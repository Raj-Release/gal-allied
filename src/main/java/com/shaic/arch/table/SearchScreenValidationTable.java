 ...
 *
 */
public class SearchScreenValidationTable extends GBaseTable<SearchScreenValidationTableDTO> {
	
	//private List<String> errorMessages;
	
	
	/*public SearchScreenValidationTable() {
		super(SearchScreenValidationTable.class);
		setUp();
	}*/

/*	public static final Object[] VISIBLE_COLUMNS = new Object[] {
			//"rodNo", "lastCompletedStage", "lastRemarks","lockedUserId"};
		"rodNo", "lastCompletedStage","status","lockedUserId"};*/
	...
	static {
		...
		fieldMap.put("rodNo", new TableFieldDTO("rodNo",TextField.class, String.class, true));
