 ...
 */
public class LotSuggestingContainer extends BeanItemContainer<SelectValue> {
...
public LotSuggestingContainer(MasterService service) throws IllegalArgumentException {
  ...
  private void filterItems(String filterString, String userId) {
	if (!isNewItemAdded())
	{
		...
		allItemIds2.clear();
		allItemIds2 = null;
		selectValueList = service.getCpuLotNumberForBasedOnInput(filterString.toLowerCase());
   ...
   * custom container implementation {@link LotSuggestingContainer}. Our container
