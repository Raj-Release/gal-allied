...
public class CustomFieldExample extends CustomComponent implements BookExampleBundle {
    ...
    void basic(VerticalLayout layout) {
        ...
        field.addValueChangeListener(new ValueChangeListener()
        {
			...
			public void valueChange(ValueChangeEvent event) {
				value.setValue((field.getValue() ? "It's now on" : "It's now off"));
			}
    ...
    class QuickCalendar extends CustomField<Date> {
        ...
        public QuickCalendar(Date date) {
            ...
            //Vaadin8-setImmediate() df.setImmediate(true);
        }
        ...
        protected Component initContent() {
            ...
            //Vaadin8-setImmediate() year.setImmediate(true);
            ...
            //Vaadin8-setImmediate() month.setImmediate(true);
...
//        Path initialpath = Path.get(baseDir.getAbsolutePath() + "/VAADIN/themes/book-examples/img/reindeer-256px.png");
