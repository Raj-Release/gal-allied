...
public class AddAddlPaymentInfoPageTable extends GEditableTable<UploadDocumentDTO>{
	private String presenterString = "";
	private Window popup;
	final Embedded imageViewer = new Embedded("Uploaded Image");

	public AddAddlPaymentInfoPageTable() {
		super(AddAddlPaymentInfoPageTable.class);
		setUp();
	}
		    	...
		    	editButton.addClickListener(new Button.ClickListener() {
					...
					public void buttonClick(ClickEvent event) {
						...
						uploadDTO.setIsEdit(true);
							fireViewEvent(AddAditionalDocumentsPaymentInfoPagePresenter.EDIT_PAYMENT_INFO_DOCUMENTS, uploadDTO);
	...
	public void tableSelectHandler(UploadDocumentDTO t) {		
			fireViewEvent(AddAditionalDocumentsPaymentInfoPagePresenter.DELETE_PAYMENT_INFO_DOCUMENTS,t);
				}
