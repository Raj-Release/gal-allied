...
@ViewInterface(UploadNEFTDetailsView.class)
public class UploadNEFTDetailsPresenter extends AbstractMVPPresenter<UploadNEFTDetailsView>{
	
public static final String UPLOAD_NEFT_DETAILS_SETUP_DROPDOWN_VALUES = "upload_neft_details_setup_dropdown_values";
	
	public static final String SUBMIT_UPLOAD_NEFT_DETAILS = "submit_upload_neft_details";
	
	public static final String DELETE_UPLOAD_NEFT_DETAILS = "delete_upload_neft_details";
	
	public static final String EDIT_UPLOAD_NEFT_DETAILS = "edit_upload_neft_details";
	
	public static final String UPDATE_UPLOAD_NEFT_DETAILS_BEAN = "upload_neft_details_UPDATE BEAN";
	
	public static final String SUBMIT_DETAILS_UPLOAD_NEFT_DETAILS = "submit_details_upload_neft_details";
	
	public static final String SETUP_UPLOAD_NEFT_DETAILS_PAYABLE_DETAILS  = "setup_payable_details_upload_neft_details";
	
	public static final String SETUP_UPLOAD_NEFT_DETAILS_IFSC_DETAILS  = "setup_ifsc_details_upload_neft_details";
	
	public static final String UPLOAD_NEFT_DETAILS_POPULATE_PREVIOUS_ACCT_DETAILS = "upload_neft_details_populate_previous_acct_details";
	...
	public void setUpDropDownValues(
			@Observes @CDIEvent(UPLOAD_NEFT_DETAILS_SETUP_DROPDOWN_VALUES) final ParameterDTO parameters) {
	//	ReceiptOfDocumentsDTO bean = (ReceiptOfDocumentsDTO) parameters.getPrimaryParameter();
		...
		BeanItemContainer<SelectValue> beanContainer = masterService.getSelectValueContainerForNEFT(ReferenceTable.DOCTYPE_NEFT);
		
		referenceDataMap.put("fileType", beanContainer);
		//String fileType = SHAConstants.NEFT_DETAILS;
	...
	public void submitUploadedDocuments(
			@Observes @CDIEvent(SUBMIT_UPLOAD_NEFT_DETAILS) final ParameterDTO parameters) {
	...
	public void deleteUploadedDocumentDetails(
			@Observes @CDIEvent(DELETE_UPLOAD_NEFT_DETAILS) final ParameterDTO parameters) {
	...
	public void editUploadedDocumentDetails(
			@Observes @CDIEvent(EDIT_UPLOAD_NEFT_DETAILS) final ParameterDTO parameters) {
	...
	public void updateBeanDetails(
			@Observes @CDIEvent(UPDATE_UPLOAD_NEFT_DETAILS_BEAN) final ParameterDTO parameters) {
		ReceiptOfDocumentsDTO bean = (ReceiptOfDocumentsDTO) parameters.getPrimaryParameter();
	...
	public void submitWizard(
			@Observes @CDIEvent(SUBMIT_DETAILS_UPLOAD_NEFT_DETAILS) final ParameterDTO parameters) {
		ReceiptOfDocumentsDTO rodDTO = (ReceiptOfDocumentsDTO) parameters.getPrimaryParameter();
		rodService.submitNEFTDetailsPaymentValues(rodDTO);
		view.buildSuccessLayout();
	}
	
	public void setupPayableDetails(
			@Observes @CDIEvent(SETUP_UPLOAD_NEFT_DETAILS_PAYABLE_DETAILS) final ParameterDTO parameters) {
	...
	public void setupIFSCDetails(
			@Observes @CDIEvent(SETUP_UPLOAD_NEFT_DETAILS_IFSC_DETAILS) final ParameterDTO parameters) {
	...
	public void populatePreviousPaymentDetails(@Observes @CDIEvent(UPLOAD_NEFT_DETAILS_POPULATE_PREVIOUS_ACCT_DETAILS) final ParameterDTO parameters)
	{
