...
//	}
	...
	//	btnCancel.setDisableOnClick(true);
		...
		previousAccountDetailsTable.setPresenterString(SHAConstants.UPLOAD_NEFT_DETAILS);
...
//		payeenameListner();
	...
	public boolean validatePage(){
		...
		/*if(txtPayableAt != null && (null == txtPayableAt.getValue() || ("").equalsIgnoreCase(txtPayableAt.getValue()))){
			...
			hasError = true;
			eMsg.append("Select Payment mode as Bank Tansfer/NEFT only </br>");
		}
	...
	public void addCitySearchListener(){
		btnCitySearch.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				citySearchCriteriaWindow.setPresenterString(SHAConstants.UPLOAD_NEFT_DETAILS);
	...
	public void addIFSCCodeListner()
	{
		btnIFCSSearch.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				viewSearchCriteriaWindow.setPresenterString(SHAConstants.UPLOAD_NEFT_DETAILS);
