...
public class UploadNEFTDetailsPageUI extends ViewComponent{
	...
	@Inject
	private SelectRODtoUploadNEFTDetailsTable selectRODtoUploadNEFTDetailsTable;
	
	@Inject
	private UploadNEFTDetailsPage uploadDocumentView;
...
//		mainPanel.addComponent(viewDetailsButtonLayout());
		...
		intimationDetailsCarousel.init(this.bean.getClaimDTO()
				...
				"Upload NEFT Details",this.bean.getDiagnosis());
		mainPanel.addComponent(intimationDetailsCarousel);
...
//		mainPanel.addComponent(PaymentInformationDetails);
		...
		fireViewEvent(UploadNEFTDetailsPresenter.UPLOAD_NEFT_DETAILS_SETUP_DROPDOWN_VALUES, bean);
...
//	}
	...
	private void addListener()
	{
		btnSubmit.addClickListener(new ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				if(selectRODtoUploadNEFTDetailsTable.isValid() && uploadDocumentView.validatePage() && paymentInformationObj.validatePage()){
					uploadDocumentView.setTableValuesToDTO();
					fireViewEvent(UploadNEFTDetailsPresenter.SUBMIT_DETAILS_UPLOAD_NEFT_DETAILS,
							bean);
					...
					new ConfirmDialog.Listener() {
						...
						public void onClose(ConfirmDialog dialog) {
							if (!dialog.isConfirmed()) {
								fireViewEvent(MenuItemBean.UPLOAD_NEFT_DETAILS, true);
