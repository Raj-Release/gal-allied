...
public class UploadNEFTDetailsPageTable extends GEditableTable<UploadDocumentDTO>{

	private String presenterString = "";
	private Window popup;
	final Embedded imageViewer = new Embedded("Uploaded Image");

	public UploadNEFTDetailsPageTable() {
		super(UploadNEFTDetailsPageTable.class);
		setUp();
	}
		    	...
		    	editButton.addClickListener(new Button.ClickListener() {
					...
					public void buttonClick(ClickEvent event) {
						...
						uploadDTO.setIsEdit(true);
							fireViewEvent(UploadNEFTDetailsPresenter.EDIT_UPLOAD_NEFT_DETAILS, uploadDTO);
	...
	public void tableSelectHandler(UploadDocumentDTO t) {		
			fireViewEvent(UploadNEFTDetailsPresenter.DELETE_UPLOAD_NEFT_DETAILS,t);
				}
