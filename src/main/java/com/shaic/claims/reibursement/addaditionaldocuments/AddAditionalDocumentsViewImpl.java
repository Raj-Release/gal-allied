 ...
 *
 */
public class AddAditionalDocumentsViewImpl extends AbstractMVPView implements
		AddAditionalDocumentsView {
	...
	public void initView(ReceiptOfDocumentsDTO rodDTO) {
		...
		billEntryDetailsView.init(this.bean, wizard);
	...
	{
		fireViewEvent(AddAditionalDocumentsPresenter.VALIDATE_ADD_ADDITIONAL_DOC_REC_USER_RRC_REQUEST, preauthDTO);//, secondaryParameters);
	}
	...
	public void buildValidationUserRRCRequestLayout(Boolean isValid) {
		...
		else
		{
			...
			//ViewDocumentDetailsDTO documentDetails =  new ViewDocumentDetailsDTO();
			//documentDetails.setClaimDto(bean.getClaimDTO());
			rewardRecognitionRequestViewObj.initPresenter(SHAConstants.ADD_ADDITIONAL_DOCUMENTS);
	...
	public void wizardCompleted(WizardCompletedEvent event) {
		/*fireViewEvent(WizardPresenter.SUBMIT_ADD_ADDITIONAL_DOCUMENTS_DETAILS,
				this.bean);*/
		fireViewEvent(AddAditionalDocumentsPresenter.SUBMIT_BILL_ENTRY_DETAILS,
				this.bean);
	}
