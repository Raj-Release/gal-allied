...
@ViewInterface(PAProcessRejectionLetterView.class)
public class PAProcessRejectionLetterPresenter extends AbstractMVPPresenter<PAProcessRejectionLetterView>{
	
	public static final String GENERATED_PA_REJECTION_LETTER = "pa generate rejection letter for second page";
...
public void saveData(@Observes @CDIEvent(GENERATED_PA_REJECTION_LETTER)final ParameterDTO parameters){
