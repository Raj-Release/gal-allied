 ...
 *
 */
public class PASearchProcessClaimRequestTable extends GBaseTable<SearchProcessClaimRequestTableDTO>{
	private final Logger log = LoggerFactory.getLogger(PASearchProcessClaimRequestTable.class);
	...
	private final static Object[] NATURAL_COL_ORDER = new Object[]{"serialNumber","intimationNo","ackAgeing","claimedAmountAsPerBill", "cpuName", "productName", "intimationSource",
		"insuredPatientName", "hospitalName", "hospitalType", "requestedAmt", "balanceSI","treatementType",  "speciality", "reasonForAdmission", "originatorID","originatorName", "claimType","documentReceivedFrom", "specialistOrQueryOrCoordinatorReqId",
		"specialistOrQueryOrCoordinatorReqName","accidentOrdeath","status"}; 
...
//		dialog.setCaption("Alert");
				 ...
				 Date date3 = new Date();
					...
					try{
						if( isActiveHumanTask){
							...
							fireViewEvent(PAMenuPresenter.PA_SHOW_MEDICAL_APPROVAL_SCREEN, t);
	...
	public void tableSelectHandler(
			SearchProcessClaimRequestTableDTO t) {
