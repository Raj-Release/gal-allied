 ...
 *
 */
public class PASearchReOpenClaimViewImpl extends AbstractMVPView implements PASearchReOpenClaimView{

	
	@Inject
	private PASearchReOpenClaimForm  searchForm;
	
	@Inject
	private PASearchReOpenClaimTable searchResultTable;
	...
	public void doSearch() {
		PASearchReOpenClaimFormDTO searchDTO = searchForm.getSearchDTO();
		...
		fireViewEvent(PASearchReOpenClaimPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
		}
		else{
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof PASearchReOpenClaimTable)
			{
				((PASearchReOpenClaimTable) comp).removeRow();
			}
		}
