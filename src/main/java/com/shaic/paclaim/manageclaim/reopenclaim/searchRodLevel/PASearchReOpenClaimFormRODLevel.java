 ...
 *
 */
public class PASearchReOpenClaimFormRODLevel extends SearchComponent<PASearchReOpenClaimFormDTORODLevel> {
	
	@Inject
	private PASearchReOpenClaimRODLevelTable searchAcknowledgementDocumentReceiverTable;
	...
	{
		this.binder = new BeanFieldGroup<PASearchReOpenClaimFormDTORODLevel>(PASearchReOpenClaimFormDTORODLevel.class);
		this.binder.setItemDataSource(new PASearchReOpenClaimFormDTORODLevel());
