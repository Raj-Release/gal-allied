...
public class PAReOpenRodLevelClaimPage extends ViewComponent {
	...
	@Inject
	private PAReOpenRodLevelClaimTable reOpenClaimTable;
	
	private TextArea txtReOpenRemarks;
	
	private BeanFieldGroup<PAReOpenRodLevelClaimDTO> binder;
	
	private PAReOpenRodLevelClaimDTO bean;
	...
	private PASearchReOpenClaimRodLevelTableDTO searchDTO;
	...
	public void init(PASearchReOpenClaimRodLevelTableDTO searchDTO){
		...
		fireViewEvent(PAReOpenRodLevelClaimPresenter.SET_DATA_FIELD, searchDTO);
		
		this.binder = new BeanFieldGroup<PAReOpenRodLevelClaimDTO>(PAReOpenRodLevelClaimDTO.class);
		this.binder.setItemDataSource(this.bean);
		binder.setFieldFactory(new EnhancedFieldGroupFieldFactory());
		
		reOpenClaimTable.init("Document Details", false, false);
		
		fireViewEvent(PAReOpenRodLevelClaimPresenter.SET_TABLE_DATA, searchDTO);
...
public void addListener(){
				        ...
				        "No", "Yes", new ConfirmDialog.Listener() {
				            ...
				            public void onClose(ConfirmDialog dialog) {
				                if (!dialog.isConfirmed()) {
				                	fireViewEvent(MenuItemBean.PA_RE_OPEN_CLAIM_ROD_LEVEL, true);
				                } else {
				                    dialog.close();
				                }
				            }
		...
		submitBtn.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				if(validatePage()){
					fireViewEvent(PAReOpenRodLevelClaimPresenter.SUBMIT_DATA, searchDTO,bean);
				}
	...
	public void setUpReference(PAReOpenRodLevelClaimDTO bean, BeanItemContainer<SelectValue> reasonForReOpen){
		this.bean = bean;
