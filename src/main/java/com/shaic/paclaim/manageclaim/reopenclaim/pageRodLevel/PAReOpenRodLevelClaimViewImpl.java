...
public class PAReOpenRodLevelClaimViewImpl extends AbstractMVPView implements PAReOpenRodLevelClaimView {
	...
	@Inject
	private Instance<PAReOpenRodLevelClaimPage> reOpenClaimInstance;
	
	private PAReOpenRodLevelClaimPage reOpenClaimObj;
