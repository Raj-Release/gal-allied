...
public class PAReopenClaimPageDTO {
	 ...
	 private List<PAReopenClaimTableDTO> reopenClaimList;
	 
	 public PAReopenClaimPageDTO(){
		 ...
		 reopenClaimList = new ArrayList<PAReopenClaimTableDTO>();
	 }
	...
	public List<PAReopenClaimTableDTO> getReopenClaimList() {
		return reopenClaimList;
	}

	public void setReopenClaimList(List<PAReopenClaimTableDTO> reopenClaimList) {
