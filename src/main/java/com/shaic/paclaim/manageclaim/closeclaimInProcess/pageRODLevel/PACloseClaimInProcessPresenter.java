...
@ViewInterface(PACloseClaimInProcessView.class)
public class PACloseClaimInProcessPresenter extends AbstractMVPPresenter<PACloseClaimInProcessView> {
    ...
    public static final String SET_DATA_FIELD = "Set data for common couresel and close claim in process reason PA";
	
	public static final String SET_TABLE_DATA = "close claim table for mangaged claim PA";
	
	public static final String SUBMIT_DATA = "Submit close claim in process screen PA";
	...
	protected void setTableValues(
		...
		List<ViewDocumentDetailsDTO> listDocumentDetails = reimbursementService.getDocumentDetailsForPACloseClaimInProcess(tableDTO.getIntimationNo(),tableDTO.getUsername(),tableDTO.getPassword());
