...
public class PACloseClaimInProcessPageUI extends ViewComponent {
	...
	@Inject
	private PACloseClaimInProcessTable documentDetailsTable;
...
//		intimationDetailsCarousel.init(this.intimationDto,"Convert Claim type to Reimbursement");
		...
		fireViewEvent(PACloseClaimInProcessPresenter.SET_TABLE_DATA, searchDTO);
		...
		fireViewEvent(PACloseClaimInProcessPresenter.SET_DATA_FIELD, searchDTO);
...
public void addListener(){
				        ...
				        "No", "Yes", new ConfirmDialog.Listener() {
				            ...
				            public void onClose(ConfirmDialog dialog) {
				                if (!dialog.isConfirmed()) {
				                	fireViewEvent(MenuItemBean.PA_CLOSE_CLAIM_IN_PROCESS_ROD_LEVEL, true);
				                } else {
				                    dialog.close();
				                }
				            }
		...
		submitBtn.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				if(validatePage()){
					fireViewEvent(PACloseClaimInProcessPresenter.SUBMIT_DATA, searchDTO, bean);
				}
