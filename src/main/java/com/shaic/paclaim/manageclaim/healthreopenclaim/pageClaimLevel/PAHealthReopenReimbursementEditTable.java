...
public class PAHealthReopenReimbursementEditTable extends ViewComponent {
...
//		layout.addComponent(btnLayout);
	...
	void initTable() {
		...
		table.setVisibleColumns(new Object[] { "acknowledgeNumber","rodNumber", "receivedFromValue", "strDocumentReceivedDate", "modeOfReceiptValue", "billClassification","approvedAmount", "status" });
