 ...
 *
 */
public class PAHealthSearchReOpenClaimFormRODLevel extends SearchComponent<PAHealthSearchReOpenClaimFormDTORODLevel> {
	
	@Inject
	private PAHealthSearchReOpenClaimRODLevelTable searchAcknowledgementDocumentReceiverTable;
	...
	{
		this.binder = new BeanFieldGroup<PAHealthSearchReOpenClaimFormDTORODLevel>(PAHealthSearchReOpenClaimFormDTORODLevel.class);
		this.binder.setItemDataSource(new PAHealthSearchReOpenClaimFormDTORODLevel());
