 ...
 */
@Stateless
public class PAHealthSearchReOpenClaimRODLevelService  extends AbstractDAO<Claim>{

	@PersistenceContext
	protected EntityManager entityManager;
	
	private final Logger log = LoggerFactory.getLogger(PAHealthSearchReOpenClaimRODLevelService.class);
	
	
	public PAHealthSearchReOpenClaimRODLevelService() {
		super();
		
	}
	public  Page<PAHealthSearchReOpenClaimRodLevelTableDTO> search(
			PAHealthSearchReOpenClaimFormDTORODLevel searchFormDTO,
	...
	//		doList = listOfClaim;
			...
			List<PAHealthSearchReOpenClaimRodLevelTableDTO> tableDTO = PAHealthSearchReOpenClaimRODLevelMapper.getInstance().getClaimDTO(doList);
			...
			List<PAHealthSearchReOpenClaimRodLevelTableDTO> result = new ArrayList<PAHealthSearchReOpenClaimRodLevelTableDTO>();
			result.addAll(tableDTO);
			
			Page<PAHealthSearchReOpenClaimRodLevelTableDTO> page = new Page<PAHealthSearchReOpenClaimRodLevelTableDTO>();		
	...
	private List<PAHealthSearchReOpenClaimRodLevelTableDTO> getHospitalDetails(
			List<PAHealthSearchReOpenClaimRodLevelTableDTO> tableDTO) {
	...
	public PAHealthReOpenRodLevelClaimDTO getReopenPAClaimDTO(Long reimbursementKey,PAHealthSearchReOpenClaimRodLevelTableDTO tableDTO){
		
		CloseClaim closeClaim = getCloseClaim(reimbursementKey);
		
		Reimbursement reimbursement = getReimbursementByKey(reimbursementKey);
		
		PAHealthReOpenRodLevelClaimDTO reOpenClaimDTO = new PAHealthReOpenRodLevelClaimDTO();
		
		if(closeClaim != null){
			reOpenClaimDTO = PAHealthSearchReOpenClaimRODLevelMapper.getInstance().getReOpenClaimDTO(closeClaim);
	...
	public List<Reimbursement> submitReopenPAClaim(PAHealthSearchReOpenClaimRodLevelTableDTO tableDTO, PAHealthReOpenRodLevelClaimDTO bean){
...
//			    	reimbursement.setCurrentProvisionAmt(bean.getProvisionAmount());
	...
	public Double getProvisionAmount(Reimbursement reimbursement,PAHealthSearchReOpenClaimRodLevelTableDTO tableDTO){
	...
	public Double getClaimedAmount(Reimbursement reimbursement,PAHealthSearchReOpenClaimRodLevelTableDTO tableDTO){
	...
	public Double getBalanceSI(Reimbursement reimbursement,PAHealthSearchReOpenClaimRodLevelTableDTO tableDTO)
	{
