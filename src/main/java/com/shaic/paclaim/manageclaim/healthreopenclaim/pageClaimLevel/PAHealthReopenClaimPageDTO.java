...
public class PAHealthReopenClaimPageDTO {
	 ...
	 private List<PAHealthReopenClaimTableDTO> reopenClaimList;
	 
	 public PAHealthReopenClaimPageDTO(){
		 ...
		 reopenClaimList = new ArrayList<PAHealthReopenClaimTableDTO>();
	 }
	...
	public List<PAHealthReopenClaimTableDTO> getReopenClaimList() {
		return reopenClaimList;
	}

	public void setReopenClaimList(List<PAHealthReopenClaimTableDTO> reopenClaimList) {
