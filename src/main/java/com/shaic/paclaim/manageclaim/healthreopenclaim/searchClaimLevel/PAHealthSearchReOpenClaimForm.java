 ...
 *
 */
public class PAHealthSearchReOpenClaimForm extends SearchComponent<PAHealthSearchReOpenClaimFormDTO> {
	
	@Inject
	private PAHealthSearchReOpenClaimTable searchAcknowledgementDocumentReceiverTable;
	...
	{
		this.binder = new BeanFieldGroup<PAHealthSearchReOpenClaimFormDTO>(PAHealthSearchReOpenClaimFormDTO.class);
		this.binder.setItemDataSource(new PAHealthSearchReOpenClaimFormDTO());
