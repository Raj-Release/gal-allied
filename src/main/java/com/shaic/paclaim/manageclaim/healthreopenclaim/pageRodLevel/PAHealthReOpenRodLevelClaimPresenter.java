...
import com.shaic.paclaim.manageclaim.healthreopenclaim.searchRodLevel.PAHealthSearchReOpenClaimRODLevelService;
import com.shaic.paclaim.manageclaim.healthreopenclaim.searchRodLevel.PAHealthSearchReOpenClaimRodLevelTableDTO;
import com.vaadin.v7.data.util.BeanItemContainer;


@ViewInterface(PAHealthReOpenRodLevelClaimView.class)
public class PAHealthReOpenRodLevelClaimPresenter extends AbstractMVPPresenter<PAHealthReOpenRodLevelClaimView> {
	
	public static final String SET_DATA_FIELD = "Set data for common couresel and Reopen field PA health";
	
	public static final String SUBMIT_DATA = "Submit reopen claim PA health";
	
	public static final String SET_TABLE_DATA = "Set List for reimburesment table for reopen claim PA health";
	...
	@EJB
	private PAHealthSearchReOpenClaimRODLevelService reOpenClaimService;
	...
	protected void setDataValues(
		...
		PAHealthReOpenRodLevelClaimDTO reopenClaimDTO = reOpenClaimService.getReopenPAClaimDTO(tableDTO.getReimbursmentKey(),tableDTO);
	...
	protected void submitEvent(
		...
		PAHealthReOpenRodLevelClaimDTO bean = (PAHealthReOpenRodLevelClaimDTO) parameters.getSecondaryParameter(0, PAHealthReOpenRodLevelClaimDTO.class);
	...
	protected void setTableValues(
		...
		List<ViewDocumentDetailsDTO> listDocumentDetails = reimbursementService.getDocumentDetailsForPAHealthReOpenClaim(tableDTO.getIntimationNo(),tableDTO.getUsername(),tableDTO.getPassword());
