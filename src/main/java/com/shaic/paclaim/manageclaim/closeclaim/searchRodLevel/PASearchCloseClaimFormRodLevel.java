 ...
 *
 */
public class PASearchCloseClaimFormRodLevel extends SearchComponent<PASearchCloseClaimFormDTORODLevel> {
	
	@Inject
	private PASearchCloseClaimTableRODLevel searchAcknowledgementDocumentReceiverTable;
