...
public class PACloseClaimPageDTO {
	 ...
	 private List<PAUploadDocumentCloseClaimDTO> uploadDocumentDetails;
	 
	 private List<PACloseClaimTableDTO> closeClaimList;
	 ...
	 public PACloseClaimPageDTO(){
		 ...
		 closeClaimList = new ArrayList<PACloseClaimTableDTO>();
		 uploadDocumentDetails = new ArrayList<PAUploadDocumentCloseClaimDTO>();
	 }
	...
	public List<PACloseClaimTableDTO> getCloseClaimList() {
		return closeClaimList;
	}

	public void setCloseClaimList(List<PACloseClaimTableDTO> closeClaimList) {
	...
	public List<PAUploadDocumentCloseClaimDTO> getUploadDocumentDetails() {
		return uploadDocumentDetails;
	}

	public void setUploadDocumentDetails(
			List<PAUploadDocumentCloseClaimDTO> uploadDocumentDetails) {
