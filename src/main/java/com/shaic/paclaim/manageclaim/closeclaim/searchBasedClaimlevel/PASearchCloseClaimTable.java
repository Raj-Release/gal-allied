 ...
 *
 */
public class PASearchCloseClaimTable extends GBaseTable<PASearchCloseClaimTableDTO>{
	...
	public void initTable() {
		...
		table.setContainerDataSource(new BeanItemContainer<PASearchCloseClaimTableDTO>(PASearchCloseClaimTableDTO.class));
		...
		table.addGeneratedColumn("dateOfAdmission", new Table.ColumnGenerator() {
		      ...
		      public Object generateCell(final Table source, final Object itemId, Object columnId) {
		    	  ...
		    	  PASearchCloseClaimTableDTO closeClaimDTO = (PASearchCloseClaimTableDTO)itemId;
	...
	public void tableSelectHandler(
			PASearchCloseClaimTableDTO t) {

			fireViewEvent(PAMenuPresenter.CLOSE_CLAIM_PAGE, t);
