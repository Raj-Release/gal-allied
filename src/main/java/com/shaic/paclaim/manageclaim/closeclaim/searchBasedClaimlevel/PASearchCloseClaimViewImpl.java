 ...
 *
 */
public class PASearchCloseClaimViewImpl extends AbstractMVPView implements PASearchCloseClaimView{

	
	@Inject
	private PASearchCloseClaimForm  searchForm;
	
	@Inject
	private PASearchCloseClaimTable searchResultTable;
	...
	public void doSearch() {
		PASearchCloseClaimFormDTO searchDTO = searchForm.getSearchDTO();
...
//			String passWord=(String)getUI().getSession().getAttribute(BPMClientContext.PASSWORD);
			...
			fireViewEvent(PASearchCloseClaimPresenter.SEARCH_BUTTON_CLICK, searchDTO);
		}
		else{
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof PASearchCloseClaimTable)
			{
				((PASearchCloseClaimTable) comp).removeRow();
			}
		}
