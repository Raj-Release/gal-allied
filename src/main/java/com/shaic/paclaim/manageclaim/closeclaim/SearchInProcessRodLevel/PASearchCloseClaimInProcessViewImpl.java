 ...
 *
 */
public class PASearchCloseClaimInProcessViewImpl extends AbstractMVPView implements PASearchCloseClaimInProcessView {
	...
	@Inject
	private PASearchCloseClaimInProcessForm  searchForm;
	
	@Inject
	private PASearchCloseClaimInProcessTable searchResultTable;
...
//		mainPanel.setHeight("625px");
	...
	public void doSearch() {
		...
		fireViewEvent(PASearchCloseClaimInProcessPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
	}
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof PASearchCloseClaimInProcessTable)
			{
				((PASearchCloseClaimInProcessTable) comp).removeRow();
			}
		}
	}
