...
public class PACloseClaimPageRodLevelViewImpl extends AbstractMVPView implements PACloseClaimRodLevelView {
	...
	@Inject
	private Instance<PACloseClaimPageRodLevelUI> closeClaimPageInstance;
	
	private PACloseClaimPageRodLevelUI closeClaimPageObj;
...
//		intimationDetailsCarousel.init(searchDTO.getIntimationDto(),searchDTO.getClaimDto(),"Close Claim (Search Based)");
		intimationDetailsCarousel.init(searchDTO.getIntimationDto(),searchDTO.getClaimDto(),"Close Claim (Search Based)",searchDTO.getDiagnosis());
		
		viewDetails.initView(searchDTO.getIntimationDto().getIntimationId(), ViewLevels.CLOSE_CLAIM, false,"Close Claim (Search Based)");
	...
	public void buildSuccessLayout() {
		...
		homeButton.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				dialog.close();
				toolbar.countTool();
				fireViewEvent(MenuItemBean.PA_CLOSE_CLAIM_ROD_LEVEL, null);
