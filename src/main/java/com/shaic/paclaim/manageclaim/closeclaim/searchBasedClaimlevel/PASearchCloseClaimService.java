 ...
 */
@Stateless
public class PASearchCloseClaimService  extends AbstractDAO<Claim>{

	@PersistenceContext
	protected EntityManager entityManager;
	
	
	public PASearchCloseClaimService() {
		super();
		
	}
	
	public  Page<PASearchCloseClaimTableDTO> search(
			PASearchCloseClaimFormDTO searchFormDTO) {
...
//		doList = listOfClaim;
		List<PASearchCloseClaimTableDTO> tableDTO = PASearchCloseClaimMapper.getInstance().getClaimDTO(doList);
		...
		List<PASearchCloseClaimTableDTO> result = new ArrayList<PASearchCloseClaimTableDTO>();
		result.addAll(tableDTO);
		
	
		Page<PASearchCloseClaimTableDTO> page = new Page<PASearchCloseClaimTableDTO>();
	...
	@SuppressWarnings("unchecked")
	private List<PASearchCloseClaimTableDTO> getHospitalDetails(
			List<PASearchCloseClaimTableDTO> tableDTO) {
	...
	/*public  Page<PASearchCloseClaimTableDTO> searchBPMNTask(
			PASearchCloseClaimFormDTO searchFormDTO,
...
//		}
		...
		List<PASearchCloseClaimTableDTO> tableDTO = new ArrayList<PASearchCloseClaimTableDTO>();
		...
		if(tasks != null){
			...
			for (HumanTask humanTask : humanTasks) {
				...
				if(rod != null && rod.getKey() != null){
					...
					PASearchCloseClaimTableDTO searchClaimDTO = PASearchCloseClaimMapper.getInstance().getSearchClaimDTO(reimbursement.getClaim());
...
//		List<SearchCloseClaimTableDTO> tableDTO = SearchCloseClaimMapper.getClaimDTO(doList);
	...
	public List<Reimbursement> submitSearchBasedCloseClaim(ViewDocumentDetailsDTO documentDTO,PASearchCloseClaimTableDTO searchDTO){
...
//					}
	...
	*/
public List<Reimbursement> submitCloseClaimInProcess(ViewDocumentDetailsDTO documentDTO,PASearchCloseClaimTableDTO searchDTO){
