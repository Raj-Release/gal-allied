 ...
 *
 */
public class PASearchCloseClaimForm extends SearchComponent<PASearchCloseClaimFormDTO> {
	
	@Inject
	private PASearchCloseClaimTable searchAcknowledgementDocumentReceiverTable;
...
//		txtClaimNo = binder.buildAndBind("Claim No","claimNo",TextField.class);
	...
	{
		this.binder = new BeanFieldGroup<PASearchCloseClaimFormDTO>(PASearchCloseClaimFormDTO.class);
		this.binder.setItemDataSource(new PASearchCloseClaimFormDTO());
