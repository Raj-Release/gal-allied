...
import com.shaic.paclaim.cashless.listenertables.PAPEDValidationListenerTableForPreauth;
...
public class PAPreauthMedicalProcessingPage extends ViewComponent implements WizardStep<PreauthDTO> {
	...
	@Inject
	private Instance<PAPEDValidationListenerTableForPreauth> pedValidationTable;
...
//	private Instance<PreauthButtons> preauthButtonInstance;
	...
	private PAPEDValidationListenerTableForPreauth pedValidationTableObj;
...
//	private PreauthButtons preauthButtonObj;
	...
	public Component getContent() {
		...
		PAPEDValidationListenerTableForPreauth pedValidationTableInstance = pedValidationTable.get();
		pedValidationTableInstance.init();
