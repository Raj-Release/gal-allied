...
public class PAMedicalDecisionTableForEnhancement extends GListenerTable<MedicalDecisionTableDTO> implements TableCellSelectionHandler {
	...
	public PAMedicalDecisionTableForEnhancement() {
		super(PAMedicalDecisionTableForEnhancement.class);
		setUp();
	}
