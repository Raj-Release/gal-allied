...
@ViewInterface(PAPreauthEnhancementWizard.class)
public class PAPreauthEnhancemetWizardPresenter extends AbstractMVPPresenter<PAPreauthEnhancementWizard> {
	...
	public static final String PREAUTH_STEP_CHANGE_EVENT = "PA_preauth_enhancement_step_change_event";
	public static final String PREAUTH_SAVE_EVENT = "PA_preauth_enhancement_save_event";
	public static final String PREAUTH_SUBMITTED_EVENT = "PA_preatuh_enhancement_submit_event";
	public static final String SETUP_REFERENCE_DATA = "PA_preauth_enhancement_set_edit_data";
	public static final String PREAUTH_TREATMENT_TYPE_CHANGED = "PA_preauth_enhancement_treatment_type_changed";
	public static final String PREAUTH_PATIENT_STATUS_CHANGED = "PA_preauth_enhancement_patient_status_changed";
	public static final String PREAUTH_RELAPSE_OF_ILLNESS_CHANGED = "PA_preauth_enhancement_relapse_of_illness_changed";
	
	public static final String PREAUTH_QUERY_EVENT ="PA_preauth_enhancement_query_click_event";
	public static final String PREAUTH_SUGGEST_REJECTION_EVENT ="PA_preauth_enhancement_rejection_click_event";
	public static final String PREAUTH_SEND_FOR_PROCESSING_EVENT ="PA_preauth_enhancement_send_for_processing_click_event";

	public static final String PREAUTH_REFERCOORDINATOR_EVENT = "PA_preauth_enhancement_refer_coordinator_event";
	
	public static final String PREAUTH_PREVIOUS_CLAIM_DETAILS = "PA_preauth_enhancement_previous_claim_details";
	
	public static final String SUBLIMIT_CHANGED_BY_SECTION = "PA_Set sublimit values by selecting section for preauth enhancement";

	public static final String MASTER_SEARCH_STATE = "PA_preauth_enhancement_master_search_stae";
	
	public static final String CHECK_CRITICAL_ILLNESS = "PA_preauth_enhancement_check_critical_illness";
	
	public static final String GET_ICD_BLOCK = "PA_preauth_enhancement_get_icd_block";
	
	public static final String GET_ICD_CODE = "PA_preauth_enhancement_get_icd_code";
	
	public static final String GET_SEC_COVER = "PA_pre_auth_enhancement_get_sec_cover";
	
	public static final String GET_SUB_COVER = "PA_pre_auth_enhancement_get_sub_cover";
	
	public static final String PREAUTH_QUERY_BUTTON_EVENT = "PA_preauth_enhancement_query_button_event";

	public static final String PREAUTH_REJECTION_EVENT = "PA_preauth_enhancement_rejection_event";

	public static final String PREAUTH_APPROVE_EVENT = "PA_preauth_enhancement_approve_event";

	public static final String PREAUTH_DENIAL_EVENT = "PA_preauth_enhancement_denial_event";

	public static final String PREAUTH_ESCALATE_EVENT = "PA_preauth_enhancement_escalate_event";

	public static final String FIELD_VISIT_RADIO_CHANGED = "PA_preauth_enhancement_field_visit_radio_changed";

	public static final String SPECIALIST_OPINION_RADIO_CHANGED = "PA_preauth_enhancement_specialist_radio_changed";

	public static final String PREAUTH_SENT_TO_CPU_SELECTED = "PA_preauth_enhancement_sent_to_cpu_selected";

	public static final String VIEW_CLAIMED_AMOUNT_DETAILS = "PA_enhancement_view_claimed_amount_details";
	
	public static final String VIEW_BALANCE_SUM_INSURED_ENH_DETAILS = "PA_view_Balance_Sum_Insured_end_details";
	
	public static final String NO_OF_DAYS_RULE = "PA_enhancement_no_of_days_rule";

	public static final String GET_EXCLUSION_DETAILS = "PA_preauth_enhancement_get_exclusion_details";

	public static final String PREAUTH_GET_PACKAGE_RATE = "PA_preauth_enhancement_get_package_rate";

	public static final String SUM_INSURED_CALCULATION = "PA_enhancement_calculate_sum_insured_values_from_DB";

	public static final String CHECK_INVESTIGATION_INITIATED = "PA_enhancement_rule_for_investigation_initiated";
	
	public static final String BALANCE_SUM_INSURED = "PA_enhancement_preauth_balance_sum_insured";
	
	public static final String SET_DB_DETAILS_TO_REFERENCE_DATA = "PA_enhancement_preauth_set_claim_and_sublimit_db_details";

	public static final String GET_DIAGNOSIS_NAME = "PA_enhancement_preauth_get_diagnosis_name";

	public static final String PREAUTH_WITHDRAW_EVENT = "PA_preauth_enhancement_withdraw";
	
	public static final String PREAUTH_WITHDRAW_AND_REJECT_EVENT = "PA_preauth_enhancement_withdraw_and_reject";

	public static final String PREAUTH_DOWNSIZE_EVENT = "PA_preauth_enhancement_downsize";
	
	public static final String PREAUTH_ENHANCEMENT_COORDINATOR_REQUEST_EVENT = "PA_preauth_enhancement_coordinator_request";
	
	public static final String GET_PREAUTH_REQUESTED_AMOUT = "PA_get_preauth_requested_amount";
	
	public static final String GET_HOSPITALIZATION_DETAILS = "PA_preauth_enhancement_get_hospitalization_details";
	
	public static final String HIDE_FVR_DETAILS = "PA_hide_fvr_details";
	
	public static final String SHOW_FVR_DETAILS = "PA_show_fvr_details";
	
	public static final String VALIDATE_PREAUTH_ENHANCEMENT_USER_RRC_REQUEST = "PA_preauth_enhancement_user_rrc_request";
	
	public static final String PREAUTH_ENHANCEMENT_LOAD_RRC_REQUEST_DROP_DOWN_VALUES = "PA_preauth_enhancement_load_rrc_request_drop_down_values";
	
	public static final String PREAUTH_ENHANCEMENTSAVE_RRC_REQUEST_VALUES = "PA_preauth_enhancement_save_rrc_request_values";
	
	public static final String PREAUTH_ENHANCEMENT_HOSPITALISATION_DUE_TO = "PA_pre_auth_enhancement_hospitalization_due_to";

	public static final String PREAUTH_ENHANCEMENT_REPORTED_TO_POLICE = "PA_PREAUTH_ENHANCEMENT_REPORTED_TO_POLICE";
	
	public static final String RECHARGE_SI_FOR_PRODUCT = "PA_recharging SI for product in Preauth Enhancement Screen";
	
	public static final String NEGOTIATION_OPINION_RADIO_CHANGED = "pa preauth_enhancement_negotiation_radio_changed";
	
	public static final String NEGOTIATION_CANCEL_OR_UPDATE = "pa negotiation cancel";
	public static final String NEGOTIATION_PENDING = " pa negotiation pending";
	public static final String PA_PREAUTH_ENHANCEMENT_LOAD_RRC_REQUEST_SUB_CATEGORY_VALUES = "pa_preauth_enhancement_load_rrc_request_sub_category_values";

	public static final String PA_PREAUTH_ENHANCEMENT_LOAD_RRC_REQUEST_SOURCE_VALUES = "pa_preauth_enhancement_load_rrc_request_source_values";
...
//									   masterService.getSelectValueContainer(ReferenceTable.REJECTION_CATEGORY));
	...
	{
		view.generateWithdrawLayout(masterService.getSelectValueContainer(ReferenceTable.WITHDRAWAL_REASON));
	}
	...
	{
		view.generateWithdrawAndRejectLayout(masterService.getSelectValueContainer(ReferenceTable.WITHDRAWAL_REASON), masterService.getRejectionCategoryByValue());
//																													  masterService.getSelectValueContainer(ReferenceTable.REJECTION_CATEGORY));
	}
	...
	public void generateFieldsBasedOnFieldVisit(@Observes @CDIEvent(FIELD_VISIT_RADIO_CHANGED) final ParameterDTO parameters)
	{
		...
		Long intimationKey = (Long) parameters.getSecondaryParameters()[0];
		...
		view.genertateFieldsBasedOnFieldVisit(isChecked, masterService.getSelectValueContainer(ReferenceTable.ALLOCATION_TO)
				,masterService.getSelectValueContainer(ReferenceTable.ASSIGN_TO)
...
//		Double balanceSI = dbCalculationService.getBalanceSI(policyDTO.getKey(), policyDTO.getTotalSumInsured());
		...
		//Integer insuredSumInsured = dbCalculationService.getInsuredSumInsured(intimationDTO.getPolicy().getKey(), intimationDTO.getInsuredPatient().getInsuredId().toString());
		 ...
		 insuredSumInsured = dbCalculationService.getInsuredSumInsured(newIntimationDTO.getInsuredPatient().getInsuredId().toString(), newIntimationDTO.getPolicy().getKey()
				 ,newIntimationDTO.getInsuredPatient().getLopFlag());
		...
		Double balanceSI = dbCalculationService.getBalanceSIForPAHealth(newIntimationDTO.getInsuredPatient().getKey(), preauthDTO.getClaimKey(),newIntimationDTO.getPolicy().getProduct().getKey(),ReferenceTable.HOSPITALIZATION_BENEFITS).get(SHAConstants.TOTAL_BALANCE_SI);
		List<Double> copayValue = dbCalculationService.getProductCoPay(newIntimationDTO.getPolicy().getProduct().getKey() ,newIntimationDTO.getInsuredPatient().getKey(), newIntimationDTO.getInsuredPatient().getInsuredId(),newIntimationDTO);
		...
		//String insuredAge = getInsuredAge(policyDTO.getInsuredDob());
		 Double sumInsured = 0d;
			if(null != preauthDTO.getNewIntimationDTO() && null != preauthDTO.getNewIntimationDTO().getPolicy() && 
					...
					null != preauthDTO.getNewIntimationDTO().getPolicy().getProduct().getKey() &&
					!(ReferenceTable.getGPAProducts().containsKey(preauthDTO.getNewIntimationDTO().getPolicy().getProduct().getKey()))){
				sumInsured = dbCalculationService.getInsuredSumInsured(preauthDTO.getNewIntimationDTO().getInsuredPatient().getInsuredId().toString(), 
						preauthDTO.getPolicyDto().getKey(),preauthDTO.getNewIntimationDTO().getInsuredPatient().getLopFlag());
			}
			else
			{
				sumInsured = dbCalculationService.getGPAInsuredSumInsured(preauthDTO.getNewIntimationDTO().getInsuredPatient().getInsuredId().toString(), 
...
//				Double balanceSI = 500000d;
	...
	public void setUpSubCategoryValues(
			@Observes @CDIEvent(PA_PREAUTH_ENHANCEMENT_LOAD_RRC_REQUEST_SUB_CATEGORY_VALUES) final ParameterDTO parameters) {
	...
	public void setUpsourceValues(
			@Observes @CDIEvent(PA_PREAUTH_ENHANCEMENT_LOAD_RRC_REQUEST_SOURCE_VALUES) final ParameterDTO parameters) {
