...
public class PAPreMedicalPreAuthPreviousClaimsPage extends PAPreMedicalPreauthPreviousClaimsPageUI implements WizardStep<PreauthDTO> {
	/**
	 * 
	 */
			...
			public void valueChange(ValueChangeEvent event) {
				...
				if (viewType.getValue() != null) {
					...
					//	fireViewEvent(PreMedicalPreauthWizardPresenter.PREMEDICAL_PREVIOUS_CLAIM_DETAILS, bean.getPolicyDto().getInsuredId());
						fireViewEvent(PAPreMedicalPreauthWizardPresenter.PREMEDICAL_PREVIOUS_CLAIM_DETAILS, bean);
...
//			});
		...
		cmbRelapseOfIllness.addValueChangeListener(new ValueChangeListener() {
			...
			@Override
			public void valueChange(ValueChangeEvent event) {
				fireViewEvent(PAPreMedicalPreauthWizardPresenter.PREMEDICAL_RELAPSE_OF_ILLNESS_CHANGED, bean, (SelectValue)event.getProperty().getValue());
			}
		});
	}
