...
import com.shaic.paclaim.cashless.downsize.search.PASearchDownsizeCashLessProcessFormDTO;
...
public class PASearchDownsizeRequestForm extends SearchComponent<PASearchDownsizeCashLessProcessFormDTO> {
	 ...
	 */
	  private static final long serialVersionUID = 1L;
	   @Inject
	    private PASearchDownsizeRequestTable searchDownsizeCashLessProcessTable;
...
//		}
		...
		public void init() {
			...
			downsizePreauthPanel.setCaption("Process Downsize Request");
			...
			mainVerticalLayout.addComponent(downsizePreauthPanel);
			mainVerticalLayout.setComponentAlignment(downsizePreauthPanel, Alignment.MIDDLE_LEFT);
...
//			searchFormLayout.setComponentAlignment(formLayout2 , Alignment.MIDDLE_RIGHT);
	...
	/*		HorizontalLayout searchFormLayout = new HorizontalLayout(new FormLayout(txtIntimationNo),new FormLayout(txtPolicyNo));
			...
			downsizeSearchButton.setCaption("Get Task");
			...
			absoluteLayout_3
			.addComponent(btnSearch, "top:140.0px;left:220.0px;");
			//Vaadin8-setImmediate() downsizeSearchButton.setImmediate(true);
			...
			absoluteLayout_3.addComponent(btnReset, "top:140.0px;left:329.0px;");
			//Vaadin8-setImmediate() resetBtn.setImmediate(true);
...
//		}
		...
		public void setDropDownValues(){
			...
			Status statusByKey2 = preauthService.getStatusByKey(ReferenceTable.DOWNSIZE_SUBMIT_SPECIALIST_REPLY);
			Status statusByKey3 = preauthService.getStatusByKey(ReferenceTable.DOWNSIZE_ESCALATION_STATUS);
//			Stage stageByKey3 = preauthService.getStageByKey(ReferenceTable.FINANCIAL_STAGE);
			...
			selectValue1.setValue(statusByKey2.getProcessValue());
			
			SelectValue selectValue2 = new SelectValue();
			selectValue2.setId(statusByKey3.getKey());
			selectValue2.setValue(statusByKey3.getProcessValue());
