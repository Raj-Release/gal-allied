...
public class PAPremedicalEnhancementPreviousClaimDetalilsPage extends PreMedicalPreauthPreviousClaimsPageUI implements WizardStep<PreauthDTO> {
				...
				public void valueChange(ValueChangeEvent event) {
					...
					if (viewType.getValue() != null) {
						...
						//	fireViewEvent(PremedicalEnhancementWizardPresenter.PREMEDICAL_PREVIOUS_CLAIM_DETAILS, bean.getPolicyDto().getInsuredId());
							fireViewEvent(PAPremedicalEnhancementWizardPresenter.PREMEDICAL_PREVIOUS_CLAIM_DETAILS, bean);
...
//			});
		...
		cmbRelapseOfIllness.addValueChangeListener(new ValueChangeListener() {
			...
			@Override
			public void valueChange(ValueChangeEvent event) {
				fireViewEvent(PAPremedicalEnhancementWizardPresenter.PREMEDICAL_RELAPSE_OF_ILLNESS_CHANGED, bean, (SelectValue)event.getProperty().getValue());
			}
		});
	}
