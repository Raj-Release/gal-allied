...
@ViewInterface(PAPremedicalEnhancementWizard.class)
public class PAPremedicalEnhancementWizardPresenter extends AbstractMVPPresenter<PAPremedicalEnhancementWizard> {
	...
	public static final String PREMEDICAL_STEP_CHANGE_EVENT = "PA_enhancement_step_change_event";
	public static final String PREMEDICAL_SAVE_EVENT = "PA_enhancement_save_event";
	public static final String PREMEDICAL_SUBMITTED_EVENT = "PA_enhancement_submit_event";
	public static final String SETUP_REFERENCE_DATA = "PA_enhancement_set_edit_data";
	public static final String PREMEDICAL_TREATMENT_TYPE_CHANGED = "PA_enhancement_treatment_type_changed";
	public static final String PREMEDICAL_PATIENT_STATUS_CHANGED = "PA_enhancement_patient_status_changed";
	public static final String PREMEDICAL_RELAPSE_OF_ILLNESS_CHANGED = "PA_enhancement_relapse_of_illness_changed";
	
	public static final String PREMEDICAL_QUERY_EVENT ="PA_enhancement_query_click_event";
	public static final String PREMEDICAL_SUGGEST_REJECTION_EVENT ="PA_enhancement_rejection_click_event";
	public static final String PREMEDICAL_SEND_FOR_PROCESSING_EVENT ="PA_enhancement_send_for_processing_click_event";

	public static final String PREAUTH_REFERCOORDINATOR_EVENT = "PA_enhancement_refer_coordinator_event";
	
	public static final String SUBLIMIT_CHANGED_BY_SECTION = "PA_Set sublimit values by selecting section for premedical enhancement";
	
	public static final String PREMEDICAL_PREVIOUS_CLAIM_DETAILS = "PA_enhancement_previous_claim_details";

	public static final String PREMEDICAL_QUERY_BUTTON_EVENT ="PA_enhancement_query_button_event";
	
	public static final String MASTER_SEARCH_STATE = "PA_enhancement_master_search_stae";
	
	public static final String CHECK_CRITICAL_ILLNESS = "PA_enhancement_check_critical_illness";
	
	public static final String GET_ICD_BLOCK = "PA_enhancement_get_icd_block";
	
	public static final String GET_ICD_CODE = "PA_enhancement_get_icd_code";
	
	public static final String GET_SEC_COVER = "PA_pre_medical_enhancement_get_sec_cover";
	
	public static final String GET_SUB_COVER = "PA_pre_medical_enhancement_get_sub_cover";
	
	public static final String GET_EXCLUSION_DETAILS = "PA_enhancement_get_exclusion_details";

	public static final String NO_OF_DAYS_RULE = "PA_no_of_days_rule";

	public static final String PREMEDICAL_GET_PACKAGE_RATE = "PA_enhancement_get_package_rate_by_procedure_key_and_hospital_key";

	public static final String SET_DB_DETAILS_TO_REFERENCE_DATA = "PA_enhancement_set_claim_and_sublimit_db_details";

	public static final String INTERIM_OR_FINAL_ENHANCEMENT = "PA_enhancement_interim_or_final_";
	
	public static final String PREMEDICAL_ENHANCEMENT_COORDINATOR_REQUEST_EVENT = "PA_premedical_enhancement_coordinator_request";
	
	public static final String GET_HOSPITALIZATION_DETAILS = "PA_premedical_enhancement_get_hospitalization_details";
	
	protected Map<String, Object> referenceData = new HashMap<String, Object>();
	
	public static final String VALIDATE_PREMEDICAL_ENHANCEMENT_USER_RRC_REQUEST = "PA_validate_premedical_enhancement_user_rrc_request";
	
	public static final String PRE_MEDICAL_ENHANCEMENT_LOAD_RRC_REQUEST_DROP_DOWN_VALUES = "PA_pre_medical_enhancement_load_rrc_request_drop_down_values";
	
	public static final String PRE_MEDICAL_ENHANCEMENT_SAVE_RRC_REQUEST_VALUES = "PA_pre_medical_enhancement_save_rrc_request_values";
	
	
	public static final String PREMEDICAL_ENHANCEMENT_HOSPITALISATION_DUE_TO = "PA_pre_medical_enhancement_hospitalization_due_to";

	public static final String PRE_MEDICAL_ENHANCEMENT_REPORTED_TO_POLICE = "PA_PRE_MEDICAL_ENHANCEMENT_REPORTED_TO_POLICE";

	public static final String PA_PRE_MEDICAL_ENHANCEMENT_LOAD_RRC_REQUEST_SUB_CATEGORY_VALUES = "pa_pre_medical_enhancement_load_rrc_request_sub_category_values";
	
	public static final String PA_PRE_MEDICAL_ENHANCEMENT_LOAD_RRC_REQUEST_SOURCE_VALUES = "pa_pre_medical_enhancement_load_rrc_request_source_values";
...
//		view.setWizardPageReferenceData(referenceData);
	...
	public void setUpSubCategoryValues(
			@Observes @CDIEvent(PA_PRE_MEDICAL_ENHANCEMENT_LOAD_RRC_REQUEST_SUB_CATEGORY_VALUES) final ParameterDTO parameters) {
	...
	public void setUpsourceValues(
			@Observes @CDIEvent(PA_PRE_MEDICAL_ENHANCEMENT_LOAD_RRC_REQUEST_SOURCE_VALUES) final ParameterDTO parameters) {
