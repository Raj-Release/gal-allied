...
public class PAWithdrawPreauthPageDTO {
	...
	private PASearchWithdrawCashLessProcessTableDTO tableDto;
	...
	public PASearchWithdrawCashLessProcessTableDTO getTableDto() {
		return tableDto;
	}

	public void setTableDto(PASearchWithdrawCashLessProcessTableDTO tableDto) {
