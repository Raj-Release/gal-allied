...
public class PAWithdrawPreauthTable extends GBaseTable<PAWithdrawPreauthPageDTO> {
	...
	public void initTable() {
		...
		table.setWidth("100%");
		table.setContainerDataSource(new BeanItemContainer<PAWithdrawPreauthPageDTO>(
...
//			    		UI.getCurrent().addWindow(viewDetailUI);
	...
	@Override
	public void tableSelectHandler(PAWithdrawPreauthPageDTO t) {
		// TODO Auto-generated method stub
