...
@ViewInterface(PAClaimAprNonHosReviewPageWizard.class)
public class PAClaimAprNonHosReviewPagePresenter extends AbstractMVPPresenter<PAClaimAprNonHosReviewPageWizard>{
	...
	public static final String BILLING_PATIENT_CARE_BENEFITS = "pa_claimAprNonHosp_patiet_care_benefits";
	public static final String BILLING_REVIEW_SET_UP_REFERENCE = "pa_claimAprNonHosp_review_set_up_reference";


	public static final String BILLING_TREATMENT_TYPE_CHANGED = "pa_claimAprNonHosp_treatment_type_changed";


	public static final String BILLING_COORDINATOR = "pa_claimAprNonHosp_coordinator";
	...
	public static final String BILLING_PATIENT_STATUS_CHANGED = "pa_claimAprNonHosp_patient_status_changed";


	public static final String BILL_ENTRY_TABLE_CATEGORY_DROPDOWN_VALUE = "pa_claimAprNonHosp_bill_entry_category_values";
	...
	public static final String BILL_ENTRY_COMPLETION_STATUS = "pa_claimAprNonHosp_bill_entry_completion_status";
	
	public static final String BILLING_DETAILS_UPDATE = "pa_claimAprNonHosp_update_details";
	...
	public static final String BILLING_BILL_REVIEW_IRDA_LEVEL2_VALUES = "pa_claimAprNonHosp_bill_review_irda_level2_values";
	
	public static final String BILLING_BILL_REVIEW_IRDA_LEVEL3_VALUES = "pa_claimAprNonHosp_bill_review_irda_level3_values";


	public static final String GET_MAPPING_DATA = "pa_claimAprNonHosp_get_mapping_data";
	
	public static final String COMPARE_WITH_PREVIOUS_ROD = "pa_process_Claim_billing_compare_with_previous_rod";
	
	public static final String BILLING_REFERCOORDINATOR_EVENT = "pa_claimAprNonHosp_refer_to_coordinator_event_for_first_page";
	
	public static final String BILLING_CANCEL_ROD_EVENT="pa_claimAprNonHosp_cancel_rod_event_for_first_page";
	
	public static final String BILLING_REFER_TO_MEDICAL_APPROVER_EVENT = "pa_claimAprNonHosp_refer_to_medical_approver_event_for_first_page";
	
	public static final String BILLING_SAVE_BILL_ENTRY_VALUES = "pa_claimAprNonHosp_save_bill_entry_values";
	
	public static final String BILLING_LOAD_BILL_DETAILS_VALUES = "pa_claimAprNonHosp_load_bill_details_values";

	public static final String BILLING_REFER_TO_BILL_ENTRY = "pa_claimAprNonHosp_refer_to_bill_entry";

	public static final String BILLING_REFER_TO_BILLING = "pa_claimAprNonHosp_refer_to_billing";
	
	public static final String BILLING_UPDATE_PRODUCT_BASED_AMT = "pa_claimAprNonHosp_update_product_based_amt";
	
	public static final String PA_CLAIM_APR_QUERY_BUTTON_EVENT = "pa_claimAprNonHosp_query_button_event";

	public static final String PA_CLAIM_APR_CANCEL_ROD_EVENT =  "pa_claimAprNonHosp_cancel_rod";


	public static final String PA_CLAIM_APR_REQUEST_APPROVE_EVENT = "pa_claimAprNonHosp_apporve_event";


	public static final String PA_CLAIM_APR_REQUEST_REJECTION_EVENT = "pa_claimAprNonHosp_rejection_button_event";


	//public static final String CLAIM_REQUEST_REFERCOORDINATOR_EVENT = "pa_claim_request_refer_to_coordinator_event";


	public static final String PA_CLAIM_APR_REQUEST_SENT_TO_REPLY_EVENT = "pa_claimAprNonHosp_sent_to_reply_event";


	public static final String FA_SETUP_IFSC_DETAILS = "ifsc code Search in non hosp Screen for claim approval";


	public static final String PA_CLAIM_APR_PAYMENT_QUERY_BUTTON_EVENT = "pa_claimAprNonHosp_payment_query";
	
	public static final String PA_CLAIM_APR_INVESTIGATION_EVENT = "pa_claimAprNonHosp_investigation_event";
	
	public static final String CLAIM_REQUEST_FIELD_VISIT_EVENT = "pa_claim_request_field_visit_event for claim approval";
	
/*public static final String PA_CLAIM_NH_VERIFIED_ACCOUNT_DETAIL_SAVE ="PA Claim NH Save Account Verificatin Details";
	
	public static final String PA_CLAIM_NH_VERIFICATION_ACCOUNT_DETAILS ="PA Claim NH Account Verificatin Details";
	@EJB
...
*/
	...
	public static final String SETUP_NOMINEE_IFSC_PA_NON_HOSP_CLAIM_APPROVAL = "Nominee IFSC Details for PA Non Hosp. Claim Approval";
	
	public static final String ADD_BANK_IFSC_DETAILS_PA_NON_HOSP_CA = "Add Bank Details for PA Non Hosp. Claim Approval";
	
	public static final String PA_CLAIM_TDS_PAN_VALIDATION = "pa_claim_tds_pan_validation";

	public static final String PA_POPULATE_OPTIONAL_COVERS_CLAIM_APPROVAL = "pa_populate_optional_covers_claim_approval";
...
//				}
	 ...
	 public void generatePaymentQueryLayout(
			...
			view.generatePaymentQueryLayout();
		}
...
//											masterService.getSelectValueContainer(ReferenceTable.REJECTION_CATEGORY));
	 ...
	 public void generateInvestigationLayout(
				@Observes @CDIEvent(PA_CLAIM_APR_INVESTIGATION_EVENT) final ParameterDTO parameters) {
	 ...
	 public void setupNomineeIFSCDetails(
				@Observes @CDIEvent(SETUP_NOMINEE_IFSC_PA_NON_HOSP_CLAIM_APPROVAL) final ParameterDTO parameters) {
			ViewSearchCriteriaTableDTO viewSearchCriteriaDTO = (ViewSearchCriteriaTableDTO) parameters.getPrimaryParameter();
	 ...
	 public void setupAddBankIFSCDetails(
			 @Observes @CDIEvent(ADD_BANK_IFSC_DETAILS_PA_NON_HOSP_CA) final ParameterDTO parameters) {
		 ViewSearchCriteriaTableDTO viewSearchCriteriaDTO = (ViewSearchCriteriaTableDTO) parameters.getPrimaryParameter();
	 ...
	 public void setupPanDetailsMandatory(@Observes @CDIEvent(PA_CLAIM_TDS_PAN_VALIDATION) final ParameterDTO parameters)
	 {
	...
	/* @SuppressWarnings("static-access")
		public void saveVerifiedAccount(
				@Observes @CDIEvent(PA_CLAIM_NH_VERIFIED_ACCOUNT_DETAIL_SAVE) final ParameterDTO parameters) {		
			PreauthDTO preauthDTO = (PreauthDTO) parameters.getPrimaryParameter();
		...
		public void setVerifictaionAccountDetails(
				@Observes @CDIEvent(PA_CLAIM_NH_VERIFICATION_ACCOUNT_DETAILS) final ParameterDTO parameters) {
			PreauthDTO preauthDTO = (PreauthDTO) parameters.getPrimaryParameter();
	...
	//R1022
		public void populateApproveAmntOPT(@Observes @CDIEvent(PA_POPULATE_OPTIONAL_COVERS_CLAIM_APPROVAL) final ParameterDTO parameters)
		{
			List<OptionalCoversDTO> optListClaimApproval = (List<OptionalCoversDTO>) parameters.getPrimaryParameter();
			view.populateApproveAmntOPT(optListClaimApproval);
		}
}
