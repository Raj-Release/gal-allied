...
public class PAClaimAprHosReviewPageViewImpl extends AbstractMVPView implements PAClaimAprHosReviewPageWizard {

	private static final long serialVersionUID = -1756934701433733987L;
	
	@Inject
	private PAClaimAprHosReviewPageUI billingReviewPage;
...
//		fireViewEvent(PAClaimAprNonHosReviewPagePresenter.BILLING_REVIEW_SET_UP_REFERENCE, bean);
	...
	public boolean onAdvance() {
		if(billingReviewPage.validatePage()){
			...
			fireViewEvent(PAClaimAprHosReviewPagePresenter.BILLING_DETAILS_UPDATE, bean);
			fireViewEvent(PAClaimAprHosReviewPagePresenter.GET_MAPPING_DATA, bean.getKey(), true);
...
//				}
			...
			fireViewEvent(PAClaimAprHosReviewPagePresenter.GET_MAPPING_DATA, bean.getKey(), false);
	...
	public boolean onBack() {
		fireViewEvent(PAClaimAprHosReviewPagePresenter.GET_MAPPING_DATA, bean);
		return true;
	}
