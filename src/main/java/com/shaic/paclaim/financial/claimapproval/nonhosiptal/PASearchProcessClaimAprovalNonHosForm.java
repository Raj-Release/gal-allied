...
public class PASearchProcessClaimAprovalNonHosForm extends SearchComponent<SearchProcessClaimBillingFormDTO> {
	
	@Inject
	private PASearchProcessClaimAprovalNonHosTable searchTable;
	...
	public void init() {
		...
		mainPanel.setCaption("Claim Approval (Non.Hos)");
