 ...
 *
 */
public class PASearchProcessClaimAprovalNonHosTable extends GBaseTable<SearchProcessClaimBillingTableDTO>{
				...
				//	Boolean isActiveHumanTask = SHAUtils.isActiveHumanTask(t.getUsername(),t.getPassword(),t.getTaskNumber(), session);
					...
					try{
						...
						if(isActiveHumanTask){
							...
							fireViewEvent(PAMenuPresenter.SHOW_PA_CLAIM_APPROVAL_SCREEN, t);
