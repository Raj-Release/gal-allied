...
public class PASearchProcessClaimAprovalHosForm extends SearchComponent<SearchProcessClaimBillingFormDTO> {
	
	@Inject
	private PASearchProcessClaimAprovalHosTable searchTable;
	...
	public void init() {
		...
		mainPanel.setCaption("Claim Approval (Hos)");
