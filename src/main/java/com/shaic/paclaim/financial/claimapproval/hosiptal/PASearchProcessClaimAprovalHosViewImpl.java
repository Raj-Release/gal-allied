 ...
 *
 */
public class PASearchProcessClaimAprovalHosViewImpl extends AbstractMVPView implements PASearchProcessClaimAprovalHosView{

	
	@Inject
	private PASearchProcessClaimAprovalHosForm  searchForm;
	
	@Inject
	private PASearchProcessClaimAprovalHosTable searchResultTable;
	...
	public void doSearch() {
		...
		fireViewEvent(PASearchProcessClaimAprovalHosPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof PASearchProcessClaimAprovalHosTable)
			{
				((PASearchProcessClaimAprovalHosTable) comp).removeRow();
			}
		}
