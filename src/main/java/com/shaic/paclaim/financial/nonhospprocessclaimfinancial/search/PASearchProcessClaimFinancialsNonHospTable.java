 ...
 *
 */
public class PASearchProcessClaimFinancialsNonHospTable extends GBaseTable<SearchProcessClaimFinancialsTableDTO>{
	...
	private final static Object[] NATURAL_COL_ORDER = new Object[]{"serialNumber","intimationNo", "claimedAmountAsPerBill", "strCpuCode","cpuName","claimType","documentReceivedFrom","productName",
		"insuredPatientName", "lOB",  "hospitalName",  "hospitalAddress", "reasonForAdmission", "type","originatorID","originatorName","accidentOrDeath"}; 
...
//		dialog.setCaption("Alert");
		...
		homeButton.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				 dialog.close();
				 fireViewEvent(PAMenuPresenter.SHOW_PA_NON_HOSP_FINANCIAL_APPROVAL_CLAIM_BILLING_SCREEN, t);
			}
		});
	}
