...
public class PANonHospFinancialReviewPageViewImpl extends AbstractMVPView implements PANonHospFinancialReviewPageWizard {

	private static final long serialVersionUID = -1756934701433733987L;
	
	@Inject
	private PANonHospFinancialReviewPageUI aprNonHosReviewPageUI;
	...
	public Component getContent() {
		...
		fireViewEvent(PANonHospFinancialReviewPagePresenter.BILLING_REVIEW_SET_UP_REFERENCE, bean);
	...
	public boolean onBack() {
		fireViewEvent(PANonHospFinancialReviewPagePresenter.GET_MAPPING_DATA, bean);
		return true;
	}
	...
	public void generateCancelRODLayout(BeanItemContainer<SelectValue> selectValueContainer){
		aprNonHosReviewPageUI.generateButtonFields(SHAConstants.PA_FINANCIAL_CANCEL_ROD, selectValueContainer);
	...
	public void generateReferToBillEntryLayout() {
		aprNonHosReviewPageUI.generateButtonFields(SHAConstants.REFER_TO_BILL_ENTRY, null);
	}
	...
	@Override
	public void generatePaymentLayout() {
	...
	public void setUpNomineeIFSCDetails(ViewSearchCriteriaTableDTO viewSearchCriteriaDTO) {
		aprNonHosReviewPageUI.setUpNomineeIFSCDetails(viewSearchCriteriaDTO);
	}
	...
	@Override
	public void genertateClaimAprlayout() {
		aprNonHosReviewPageUI.generateButtonFields(SHAConstants.PA_CLAIM_APPROVAL, null);
	...
	public void genertateFieldsBasedOnFieldVisit(
		...
		aprNonHosReviewPageUI.generateButtonFields(SHAConstants.FVR_STAGE, values);
	...
	public void populateApproveAmntOPT(List<OptionalCoversDTO> optListFinancial) {
		aprNonHosReviewPageUI.populateApproveAmntOPT(optListFinancial);	
	}
}
