 ...
 *
 */
public class SearchGeneratePARemainderTable extends GBaseTable<SearchGenerateReminderTableDTO>{
									...
									public void buttonClick(
										...
										if(reminderDto != null){
											...
											if(! isActiveHumanTask){
												...
												fireViewEvent(SearchGeneratePARemainderPresenter.GENERATE_PA_LETTER, reminderDto);
