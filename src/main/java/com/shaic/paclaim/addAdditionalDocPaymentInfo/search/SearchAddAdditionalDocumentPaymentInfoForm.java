...
public class SearchAddAdditionalDocumentPaymentInfoForm extends
		SearchComponent<SearchAddAdditionalDocumentPaymentInfoFormDTO> {
	...
	public void init() {
		...
		mainPanel.setCaption("Add Additional Document-Payment Information");
	...
	{
		this.binder = new BeanFieldGroup<SearchAddAdditionalDocumentPaymentInfoFormDTO>(SearchAddAdditionalDocumentPaymentInfoFormDTO.class);
		this.binder.setItemDataSource(new SearchAddAdditionalDocumentPaymentInfoFormDTO());
