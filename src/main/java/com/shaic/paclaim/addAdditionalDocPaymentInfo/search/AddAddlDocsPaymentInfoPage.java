...
public class AddAddlDocsPaymentInfoPage extends ViewComponent {
	@Inject
...
//	private UploadDocumentsTable uploadDocsTable;
	...
	@Inject
	private AddAddlPaymentInfoPageTable uploadedDocsTable;
	
	private BeanFieldGroup<UploadDocumentDTO> binder;
	
	@Inject
	private AddAddlDocsPaymentInfoGridForm uploadDocsTable;
	...
	{	
		...
		uploadDocsTable.init(bean.getUploadDocumentsDTO(), "Add Additional Documents Payment Info");
		...
		uploadedDocsTable.setPreseneterString(SHAConstants.PA_ADD_ADDITIONAL_PAYMENT_INFO);
	...
	private void setTableValues()
	{
		...
		{
			this.uploadDocsTable.init(new UploadDocumentDTO(),"Add Additional Documents Payment Info");
...
public boolean validatePage() {
	...
	public void editUploadedDocumentDetails(UploadDocumentDTO dto)
	{
		if(null != this.uploadDocsTable)
		{
			uploadDocsTable.init(dto,"Add Additional Documents Payment Info");
			uploadDocsTable.setFileTypeValues(fileTypeValues);
