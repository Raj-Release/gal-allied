...
public class PAHospSettlementPullBackViewImpl extends AbstractMVPView implements PAHospSettlementPullBackView, GMVPView{

	private static final long serialVersionUID = 1180651477021369571L;


	@Inject
	private Instance<PAHospSettlementPullBackUI> clearCashlessUIInstance;	 
	
	private PAHospSettlementPullBackUI clearCashlessUI;
