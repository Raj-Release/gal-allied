...
public class PAHospSearchSettlementPullBackForm  extends SearchComponent<PAHospSearchSettlementPullBackFormDTO> {
	...
	public void init() {
		...
		mainPanel.setCaption("Claim Final Approval Cancel");
	...
	{
		this.binder = new BeanFieldGroup<PAHospSearchSettlementPullBackFormDTO>(PAHospSearchSettlementPullBackFormDTO.class);
		this.binder.setItemDataSource(new PAHospSearchSettlementPullBackFormDTO());
