...
public class PABillEntryDetailsPageForAddAdditionalDetails  extends ViewComponent{
	...
	//	mainLayout.addComponent(benefitsPanel);
		...
		fireViewEvent(PAAddAdditionalDetailsPresenter.BILL_ENTRY_DETAILS_PAGE_UPLOADED_DOC_SETUP_DROPDOWN_VALUES, bean);
		return mainLayout;
	}
