...
public class PAAddAdditionalDetailsViewImpl extends AbstractMVPView implements PAAddAdditionalDetailsView{
	...
	@Inject
	private PABillEntryDetailsPageForAddAdditionalDetails billEntryDetailsPage;
