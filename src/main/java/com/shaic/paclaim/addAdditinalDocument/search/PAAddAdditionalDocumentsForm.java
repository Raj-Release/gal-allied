...
public class PAAddAdditionalDocumentsForm extends SearchComponent<SearchAddAdditionalDocumentFormDTO>{
	...
	public void init() {
		...
		mainPanel.setCaption("Add Additional Documents");
	...
	public VerticalLayout mainVerticalLayout(){
		...
		FormLayout formLayoutLeft = new FormLayout(txtIntimationNo,cmbAccidentOrDeath);
	...
	{
		this.binder = new BeanFieldGroup<SearchAddAdditionalDocumentFormDTO>(SearchAddAdditionalDocumentFormDTO.class);
		this.binder.setItemDataSource(new SearchAddAdditionalDocumentFormDTO());
