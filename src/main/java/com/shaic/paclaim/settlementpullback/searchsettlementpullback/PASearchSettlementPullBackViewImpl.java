...
public class PASearchSettlementPullBackViewImpl extends AbstractMVPView implements PASearchSettlementPullBackView {
	...
	@Inject
	private PASearchSettlementPullBackForm searchForm;
	
	@Inject
	private PASearchSettlementPullBackTable searchResultTable;
	...
	public void doSearch() {
		...
		if(searchForm.validatePage()){
			PASearchSettlementPullBackFormDTO searchDTO = searchForm.getSearchDTO();
			Pageable pageable = searchResultTable.getPageable();
			searchDTO.setPageable(pageable);
			String userName=(String)getUI().getSession().getAttribute(BPMClientContext.USERID);
			String passWord=(String)getUI().getSession().getAttribute(BPMClientContext.PASSWORD);
			fireViewEvent(PASearchSettlementPullBackPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
		} else {
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof PASearchSettlementPullBackTable)
			{
				((PASearchSettlementPullBackTable) comp).removeRow();
			}
		}
	}
	...
	@Override
	public void list(Page<PASearchSettlementPullBackDTO> tableRows) {
