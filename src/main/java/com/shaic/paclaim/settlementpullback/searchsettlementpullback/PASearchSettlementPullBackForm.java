...
public class PASearchSettlementPullBackForm  extends SearchComponent<PASearchSettlementPullBackFormDTO> {
	...
	{
		this.binder = new BeanFieldGroup<PASearchSettlementPullBackFormDTO>(PASearchSettlementPullBackFormDTO.class);
		this.binder.setItemDataSource(new PASearchSettlementPullBackFormDTO());
