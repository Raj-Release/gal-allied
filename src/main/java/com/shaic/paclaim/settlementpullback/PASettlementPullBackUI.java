...
public class PASettlementPullBackUI extends ViewComponent {
	...
	public void initView(PASearchSettlementPullBackDTO dto, NewIntimationDto newIntimationDTO) {
...
//		viewTrailsBtn.addStyleName(ValoTheme.BUTTON_LINK);
	...
	private HorizontalLayout buildSubmitAndCancelBtnLayout(final PASearchSettlementPullBackDTO dto) {
									...
									"No", "Yes", new ConfirmDialog.Listener() {
										...
										public void onClose(ConfirmDialog dialog) {
											if (!dialog.isConfirmed()) {
												fireViewEvent(PASettlementPullBackPresenter.SUBMIT_SETTLEMENT_PULL_BACK, dto);
											} else {
					...
					ConfirmDialog dialog = ConfirmDialog
							.show(getUI(),
									...
									"No", "Yes", new ConfirmDialog.Listener() {
										...
										public void onClose(ConfirmDialog dialog) {
											if (!dialog.isConfirmed()) {
												fireViewEvent(MenuItemBean.PA_SETTLEMENT_PULL_BACK,
														null);
											} else {
