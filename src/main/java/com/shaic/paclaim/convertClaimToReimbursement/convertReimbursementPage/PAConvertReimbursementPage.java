...
public class PAConvertReimbursementPage extends ViewComponent {
	...
	public void addListener(){
				        ...
				        "No", "Yes", new ConfirmDialog.Listener() {
				            ...
				            public void onClose(ConfirmDialog dialog) {
				                if (!dialog.isConfirmed()) {
				                	...
				                	fireViewEvent(MenuItemBean.CONVERT_PA_CLAIM_OUTSIDE_PROCESS, true);
				                } else {
				                    dialog.close();
				                }
				            }
		...
		convertbutton.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				fireViewEvent(PAConvertReimbursementPagePresenter.CONVERSION_REIMBURSEMENT,bean,searchFormDto);
				}
			}
		});
