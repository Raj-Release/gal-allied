...
@ViewInterface(PAHealthBillingWizard.class)
public class PAHealthBillingWizardPresenter extends AbstractMVPPresenter<PAHealthBillingWizard>{
	private static final long serialVersionUID = 7488192193097057694L;
	
	public static final String SUBMIT_CLAIM_BILLING = "PA_HEALTH_submit_claim_billing";
	
	public static final String SUBMIT_CLAIM_BILLING_MAPPING = "PA_HEALTH_submit_claim_billing_mapping";
	
	public static final String SAVE_BILLING_RRC_REQUEST_VALUES = "PA_HEALTH_save_billing_rrc_request_values";
	
	public static final String BILLING_LOAD_RRC_REQUEST_DROP_DOWN_VALUES = "PA_HEALTH_billing_load_rrc_request_drop_down_values";
	public static final String BILLING_LOAD_EMPLOYEE_DETAILS = "PA_HEALTH_billing_load_employee_details";
	
	public static final String VALIDATE_BILLING_USER_RRC_REQUEST = "PA_HEALTH_validate_billing_user_rrc_request"; 

	public static final String BILLING_RRC_REQUEST_SUB_CATEGORY_VALUES = "billing_rrc_request_sub_category_values";

	public static final String BILLING_RRC_REQUEST_SOURCE_VALUES = "billing_rrc_request_source_values";
...
//			}
			...
			if(!ReferenceTable.getReferToKeys().containsKey(reimbursement.getStatus().getKey())) {
				...
				//reimbursementService.mergeReimbursement(reimbursement);
				...
				{
					reimbursement.setCurrentProvisionAmt(reimbursementByKey.getCurrentProvisionAmt());
				}			
	...
	public void setUpSubCategoryValues(
			@Observes @CDIEvent(BILLING_RRC_REQUEST_SUB_CATEGORY_VALUES) final ParameterDTO parameters) {
	...
	public void setUpsourceValues(
			@Observes @CDIEvent(BILLING_RRC_REQUEST_SOURCE_VALUES) final ParameterDTO parameters) {
