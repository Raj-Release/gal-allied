...
@Alternative
public class PAHealthClaimRequestPreMedicalProcessingButtonsUI extends PreauthButtonsUI implements PreauthButtonListeners {
	...
	protected void addListener(){
		query.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				fireViewEvent(PAHealthClaimRequestPremedicalProcessingPagePresenter.ZONAL_REVIEW_SUGGEST_QUERY_EVENT, null);
			}
		});
		...
		suggestRejection.addClickListener(new ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				fireViewEvent(PAHealthClaimRequestPremedicalProcessingPagePresenter.ZONAL_REVIEW_SUGGEST_REJECTION_EVENT, null);
			}
		});
		sendForProcessing.addClickListener(new ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				fireViewEvent(PAHealthClaimRequestPremedicalProcessingPagePresenter.ZONAL_REVIEW_SUGGEST_APPROVAL_EVENT, null);
			}
		});
