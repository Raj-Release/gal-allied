 ...
 *
 */
public class PAHealthSearchProcessClaimRequestTable extends GBaseTable<PAHealthSearchProcessClaimRequestTableDTO>{
	private final Logger log = LoggerFactory.getLogger(PAHealthSearchProcessClaimRequestTable.class);

	private static final long serialVersionUID = -4966316904968477836L;
	private final static Object[] NATURAL_COL_ORDER = new Object[]{"serialNumber","intimationNo","ackAgeing","claimedAmountAsPerBill", "cpuName", "productName", "intimationSource",
		"insuredPatientName", "hospitalName", "hospitalType", "requestedAmt", "balanceSI","treatementType",  "speciality", "reasonForAdmission", "originatorID","originatorName", "claimType","documentReceivedFrom", "specialistOrQueryOrCoordinatorReqId", "specialistOrQueryOrCoordinatorReqName","status"}; 
	...
	public void initTable() {
		...
		table.setContainerDataSource(new BeanItemContainer<PAHealthSearchProcessClaimRequestTableDTO>(PAHealthSearchProcessClaimRequestTableDTO.class));
		table.setVisibleColumns(NATURAL_COL_ORDER);
		table.setHeight("320px");
	}

	
	public void alertMessage(final PAHealthSearchProcessClaimRequestTableDTO t, String message) {
...
//		dialog.setCaption("Alert");
				 ...
				 Date date3 = new Date();
					...
					try{
						if( isActiveHumanTask){
							...
							fireViewEvent(PAMenuPresenter.SHOW_PA_HEALTH_MEDICAL_APPROVAL_PROCESS_CLAIM_REQUEST, t);
	...
	//PAMenuPresenter.SHOW_PA_HEALTH_MEDICAL_APPROVAL_PROCESS_CLAIM_REQUEST, t
	@Override
	public void tableSelectHandler(
			PAHealthSearchProcessClaimRequestTableDTO t) {
