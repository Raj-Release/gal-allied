...
import com.shaic.paclaim.health.reimbursement.billing.wizard.pages.bililnghosp.PAHealthBillingHospitalizationPageUI;
...
public class PAHealthBillingProcessButtonsUI extends ViewComponent {
	...
	@Inject
	private PAHealthBillingHospitalizationPageUI billingHospitalizationPageUI;
	...
	private void addListener() {
		...
		referCoordinatorBtn.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				fireViewEvent(PAHealthBillingHospitalizationPagePresenter.BILLING_REFERCOORDINATOR_EVENT, null);
			}
		});
		...
		referToMedicalApproverBtn.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				fireViewEvent(PAHealthBillingHospitalizationPagePresenter.BILLING_REFER_TO_MEDICAL_APPROVER_EVENT, null);
			}
		});
		...
		cancelROD.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				fireViewEvent(PAHealthBillingHospitalizationPagePresenter.BILLING_CANCEL_ROD_EVENT, null);
			}
		});
		...
		//Vaadin8-setImmediate() btnBillAssessmentSheet.setImmediate(true);
		 ...
		 referToBillEntry.addClickListener(new Button.ClickListener() {
				...
				@Override
				public void buttonClick(ClickEvent event) {
					fireViewEvent(PAHealthBillingHospitalizationPagePresenter.BILLING_HOSPITALIZATION_REFER_TO_BILL_ENTRY, null);
				}
			});
		...
		btnBillAssessmentSheet.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				billingHospitalizationPageUI.setTableValuesForLegalSettlement();
				opener.open();
			}
		});
...
//		panel.setHeight("100%");
	...
	public void setBillingProcessPageObject(PAHealthBillingHospitalizationPageUI billingProcessPageUI){
		this.billingHospitalizationPageUI = billingProcessPageUI;
	}
