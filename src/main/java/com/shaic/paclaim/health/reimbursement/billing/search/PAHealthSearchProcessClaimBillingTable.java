 ...
 *
 */
public class PAHealthSearchProcessClaimBillingTable extends GBaseTable<PAHealthSearchProcessClaimBillingTableDTO>{

	private final static Object[] NATURAL_COL_ORDER = new Object[]{"serialNumber","intimationNo", "strCpuCode", "cpuName", "insuredPatientName", "productName","hospitalName", 
	...
	public void initTable() {
		...
		table.setContainerDataSource(new BeanItemContainer<PAHealthSearchProcessClaimBillingTableDTO>(PAHealthSearchProcessClaimBillingTableDTO.class));
	...
	public void alertMessage(final PAHealthSearchProcessClaimBillingTableDTO t, String message) {
...
//		dialog.setCaption("Alert");
				...
				//	Boolean isActiveHumanTask = SHAUtils.isActiveHumanTask(t.getUsername(),t.getPassword(),t.getTaskNumber(), session);
					...
					try{
						...
						if(isActiveHumanTask){
							...
							fireViewEvent(PAMenuPresenter.SHOW_PA_HEALTH_MEDICAL_APPROVAL_CLAIM_BILLING_SCREEN, t);
	...
	public void tableSelectHandler(
			PAHealthSearchProcessClaimBillingTableDTO t) {
	...
	//PAMenuPresenter.SHOW_PA_HEALTH_MEDICAL_APPROVAL_CLAIM_BILLING_SCREEN, t
