 ...
 *
 */
public class PAHealthSearchProcessClaimBillingForm extends SearchComponent<PAHealthSearchProcessClaimBillingFormDTO> {
	
	private static final long serialVersionUID = 4524670799179036664L;

	@Inject
	private PAHealthSearchProcessClaimBillingTable searchTable;
	...
	public VerticalLayout mainVerticalLayout(){
		...
		FormLayout formLayoutReight = new FormLayout(cbxType, cbxProductNameCode,cmbPriority);	
	...
	{
		this.binder = new BeanFieldGroup<PAHealthSearchProcessClaimBillingFormDTO>(PAHealthSearchProcessClaimBillingFormDTO.class);
		this.binder.setItemDataSource(new PAHealthSearchProcessClaimBillingFormDTO());
