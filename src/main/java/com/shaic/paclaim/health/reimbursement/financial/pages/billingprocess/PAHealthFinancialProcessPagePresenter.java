...
@ViewInterface(PAHealthFinancialProcessPageWizard.class)
public class PAHealthFinancialProcessPagePresenter extends AbstractMVPPresenter<PAHealthFinancialProcessPageWizard>{
	...
	public static final String SUM_INSURED_CALCULATION = "pa_health_financial_process_row_by_row_calculation";

	public static final String GET_PREAUTH_REQUESTED_AMOUT = "pa_health_financial_process_preauth_requested_amount";


	public static final String BILLING_PROCESS_SET_UP_REFERENCE = "pa_health_financial_process_set_up_reference";


	public static final String POST_HOSPITALIZATION_AMOUNT = "pa_health_financial_post_hospitalization_calculation";
	
	public static final String GET_CLAIM_RESTRICTION = "pa_health_financial_get_health_Care_claim_restriction";
	
	public static final String RECHARGE_SI_FOR_PRODUCT = "pa_health_recharging SI for product in Process claim financial";
