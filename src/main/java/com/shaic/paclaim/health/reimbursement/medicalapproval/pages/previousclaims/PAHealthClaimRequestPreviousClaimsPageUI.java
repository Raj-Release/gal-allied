...
public class PAHealthClaimRequestPreviousClaimsPageUI extends PreMedicalPreauthPreviousClaimsPageUI {
				...
				public void valueChange(ValueChangeEvent event) {
					...
					if (viewType.getValue() != null) {
						if (viewType.getValue().equals(POLICY_WISE)) {
							...
							fireViewEvent(PAHealthClaimRequestPreviousClaimsPagePresenter.MEDICAL_APPROVAL_PREVIOUS_CLAIM_DETAILS, bean);
			...
			cmbRelapseOfIllness.addValueChangeListener(new ValueChangeListener() {
				...
				public void valueChange(ValueChangeEvent event) {
					if(event.getProperty() != null && (SelectValue)event.getProperty().getValue() != null){// && ((SelectValue)event.getProperty().getValue()).getId() == ReferenceTable.COMMONMASTER_YES) {
						fireViewEvent(PAHealthClaimRequestPreviousClaimsPagePresenter.MEDICAL_APPROVAL_RELAPSE_OF_ILLNESS_CHANGED, bean, (SelectValue)event.getProperty().getValue());
					}
