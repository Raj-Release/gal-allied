...
public class PABillEntryUploadDocumentsPage  extends ViewComponent{
...
//		}
		...
		uploadDocsTable.init(bean.getUploadDocumentsDTO(), "PA Bill Entry");
		...
		uploadedDocsTable.initPresenter(SHAConstants.PA_BILL_ENTRY);
	...
	private void setTableValues()
	{
		if(null != this.uploadDocsTable)
		{
			...
			this.uploadDocsTable.init(new UploadDocumentDTO(), "PA Bill Entry");
...
//			this.uploadedTblList.remove(dto);
	...
	public void editUploadedDocumentDetails(UploadDocumentDTO dto)
	{
		if(null != this.uploadDocsTable)
		{
			uploadDocsTable.init(dto,"PA Bill Entry");
			uploadDocsTable.setFileTypeValues(fileTypeValues);
