...
@ViewInterface(PABillEntryUploadDocumentsView.class)
public class PABillentryUploadDocumentsPresenter extends AbstractMVPPresenter<PABillEntryUploadDocumentsView>{
	
	public static final String BILL_ENTRY_UPLOAD_DOC_SETUP_DROPDOWN_VALUES = "bill_entry_upload_doc_setup_dropdown_values_PA";
	
	public static final String BILL_ENTRY_SUBMIT_UPLOADED_DOCUMENTS = "bill_entry_submit_uploaded_documents_PA";
	
	public static final String BILL_ENTRY_DELETE_UPLOADED_DOCUMENTS = "bill_entry_delete_uploaded_documents_PA";	
	
	public static final String BILL_ENTRY_EDIT_UPLOADED_DOCUMENTS = "bill_entry_edit_uploaded_documents_PA";
