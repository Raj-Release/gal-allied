...
public class PABillEntryUploadDocumentsViewImpl extends AbstractMVPView implements PABillEntryUploadDocumentsView {

	
	@Inject
	private PABillEntryUploadDocumentsPage uploadDocumentsPage;
	...
	public Component getContent() {
		...
		fireViewEvent(PABillentryUploadDocumentsPresenter.BILL_ENTRY_UPLOAD_DOC_SETUP_DROPDOWN_VALUES, null);
		// TODO Auto-generated method stub
		return comp;
	}
