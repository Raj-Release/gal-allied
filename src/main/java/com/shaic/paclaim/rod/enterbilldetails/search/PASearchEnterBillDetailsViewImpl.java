...
public class PASearchEnterBillDetailsViewImpl extends AbstractMVPView implements PASearchEnterBillDetailsView{

	private static final long serialVersionUID = 1L;

	@Inject
	private PASearchEnterBillDetailsForm  searchForm;
	
	@Inject
	private PASearchEnterBillDetailsTable searchResultTable;
	...
	public void doSearch() {
		...
		fireViewEvent(PASearchEnterBillDetailsPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof PASearchEnterBillDetailsTable)
			{
				((PASearchEnterBillDetailsTable) comp).removeRow();
			}
		}
