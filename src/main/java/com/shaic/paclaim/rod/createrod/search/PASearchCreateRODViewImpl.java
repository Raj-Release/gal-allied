...
public class PASearchCreateRODViewImpl extends AbstractMVPView implements PASearchCreateRODView{

	
	@Inject
	private PASearchCreateRODForm  searchForm;
	
	@Inject
	private PASearchCreateRODTable searchResultTable;
	...
	public void doSearch() {
		...
		fireViewEvent(PASearchCreateRODPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
