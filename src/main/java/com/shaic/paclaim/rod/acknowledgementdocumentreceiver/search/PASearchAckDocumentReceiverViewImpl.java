...
public class PASearchAckDocumentReceiverViewImpl extends AbstractMVPView implements PASearchAckDocumentReceiverView{

	
	@Inject
	private PASearchAckDocumentReceiverForm  searchForm;
	
	@Inject
	private PASearchAckDocumentReceiverTable searchResultTable;
	...
	public void doSearch() {
		...
		fireViewEvent(PASearchAckDocumentReceiverPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof PASearchAckDocumentReceiverTable)
			{
				((PASearchAckDocumentReceiverTable) comp).removeRow();
			}
		}
