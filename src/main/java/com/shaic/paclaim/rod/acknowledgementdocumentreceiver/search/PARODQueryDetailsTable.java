...
public class PARODQueryDetailsTable extends GBaseTable<RODQueryDetailsDTO>{
...
/*	@PersistenceContext(unitName = "PERSISTENCE_UNIT_NAME", type = PersistenceContextType.EXTENDED)
	...
	private static final Object[] NATURAL_COL_ORDER = new Object[] {
			...
			"serialNumber","rodNo", "benifitOrCover", "diagnosis",
...
static {
		...
		fieldMap.put("benifitOrCover", new TableFieldDTO("benifitOrCover",TextField.class, String.class, false));
...
//				 RODQueryDetailsDTO queryDetai	ls1 = (RODQueryDetailsDTO) itemId;
...
//				 }
	...
	//							Label noteLabel = new Label("<b style = 'color: red;'>  In case of query next step would be </br> viewing the letter and confirming </b>", ContentMode.HTML);
								...
								HashMap<String, Button> messageBoxButtons = GalaxyAlertBox
										.createAlertBox("<b style = 'color: red;'>A query is available, are you sure these documents are not related/ reply to query.</b>", buttonsNamewithType);
								...
								homeButton.addClickListener(new ClickListener() {
									...
									public void buttonClick(ClickEvent event) {
										...
										{
											fireViewEvent(PAAcknowledgementDocumentDetailsPresenter.SET_DOC_REC_STATUS_FOR_QUERY_REPLY, queryDetails);
										}
										else if (SHAConstants.CREATE_ROD.equalsIgnoreCase(presenterString))
										{
											fireViewEvent(PACreateRODDocumentDetailsPresenter.ROD_SET_DOC_REC_STATUS_FOR_QUERY_REPLY, queryDetails);
											
										}
										else if (SHAConstants.PA_BILL_ENTRY.equalsIgnoreCase(presenterString))
										{
											fireViewEvent(PABillEntryDocumentDetailsPresenter.BILL_ENTRY_SET_DOC_REC_STATUS_FOR_QUERY_REPLY, queryDetails);
...
//			}
	...
	/*	Map<Long, String> valuesMap = new HashMap<Long, String>();
		...
		//if(null != bean && ( null != bean.getReceivedStatus() || null != bean.getNoOfDocuments() || null != bean.getRemarks()))
				...
				/*if(("No").equalsIgnoreCase(bean.getReplyStatus())){
...
*/			
	...
	public boolean isQueryReplyNo()
	{
		boolean QueryReply = false;
		errorMessages.removeAll(getErrors());
		@SuppressWarnings("unchecked")
		Collection<RODQueryDetailsDTO> itemIds = (Collection<RODQueryDetailsDTO>) table.getItemIds();
		Integer queryCount = 0;
