 ...
 */
@Stateless
public class PASearchProcessFieldVisitService extends AbstractDAO<Intimation>{
	...
	public PASearchProcessFieldVisitService() {
		super();
	...
	*/}
	...
	private List<SearchFieldVisitTableDTO> getIntimationData(String intimationNo,Long fvrKey,Long rodKey,Integer taskNumber){
		...
		intimationsList = typedQuery.getResultList();
			...
			List<SearchFieldVisitTableDTO> tableDTO = PASearchProcessFieldVisitMapper.getInstance().getIntimationDTO(doList);
