 ...
 *
 */
public class SearchGeneratePARemainderBulkViewImpl extends AbstractMVPView implements SearchGeneratePARemainderBulkView{
	...
	@Inject
	private SearchGeneratePARemainderBulkForm  searchForm;
	
	private SearchGeneratePARemainderBulkTable searchResultTable;
	
	@Inject
	private ShowPAReminderLetterBulkPage showReminderLetterPage;
...
//		searchForm.refresh();
	...
	public void doSearch() {
		...
		if(searchDTO != null){
			...
			fireViewEvent(SearchGeneratePARemainderBulkPresenter.PA_SEARCH_BULK_BUTTON_CLICK, searchDTO,userName,passWord);	
		}
		else{
			return;
		}
...
//		reminderLetterDto.setPassword(passWord);
		fireViewEvent(SearchGeneratePARemainderBulkPresenter.SUBMIT_PA_BULK_LETTER, bulkReminderDto);
	}
