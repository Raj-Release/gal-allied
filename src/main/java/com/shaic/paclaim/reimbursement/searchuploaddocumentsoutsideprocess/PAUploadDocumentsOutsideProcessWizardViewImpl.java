...
public class PAUploadDocumentsOutsideProcessWizardViewImpl extends AbstractMVPView implements PAUploadDocumentsOutSideProcessWizardView{



	@Inject
	private Instance<PAUploadDocumentsOutsideProcessPageView> searchUploadDocumentsPageObj;
	private PAUploadDocumentsOutsideProcessPageView searchUploadDocumentsPage;
...
/*		item.addNestedProperty("documentDetails.documentCheckList");
	...
	public void initView(ReceiptOfDocumentsDTO rodDTO)
	{
		...
		viewDetails.initView(bean.getClaimDTO().getNewIntimationDto().getIntimationId(),0l, ViewLevels.PREAUTH_MEDICAL,"Acknowledge Receipt of Documents");
		...
		public void buildSuccessLayout() {
			...
			homeButton.addClickListener(new ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					dialog.close();
					fireViewEvent(MenuItemBean.PA_SEARCH_OR_UPLOAD_DOCUMENTS_FOR_ACK_NOT_RECEIVED, null);
	...
	public void wizardCompleted(WizardCompletedEvent event) {
		...
		{
			fireViewEvent(PAUploadDocumentsOutsideProcessWizard.SUBMIT_SEARCH_OR_UPLOAD_DOCUMENTS, bean);
		}
	}
