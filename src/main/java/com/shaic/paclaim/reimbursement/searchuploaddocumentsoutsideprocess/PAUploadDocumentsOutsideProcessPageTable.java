...
public class PAUploadDocumentsOutsideProcessPageTable extends GEditableTable<UploadDocumentDTO>{
	...
	public PAUploadDocumentsOutsideProcessPageTable() {
		super(PAUploadDocumentsOutsideProcessPageTable.class);
		setUp();
	}
		    	...
		    	editButton.addClickListener(new Button.ClickListener() {
					...
					public void buttonClick(ClickEvent event) {
						...
						uploadDTO.setIsEdit(true);
							fireViewEvent(PAUploadDocumentsOutsideProcessPagePresenter.EDIT_SEARCH_OR_UPLOADED_UPLOADED_DOCUMENTS, uploadDTO);
	...
	public void tableSelectHandler(UploadDocumentDTO t) {		
			fireViewEvent(PAUploadDocumentsOutsideProcessPagePresenter.DELETE_SEARCH_OR_UPLOADED_UPLOADED_DOCUMENTS,t);
				}
