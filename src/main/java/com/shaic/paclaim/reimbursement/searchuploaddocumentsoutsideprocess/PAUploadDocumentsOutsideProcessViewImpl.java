...
public class PAUploadDocumentsOutsideProcessViewImpl  extends AbstractMVPView implements PAUploadDocumentsOutsideProcessView{



	@Inject
	private PAUploadDocumentsOutsideProcessForm searchForm;
	
	@Inject
	private PAUploadDocumentsOutsideProcessTable searchResultTable;
...
private VerticalSplitPanel mainPanel;
	...
	public void doSearch() {
		...
		fireViewEvent(PAUploadDocumentsOutsideProcessPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
		}
		else
		{
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof PAUploadDocumentsOutsideProcessTable)
			{
				((PAUploadDocumentsOutsideProcessTable) comp).removeRow();
			}
		}
