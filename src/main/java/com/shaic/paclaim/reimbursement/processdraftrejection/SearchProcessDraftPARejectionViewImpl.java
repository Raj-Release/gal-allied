 ...
 *
 */
public class SearchProcessDraftPARejectionViewImpl extends AbstractMVPView implements SearchProcessDraftPARejectionView{

	
	@Inject
	private SearchProcessDraftPARejectionForm  searchForm;
	
	@Inject
	private SearchProcessDraftPARejectionTable searchResultTable;
	...
	public void doSearch() {
		SearchProcessDraftRejectionFormDTO searchDTO = searchForm.getSearchDTO();
		Pageable pageable = searchResultTable.getPageable();
		searchDTO.setPageable(pageable);
		searchDTO.setLobKey(ReferenceTable.PA_LOB_KEY);
		String userName=(String)getUI().getSession().getAttribute(BPMClientContext.USERID);
		String passWord=(String)getUI().getSession().getAttribute(BPMClientContext.PASSWORD);
		fireViewEvent(SearchProcessDraftPARejectionPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchProcessDraftPARejectionTable)
			{
				((SearchProcessDraftPARejectionTable) comp).removeRow();
			}
		}
