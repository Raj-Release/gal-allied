 ...
 *
 */
public class SearchProcessDraftPARejectionForm extends SearchComponent<SearchProcessDraftRejectionFormDTO> {
	
	@Inject
	private SearchProcessDraftPARejectionTable searchTable;
	...
	public VerticalLayout mainVerticalLayout(){
		...
		FormLayout formLayoutLeft = new FormLayout(txtIntimationNo,cbxCPUCode,cmbType);
