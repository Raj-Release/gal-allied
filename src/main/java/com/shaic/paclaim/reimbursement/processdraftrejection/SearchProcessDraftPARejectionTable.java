 ...
 *
 */
public class SearchProcessDraftPARejectionTable extends GBaseTable<SearchProcessDraftRejectionTableDTO>{
	...
	public void initTable() {
		...
		table.setContainerDataSource(new BeanItemContainer<SearchProcessDraftRejectionTableDTO>(SearchProcessDraftRejectionTableDTO.class));
	...
	public void tableSelectHandler(
			SearchProcessDraftRejectionTableDTO t) {
		...
		try{
			if(! isActiveHumanTask){
				...
				fireViewEvent(MenuItemBean.PA_DRAFT_REJECTION_LETTER_WIZARD, t);
			}else{
...
//		fireViewEvent(MenuItemBean.DRAFT_REJECTION_LETTER_WIZARD, t);
	...
	public String textBundlePrefixString() {
		...
		return "search-process-default-rejection-";
	}
