 ...
 *
 */
public class ConfirmPAQueryViewImpl extends AbstractMVPView implements
WizardStep<ClaimQueryDto> {

	@Inject
	private ConfirmPAQueryPage confirmQueryPage;
	
	@Inject
	private Instance<DecideOnPAQueryView> decideOnQueryView;
	...
	public ClaimQueryDto getUpdatedBean(){
		return this.bean;
	}
