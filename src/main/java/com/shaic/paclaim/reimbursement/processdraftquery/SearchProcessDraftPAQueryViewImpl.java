 ...
 *
 */
public class SearchProcessDraftPAQueryViewImpl extends AbstractMVPView implements SearchProcessDraftPAQueryView{

	
	@Inject
	private SearchProcessDraftPAQueryForm  searchForm;
	
	@Inject
	private SearchProcessDraftPAQueryTable searchResultTable;
	...
	public void doSearch() {
		SearchProcessDraftQueryFormDTO searchDTO = searchForm.getSearchDTO();
		Pageable pageable = searchResultTable.getPageable();
		searchDTO.setPageable(pageable);
		searchDTO.setLobKey(ReferenceTable.PA_LOB_KEY);
		String userName=(String)getUI().getSession().getAttribute(BPMClientContext.USERID);
		String passWord=(String)getUI().getSession().getAttribute(BPMClientContext.PASSWORD);
		fireViewEvent(SearchProcessDraftPAQueryPresenter.SEARCH_PROCESS_PA_QUERY_BUTTON_CLICK, searchDTO,userName,passWord);
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchProcessDraftPAQueryTable)
			{
				((SearchProcessDraftPAQueryTable) comp).removeRow();
			}
		}
	...
	public void list(Page<SearchProcessDraftQueryTableDTO> tableRows) {
		...
		else
		{
			...
			Button homeButton = new Button("Process Query Home");
	...
	public void init(BeanItemContainer<SelectValue> parameter, BeanItemContainer<SelectValue> selectValueForPriority, BeanItemContainer<SelectValue> statusByStage) {
		searchForm.setCPUCode(parameter,selectValueForPriority,statusByStage);
