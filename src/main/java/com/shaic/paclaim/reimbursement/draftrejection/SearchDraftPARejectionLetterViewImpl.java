 ...
 *
 */
public class SearchDraftPARejectionLetterViewImpl extends AbstractMVPView implements SearchDraftPARejectionLetterView{

	
	@Inject
	private SearchDraftPARejectionLetterForm  searchForm;
	
	@Inject
	private SearchDraftPARejectionLetterTable searchResultTable;
	...
	public void doSearch() {
		...
		fireViewEvent(SearchDraftPARejectionLetterPresenter.SEARCH_PA_REJECTION_BUTTON_CLICK, searchDTO,userName,passWord);
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchDraftPARejectionLetterTable)
			{
				((SearchDraftPARejectionLetterTable) comp).removeRow();
			}
		}
