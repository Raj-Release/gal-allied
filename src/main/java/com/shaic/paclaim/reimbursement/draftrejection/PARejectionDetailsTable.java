...
public class PARejectionDetailsTable extends GBaseTable<ReimbursementRejectionDetailsDto>{
		...
		private static final Object[] NATURAL_COL_ORDER = new Object[] {"select","rejectionNo","acknowledgementNo", "rodNo", "documentReceivedFrom", "benefitsAndCovers", 
