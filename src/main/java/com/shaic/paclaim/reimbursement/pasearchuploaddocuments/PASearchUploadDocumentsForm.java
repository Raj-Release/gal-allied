...
public class PASearchUploadDocumentsForm extends SearchComponent<SearchUploaddocumentsFormDTO>{
	...
	public void init() {
		...
		mainPanel.setCaption("Search/Upload Documents");
	...
	public VerticalLayout mainVerticalLayout(){
		...
		FormLayout formLayoutRight = new FormLayout(txtAckNo,txtPolicyNo);
...
/*		absoluteLayout_3
	...
	{
		this.binder = new BeanFieldGroup<SearchUploaddocumentsFormDTO>(SearchUploaddocumentsFormDTO.class);
		this.binder.setItemDataSource(new SearchUploaddocumentsFormDTO());
	...
	public void setDropDownValues(BeanItemContainer<SelectValue> type) 
	{
		...
		selectUploadedDocuments.setValue("Uploaded documents");
	...
	public String validate()
	{
		...
		if((null != txtAckNo && (null == txtAckNo.getValue() || txtAckNo.getValue().equals(""))) && (null != txtPolicyNo && (null == txtPolicyNo.getValue()|| txtPolicyNo.getValue().equals(""))) 
				&& (null != txtIntimationNo && (null == txtIntimationNo.getValue() || txtIntimationNo.getValue().equals("")))){
			
			return err = "Please Select Search by Acknowledgement Or Intimation Or Policy Number";
		}
