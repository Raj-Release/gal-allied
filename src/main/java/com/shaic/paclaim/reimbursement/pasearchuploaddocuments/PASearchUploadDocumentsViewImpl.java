...
public class PASearchUploadDocumentsViewImpl extends AbstractMVPView implements PASearchUploadDocumentsView{


	@Inject
	private PASearchUploadDocumentsForm searchForm;
	
	@Inject
	private PASearchUploadDocumentsTable searchResultTable;
...
private VerticalSplitPanel mainPanel;
	...
	public void doSearch() {
		...
		fireViewEvent(PASearchUploaddocumentsPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
		}
		else
		{
	...
	public void list(Page<SearchUploadDocumentsTableDTO> tableRows) {
		...
		else
		{
			...
			{
				fireViewEvent(PASearchUploaddocumentsPresenter.SEARCH_INVALID_INTIMATION, searchDTO.getIntimationNo());
			}
			...
			{
				fireViewEvent(PASearchUploaddocumentsPresenter.SEARCH_INVALID_ACK_NO, searchDTO.getAckNo());
			}
			else if(null != searchDTO && (null != searchDTO.getAckNo() && !("").equalsIgnoreCase(searchDTO.getAckNo())) && (null != searchDTO.getIntimationNo() && !("").equalsIgnoreCase(searchDTO.getIntimationNo())))
