...
public class PASearchUploadDocumentsPageTable extends GEditableTable<UploadDocumentDTO> {
	...
	public PASearchUploadDocumentsPageTable() {
		super(PASearchUploadDocumentsPageTable.class);
		setUp();
	}
		    	...
		    	editButton.addClickListener(new Button.ClickListener() {
					...
					public void buttonClick(ClickEvent event) {
						...
						uploadDTO.setIsEdit(true);
							fireViewEvent(PASearchUploadDocumentsPagePresenter.EDIT_SEARCH_OR_UPLOADED_UPLOADED_DOCUMENTS, uploadDTO);
	...
	public void tableSelectHandler(UploadDocumentDTO t) {		
			fireViewEvent(PASearchUploadDocumentsPagePresenter.DELETE_SEARCH_OR_UPLOADED_UPLOADED_DOCUMENTS,t);
				}
