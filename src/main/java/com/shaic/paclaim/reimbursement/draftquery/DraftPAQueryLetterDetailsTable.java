...
public class DraftPAQueryLetterDetailsTable extends GEditableTable<DraftQueryLetterDetailTableDto> {

	private List<DraftQueryLetterDetailTableDto> deltedQueryDraftRemarksList;
	
	public DraftPAQueryLetterDetailsTable() {
...
//		fieldMap.put("sno", new TableFieldDTO("sno", TextField.class, String.class, false));
		...
		fieldMap.put("draftOrRedraftRemarks", new TableFieldDTO("draftOrRedraftRemarks", TextField.class, String.class, true, true, 495, 500));
...
//		table.getContainerProperty("DraftQueryLetterDetailTableDto", "sno").setValue(table.getContainerDataSource().size());
	...
	public void deleteRow(Object itemId) {
		...
		fireViewEvent(DraftPAQueryLetterDetailPresenter.DELETE_DRAFT_PA_LETTER_REMARKS,itemId);
