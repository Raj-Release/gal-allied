...
public class DraftPAQueryLetterDetailViewImpl extends AbstractMVPView implements DraftPAQueryLetterDetailView{
	...
	private DraftPAQueryLetterDetailPage draftQueryLetterDetailPage;
	
	@Inject
	private Instance<DraftPAQueryLetterDetailPage> draftQueryLetterDetailPageInstance;
...
//	}
	...
	public boolean onSave() {
		...
		fireViewEvent(DraftPAQueryLetterDetailPresenter.SAVE_DRAFT_PA_QUERY, reimbQueryDto);
		return true;
	}
...
//		draftQueryLetterDetailPage.repaintNomineeTableValues(queryDto.getReimbursementDto().getClaimDto().getNewIntimationDto().getNomineeList());
		draftQueryLetterDetailPage.repaintNomineeTableValues(queryDto);
