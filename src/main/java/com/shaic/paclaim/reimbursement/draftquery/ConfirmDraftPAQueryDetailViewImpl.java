 ...
 *
 */
public class ConfirmDraftPAQueryDetailViewImpl extends AbstractMVPView implements
WizardStep<SearchDraftQueryLetterTableDTO> {

	@Inject
	private ConfirmDraftPAQueryDetailPage confirmQueryPage;
	
	@Inject
	private Instance<DraftPAQueryLetterDetailViewImpl> decideOndraftQueryView;
