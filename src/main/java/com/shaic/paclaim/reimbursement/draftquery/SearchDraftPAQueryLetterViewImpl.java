 ...
 *
 */
public class SearchDraftPAQueryLetterViewImpl extends AbstractMVPView implements SearchDraftPAQueryLetterView{

	
	@Inject
	private SearchDraftPAQueryLetterForm  searchForm;
	
	@Inject
	private SearchDraftPAQueryLetterTable searchResultTable;
	...
	public void doSearch() {
		SearchDraftQueryLetterFormDTO searchDTO = searchForm.getSearchDTO();
		Pageable pageable = searchResultTable.getPageable();
		searchDTO.setPageable(pageable);
		searchDTO.setLobKey(ReferenceTable.PA_LOB_KEY);
		String userName=(String)getUI().getSession().getAttribute(BPMClientContext.USERID);
		String passWord=(String)getUI().getSession().getAttribute(BPMClientContext.PASSWORD);
		fireViewEvent(SearchDraftPAQueryLetterPresenter.PA_QUERY_SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchDraftPAQueryLetterTable)
			{
				((SearchDraftPAQueryLetterTable) comp).removeRow();
			}
		}
	...
	public void list(Page<SearchDraftQueryLetterTableDTO> tableRows) {
		...
		else
		{
			...
			Button homeButton = new Button("Draft Query Letter Home");
