 ...
 *
 */
public class PASearchProcessClaimBillingViewImpl extends AbstractMVPView implements PASearchProcessClaimBillingView{

	
	@Inject
	private PASearchProcessClaimBillingForm  searchForm;
	
	@Inject
	private PASearchProcessClaimBillingTable searchResultTable;
	...
	public void doSearch() {
		...
		fireViewEvent(PASearchProcessClaimBillingPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof PASearchProcessClaimBillingTable)
			{
				((PASearchProcessClaimBillingTable) comp).removeRow();
			}
		}
