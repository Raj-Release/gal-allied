 ...
 *
 */
public class PASearchProcessClaimBillingTable extends GBaseTable<SearchProcessClaimBillingTableDTO>{
	...
	private final static Object[] NATURAL_COL_ORDER = new Object[]{"serialNumber","intimationNo", "strCpuCode", "cpuName", "insuredPatientName", "productName","coverBenefits","hospitalName", 
					"hospitalAddress", "dateOfAdmission", "reasonForAdmission","claimType","documentReceivedFrom","claimAmt", "type","originatorID","originatorName","accidentOrDeath"}; 
				...
				//	Boolean isActiveHumanTask = SHAUtils.isActiveHumanTask(t.getUsername(),t.getPassword(),t.getTaskNumber(), session);
					...
					try{
						...
						if(isActiveHumanTask){
							...
							fireViewEvent(PAMenuPresenter.SHOW_PA_MEDICAL_APPROVAL_CLAIM_BILLING_SCREEN, t);
