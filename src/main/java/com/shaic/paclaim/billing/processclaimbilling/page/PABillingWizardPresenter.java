...
@ViewInterface(PABillingWizard.class)
public class PABillingWizardPresenter extends AbstractMVPPresenter<PABillingWizard>{
	private static final long serialVersionUID = 7488192193097057694L;
	
	public static final String SUBMIT_CLAIM_BILLING = "pa_submit_claim_billing";
	
	public static final String SUBMIT_CLAIM_BILLING_MAPPING = "pa_submit_claim_billing_mapping";
	
	public static final String SAVE_BILLING_RRC_REQUEST_VALUES = "pa_save_billing_rrc_request_values";
	
	public static final String BILLING_LOAD_RRC_REQUEST_DROP_DOWN_VALUES = "pa_billing_load_rrc_request_drop_down_values";
	public static final String BILLING_LOAD_EMPLOYEE_DETAILS = "pa_billing_load_employee_details";
	
	public static final String VALIDATE_BILLING_USER_RRC_REQUEST = "pa_validate_billing_user_rrc_request"; 
	
	public static final String PA_VALIDATE_OPTIONAL_COVERS = "pa_validate_optional_covers_billing";
	public static final String PA_BILLING_LOAD_RRC_REQUEST_SUB_CATEGORY_VALUES = "pa_billing_load_rrc_request_sub_category_values";

	public static final String PA_BILLING_LOAD_RRC_REQUEST_SOURCE_VALUES = "pa_billing_load_rrc_request_source_values";
	...
	public void submitWizard(
			@Observes @CDIEvent(SUBMIT_CLAIM_BILLING) final ParameterDTO parameters) {
...
//			}
			...
			*/}else {
			 ...
			 * */
			if(!ReferenceTable.getReferToKeys().containsKey(reimbursement.getStatus().getKey()) || (reimbursementDTO.getStatusKey().equals(ReferenceTable.BILLING_CANCEL_ROD))) {
	...
	public void validateCoversForClaim(@Observes @CDIEvent(PA_VALIDATE_OPTIONAL_COVERS) final ParameterDTO parameters) {		
		Long coverId = (Long) parameters.getPrimaryParameter();
		TextField eligibleFld = (TextField) parameters.getSecondaryParameter(0,TextField.class);
		
		//Boolean isValid = paReimbService.validateCoversForClaims(dto.getClaimDTO().getKey(), dto.getKey(), coverId);
		view.validateOPtionalCovers(coverId,eligibleFld);
}
	...
	public void setUpSubCategoryValues(
			@Observes @CDIEvent(PA_BILLING_LOAD_RRC_REQUEST_SUB_CATEGORY_VALUES) final ParameterDTO parameters) {
	...
	public void setUpsourceValues(
			@Observes @CDIEvent(PA_BILLING_LOAD_RRC_REQUEST_SOURCE_VALUES) final ParameterDTO parameters) {
