 ...
 *
 */
public class PASearchHospCoverProcessClaimBillingViewImpl extends AbstractMVPView implements PASearchHospCoverProcessClaimBillingView{

	
	@Inject
	private PASearchHospCoverProcessClaimBillingForm  searchForm;
	
	@Inject
	private PASearchHospCoverProcessClaimBillingTable searchResultTable;
	...
	public void doSearch() {
		...
		fireViewEvent(PASearchHospCoverProcessClaimBillingPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof PASearchHospCoverProcessClaimBillingTable)
			{
				((PASearchHospCoverProcessClaimBillingTable) comp).removeRow();
			}
		}
	...
	public void list(Page<SearchProcessClaimBillingTableDTO> tableRows) {
		...
		else
		{
			...
			else
			{
				...
				Button homeButton = new Button("Process Claim Billing(Hosp Cover) Home");
