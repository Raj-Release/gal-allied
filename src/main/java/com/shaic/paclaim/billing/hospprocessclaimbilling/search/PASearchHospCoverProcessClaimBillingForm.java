...
public class PASearchHospCoverProcessClaimBillingForm extends SearchComponent<SearchProcessClaimBillingFormDTO> {
	
	@Inject
	private PASearchHospCoverProcessClaimBillingTable searchTable;
	...
	public void init() {
		...
		mainPanel.setCaption("Process Claim Billing (Hosp Cover)");
