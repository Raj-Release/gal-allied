...
@ViewInterface(PAHospCoverBillingWizard.class)
public class PAHospCoverBillingWizardPresenter extends AbstractMVPPresenter<PAHospCoverBillingWizard>{
	private static final long serialVersionUID = 7488192193097057694L;
	
	public static final String SUBMIT_CLAIM_BILLING = "pa_submit_claim_hosp_cvr";
	
	public static final String SUBMIT_CLAIM_BILLING_MAPPING = "pa_submit_claim_hosp_cvr_mapping";
	
	public static final String SAVE_BILLING_RRC_REQUEST_VALUES = "pa_save_hosp_cvr_rrc_request_values";
	
	public static final String BILLING_LOAD_RRC_REQUEST_DROP_DOWN_VALUES = "pa_hosp_cvr_load_rrc_request_drop_down_values";
	public static final String BILLING_LOAD_EMPLOYEE_DETAILS = "pa_hosp_cvr_load_employee_details";
	
	public static final String VALIDATE_BILLING_USER_RRC_REQUEST = "pa_validate_hosp_cvr_user_rrc_request"; 
