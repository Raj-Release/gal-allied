...
public class PAHospCoverBillingReviewPageViewImpl extends AbstractMVPView implements PAHospCoverBillingReviewPageWizard {

	private static final long serialVersionUID = -1756934701433733987L;
	
	@Inject
	private PAHospCoverBillingReviewPageUI billingReviewPage;
...
//		fireViewEvent(PAHospCoverBillingReviewPagePresenter.BILLING_REVIEW_SET_UP_REFERENCE, bean);
		return comp;
	}
	...
	public boolean onAdvance() {
		if(billingReviewPage.validatePage()){
			...
			fireViewEvent(PAHospCoverBillingReviewPagePresenter.BILLING_DETAILS_UPDATE, bean);
			fireViewEvent(PAHospCoverBillingReviewPagePresenter.GET_MAPPING_DATA, bean.getKey(), true);
...
//				}
			...
			fireViewEvent(PAHospCoverBillingReviewPagePresenter.GET_MAPPING_DATA, bean.getKey(), false);
	...
	public boolean onBack() {
		fireViewEvent(PAHospCoverBillingReviewPagePresenter.GET_MAPPING_DATA, bean);
		return true;
	}
