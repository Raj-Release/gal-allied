...
@ViewInterface(PAHospCoverBillingReviewPageWizard.class)
public class PAHospCoverBillingReviewPagePresenter extends AbstractMVPPresenter<PAHospCoverBillingReviewPageWizard>{
	...
	public static final String BILLING_HOSPITAL_BENEFITS = "pa_hosp_hospital_cash_benefits";
	public static final String BILLING_PATIENT_CARE_BENEFITS = "pa_hosp_patiet_care_benefits";
//	public static final String BILLING_REVIEW_SET_UP_REFERENCE = "billing_review_set_up_reference";


	public static final String BILLING_TREATMENT_TYPE_CHANGED = "pa_hosp_treatment_type_changed";


	public static final String BILLING_COORDINATOR = "pa_hosp_coordinator";
	...
	public static final String BILLING_PATIENT_STATUS_CHANGED = "pa_hosp_patient_status_changed for PA";


	public static final String BILL_ENTRY_TABLE_CATEGORY_DROPDOWN_VALUE = "pa_hosp_bill_entry_category_values";
	...
	public static final String BILL_ENTRY_COMPLETION_STATUS = "pa_hosp_bill_entry_completion_status";
	
	public static final String BILLING_DETAILS_UPDATE = "pa_hosp_update_details";
	...
	public static final String BILLING_BILL_REVIEW_IRDA_LEVEL2_VALUES = "pa_hosp_bill_review_irda_level2_values";
	
	public static final String BILLING_BILL_REVIEW_IRDA_LEVEL3_VALUES = "pa_hosp_bill_review_irda_level3_values";


	public static final String GET_MAPPING_DATA = "pa_hosp_get_mapping_data";
	
	public static final String COMPARE_WITH_PREVIOUS_ROD = "pa_process_Claim_billing_compare_with_previous_rod";
	
	public static final String BILLING_REFERCOORDINATOR_EVENT = "pa_hosp_refer_to_coordinator_event_for_first_page";
	
	public static final String BILLING_CANCEL_ROD_EVENT="pa_hosp_cancel_rod_event_for_first_page";
	
	public static final String BILLING_REFER_TO_MEDICAL_APPROVER_EVENT = "pa_hosp_refer_to_medical_approver_event_for_first_page";
	
	public static final String BILLING_SAVE_BILL_ENTRY_VALUES = "pa_hosp_save_bill_entry_values";
	
	public static final String BILLING_LOAD_BILL_DETAILS_VALUES = "pa_hosp_load_bill_details_values";

	public static final String BILLING_REFER_TO_BILL_ENTRY = "pa_hosp_refer_to_bill_entry";

	public static final String PA_HOSP_COVER_BILLING_UPDATE_PRODUCT_BASED_AMT = "pa_hosp_cover_billing_update_product_based_amt";
...
//		referenceData.put("previousPreauth", previousPreauthService.search(dto.getClaimKey()));
...
//		Double sumInsured = dbCalculationService.getInsuredSumInsured(dto.getNewIntimationDTO().getInsuredPatient().getInsuredId().toString(), dto.getPolicyDto().getKey());
//		if (sumInsured == 0) {
...
//			referenceData.put("sublimitDBDetails", dbCalculationService.getClaimedAmountDetailsForSection(dto.getPolicyDto().getProduct().getKey(), sumInsured, insuredAge,dto.getPreauthDataExtractionDetails().getSection().getId(),
//					dto.getNewIntimationDTO().getPolicy().getPolicyPlan() != null ? dto.getNewIntimationDTO().getPolicy().getPolicyPlan() : "0"));
//		}else{
//			
//			referenceData.put("sublimitDBDetails", dbCalculationService.getClaimedAmountDetailsForSection(dto.getPolicyDto().getProduct().getKey(), sumInsured, insuredAge,0l,"0"));
//		}
//		
//		
...
//		referenceData.put("criticalIllness", preauthService.getCriticalIllenssMasterValues());
...
//				}
	 ...
	 public void setProductBasedAmt(
				@Observes @CDIEvent(PA_HOSP_COVER_BILLING_UPDATE_PRODUCT_BASED_AMT) final ParameterDTO parameters) {
