 ...
 *
 */
public class SearchPAPrintRemainderBulkForm extends SearchComponent<SearchPrintRemainderBulkFormDTO> {
	
	@Inject
	private SearchPAPrintRemainderBulkTable searchTable;
	...
	public VerticalLayout buildPrintReminderLetterLayout(){
		...
		searchBatchOrIntimationBtn.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				if(searchDTO != null){
					fireViewEvent(SearchPAPrintRemainderBulkPresenter.SEARCH_PA_BULK_PRINT_BATCH_ID_BUTTON_CLICK, searchDTO);
				}
...
//		searchTable.setTableList(prevBatchList);
	...
	public SearchPAPrintRemainderBulkTable getSearchTable(){
