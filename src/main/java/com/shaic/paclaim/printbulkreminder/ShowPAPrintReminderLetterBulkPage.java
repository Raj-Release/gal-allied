...
public class ShowPAPrintReminderLetterBulkPage extends ViewComponent {
	
	private ShowPAPrintReminderLetterBulkPage instance;
	SearchPAPrintRemainderBulkViewImpl parent;
	
	public void initView(final SearchPAPrintRemainderBulkViewImpl parent, String fileUrl,PrintBulkReminderResultDto bulkReminderDto) {
		this.instance = this;
		this.parent = parent;
