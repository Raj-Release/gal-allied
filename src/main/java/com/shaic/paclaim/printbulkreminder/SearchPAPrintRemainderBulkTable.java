 ...
 *
 */
public class SearchPAPrintRemainderBulkTable extends GBaseTable<PrintBulkReminderResultDto>{
	...
	private SearchPAPrintRemainderBulkView parent;
		
	public void initview(SearchPAPrintRemainderBulkView parent){
		this.parent = parent;
	}
								...
								.addClickListener(new Button.ClickListener() {
									public void buttonClick(
										...
										if(reminderDto != null){
												...
												fireViewEvent(SearchPAPrintRemainderBulkPresenter.PRINT_PA_BULK_LETTER, reminderDto);
...
//										getUI().addWindow(dialog);
										...
										if(letterDto != null){
												...
												fireViewEvent(SearchPAPrintRemainderBulkPresenter.COMPLETED_PA_BUTTON_CLICK, reminderDto);
										}
							        } 
							    });
						generateLetterButton.addStyleName("link");
...
//							
					...
					exportBtn.addClickListener(new Button.ClickListener() {
						...
						public void buttonClick(ClickEvent event) {
							...
							fireViewEvent(SearchPAPrintRemainderBulkPresenter.EXPORT_PA_BULK_PRINT_REMINDER_LIST,reminderBulkDto);
