...
public class ManagerFeedBackClaimTable extends GEditableTable<ManagerFeedBackPolicyTableDto> {
	private List<ManagerFeedBackPolicyTableDto> climRemarksList;
	
	@EJB
	private MasterService masterService;

	public ManagerFeedBackClaimTable() {
		super(ManagerFeedBackPolicyTableDto.class);
		// TODO Auto-generated constructor stub
		climRemarksList = new ArrayList<ManagerFeedBackPolicyTableDto>();
	}
	...
	protected Map<String, TableFieldDTO> getFiledMapping() {
		...
		fieldMap.put("intimationNO", new TableFieldDTO("intimationNO", TextField.class, String.class,true,true,350,50));
	...
	public void deleteRow(Object itemId) {
		...
		climRemarksList.add((ManagerFeedBackPolicyTableDto)itemId);
	...
	public void initTable() {
		...
		table.setContainerDataSource(new BeanItemContainer<ManagerFeedBackPolicyTableDto>(ManagerFeedBackPolicyTableDto.class));
		 Object[] VISIBLE_COLUMNS = new Object[] {
			"serialNumber", "intimationNO", "fbCategory","remarks"};
		table.setVisibleColumns(VISIBLE_COLUMNS);
		table.setColumnCollapsingAllowed(false);
		
		table.setColumnExpandRatio("intimationNO",80.0f);
		...
		if(!table.getVisibleItemIds().contains("fbCategory")){
			...
			table.addGeneratedColumn("fbCategory", new Table.ColumnGenerator() {
			      ...
			      public Object generateCell(final Table source, final Object itemId, Object columnId) {
				    	 ...
				    	 GComboBox comboBox = new GComboBox();
				    	 comboBox.setNullSelectionAllowed(false);
				    	 BeanItemContainer<SelectValue> selectValueContainer = masterService.getSelectValueCategoryContainer(ReferenceTable.FEEDBACK_TYPE_CLAIM_GMC);
