...
public class PreviousFeedbackViewLinkTable  extends GBaseTable<BranchManagerPreviousFeedbackTableDTO> {
	...
	private final static Object[] CLAIM_COL_ORDER = new Object[]{"serialNumber", "claimNumber", "feedBackRemarks", "claimsDepartmentReply"};
		...
		.addValueChangeListener(new Property.ValueChangeListener() {
			...
			public void valueChange(
				...
				{  
					...
					BranchManagerPreviousFeedbackTableDTO tableDTO = (BranchManagerPreviousFeedbackTableDTO)txtField.getData();
