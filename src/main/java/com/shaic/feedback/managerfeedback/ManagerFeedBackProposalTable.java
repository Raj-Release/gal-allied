 ...
 *
 */
public class ManagerFeedBackProposalTable extends GEditableTable<ManagerFeedBackPolicyTableDto> {
	
	private List<ManagerFeedBackPolicyTableDto> proposalRemarksList;
	
	@EJB
	private MasterService masterService;

	public ManagerFeedBackProposalTable() {
		super(ManagerFeedBackPolicyTableDto.class);
		// TODO Auto-generated constructor stub
		setUp();
		proposalRemarksList = new ArrayList<ManagerFeedBackPolicyTableDto>();
	}
	...
	protected Map<String, TableFieldDTO> getFiledMapping() {
		...
		fieldMap.put("proposalNO", new TableFieldDTO("proposalNO", TextField.class, String.class,true,true,350,50));
	...
	public void deleteRow(Object itemId) {
		...
		proposalRemarksList.add((ManagerFeedBackPolicyTableDto)itemId);
	...
	public void initTable() {
		...
		table.setContainerDataSource(new BeanItemContainer<ManagerFeedBackPolicyTableDto>(ManagerFeedBackPolicyTableDto.class));
		 Object[] VISIBLE_COLUMNS = new Object[] {
			"serialNumber", "proposalNO","fbCategory","remarks"};
		table.setVisibleColumns(VISIBLE_COLUMNS);
		table.setColumnCollapsingAllowed(false);
		
		table.setColumnExpandRatio("proposalNO",80.0f);
		table.setColumnExpandRatio("remarks",82.0f);		
		table.setWidth("95%");
...
//			    	  field.setWidth("350px");
		...
		if(!table.getVisibleItemIds().contains("fbCategory")){
			...
			table.addGeneratedColumn("fbCategory", new Table.ColumnGenerator() {
			      ...
			      public Object generateCell(final Table source, final Object itemId, Object columnId) {
				    	 ...
				    	 GComboBox comboBox = new GComboBox();
				    	 comboBox.setNullSelectionAllowed(false);
				    	 BeanItemContainer<SelectValue> selectValueContainer = masterService.getSelectValueCategoryContainer(ReferenceTable.FEEDBACK_TYPE_MER);
	...
	public String textBundlePrefixString() {
		// TODO Auto-generated method stub
		 return "manager-feedback-proposal-";
	}
