...
public class ReceivedPhysicalDocumentDetailsViewImpl extends AbstractMVPView implements ReceivedPhysicalDocumentDetailsView{
	...
	@Inject
	private ReceivedPhysicalDocumentDetailsPage documentDetailsPage;
...
//		fireViewEvent(DocumentDetailsPresenter.BILL_ENTRY_SETUP_DROPDOWN_VALUES, bean);
