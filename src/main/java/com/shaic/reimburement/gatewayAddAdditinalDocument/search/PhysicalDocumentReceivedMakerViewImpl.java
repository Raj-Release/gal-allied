...
public class PhysicalDocumentReceivedMakerViewImpl extends AbstractMVPView implements PhysicalDocumentReceivedMakerView{
	...
	@PostConstruct
	public void initView(String screenName) {
		addStyleName("view");
		setSizeFull();
		this.screenName = screenName;
		searchForm.init(screenName);
	...
	public void doSearch() {
		...
		if(( (null == searchDTO.getIntimationNo() || searchDTO.getIntimationNo().isEmpty()) && (null == searchDTO.getPolicyNo() ||  searchDTO.getPolicyNo().isEmpty()))){
			fireViewEvent(PhysicalDocumentReceivedMakerPresenter.SEARCH_ERROR, searchDTO,userName,passWord);
				...
				fireViewEvent(PhysicalDocumentReceivedMakerPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord,screenName);
	...
	public void list(Page<PhysicalDocumentReceivedMakerTableDTO> tableRows) {
		...
		else
		{
			...
			Button homeButton = new Button("Physical Document Verification Home");
