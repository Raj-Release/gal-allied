 ...
 *
 */
public class SearchApproveClaimForm extends SearchComponent<SearchApproveClaimFormDTO>{
	...
	public void init() {
		...
		mainPanel.setCaption("Approve Claim (Special Approval)");
	...
	{
		this.binder = new BeanFieldGroup<SearchApproveClaimFormDTO>(SearchApproveClaimFormDTO.class);
		this.binder.setItemDataSource(new SearchApproveClaimFormDTO());
