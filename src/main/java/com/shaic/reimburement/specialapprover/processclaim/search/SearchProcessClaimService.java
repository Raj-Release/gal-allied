 ...
 */
@Stateless
public class SearchProcessClaimService extends AbstractDAO<Intimation>{
	...
	public SearchProcessClaimService() {
		super();
	}

	public  Page<SearchProcessClaimTableDTO> search(
			SearchProcessClaimFormDTO searchFormDTO,
		...
		List<SearchProcessClaimTableDTO> tableDTO = SearchProcessClaimMapper.getInstance().getIntimationDTO(doList);
		...
		List<SearchProcessClaimTableDTO> result = new ArrayList<SearchProcessClaimTableDTO>();
		result.addAll(tableDTO);
		Page<SearchProcessClaimTableDTO> page = new Page<SearchProcessClaimTableDTO>();
	...
	private List<SearchProcessClaimTableDTO> getclaimNumber(List<SearchProcessClaimTableDTO> intimationList){
		Claim a_claim = null;
	...
	private List<SearchProcessClaimTableDTO> getHospitalDetails(
			List<SearchProcessClaimTableDTO> tableDTO) {
