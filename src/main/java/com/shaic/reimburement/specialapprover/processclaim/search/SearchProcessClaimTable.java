 ...
 *
 */
public class SearchProcessClaimTable extends GBaseTable<SearchProcessClaimTableDTO>{
	...
	public void initTable() {
		table.setContainerDataSource(new BeanItemContainer<SearchProcessClaimTableDTO>(SearchProcessClaimTableDTO.class));
		table.setVisibleColumns(NATURAL_COL_ORDER);
		table.setHeight("331px");
	}

	@Override
	public void tableSelectHandler(SearchProcessClaimTableDTO t) {
