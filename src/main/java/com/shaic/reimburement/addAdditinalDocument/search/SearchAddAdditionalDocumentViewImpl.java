 ...
 *
 */
public class SearchAddAdditionalDocumentViewImpl  extends AbstractMVPView implements SearchAddAdditionalDocumentView {

	@Inject
	private SearchAddAdditionalDocumentForm searchForm;
	
	@Inject
	private SearchAddAdditionalDocumentTable searchResultTable;
...
private VerticalSplitPanel mainPanel;
	...
	public void doSearch() {
		...
		if(( (null == searchDTO.getIntimationNo() || searchDTO.getIntimationNo().isEmpty()) && (null == searchDTO.getPolicyNo() ||  searchDTO.getPolicyNo().isEmpty()))){
			fireViewEvent(SearchAddAdditionalDocumentPresenter.SEARCH_ERROR, searchDTO,userName,passWord);
			} else{
				fireViewEvent(SearchAddAdditionalDocumentPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
