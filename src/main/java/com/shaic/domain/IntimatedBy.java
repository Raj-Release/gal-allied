...
/**
 * The persistent class for the MAS_INTIMATED_BY_T database table.
 * 
 */
@Entity
@Table(name="MAS_INTIMATED_BY")
@NamedQuery(name="IntimatedBy.findAll", query="SELECT m FROM IntimatedBy m")
public class IntimatedBy implements Serializable {
