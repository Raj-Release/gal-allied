...
//
///**
// * The persistent class for the MAS_RELATIONSHIP_T database table.
// * 
// */
//@Entity
//@Table(name="MAS_RELATIONSHIP_T")
//@NamedQuery(name="Relationship.findAll", query="SELECT m FROM Relationship m")
