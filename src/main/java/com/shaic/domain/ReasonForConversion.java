...
/**
 * The persistent class for the MAS_REASON_FOR_CONVERSION_T database table.
 * 
 */
@Entity
@Table(name="MAS_REASON_FOR_CONVERSION")
@NamedQuery(name="ReasonForConversion.findAll", query="SELECT m FROM ReasonForConversion m")
public class ReasonForConversion implements Serializable {
