...
/**
 * The persistent class for the MAS_NETWORK_HOSPITAL_T database table.
 * 
 */
@Entity
@Table(name="MAS_NETWORK_HOSPITAL")
@NamedQuery(name="NetworkHospital.findAll", query="SELECT m FROM NetworkHospital m")
public class NetworkHospital implements Serializable {
