...
@Entity
@Table(name="IMS_CLS_BILL_POST_HOSPITAL")
@NamedQueries( {
@NamedQuery(name="BillingPostHospitalisation.findAll", query="SELECT m FROM BillingPostHospitalisation m"),
@NamedQuery(name = "BillingPostHospitalisation.findByReimbursement",query = "select o from BillingPostHospitalisation o where o.reimbursement.key = :reimbursementKey")
})

public class BillingPostHospitalisation {
...
*/
    ...
    public boolean equals(Object obj) {
        if (obj == null || !getClass().isAssignableFrom(obj.getClass())) {
            ...
            return getKey().equals(((BillingPostHospitalisation) obj).getKey());
        }
    }
