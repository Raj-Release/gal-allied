...
/**
 * The persistent class for the MAS_HOSPITAL_TYPE_T database table.
 * 
 */
@Entity
@Table(name="MAS_HOSPITAL_TYPE")
@NamedQuery(name="HospitalType.findAll", query="SELECT m FROM HospitalType m")
