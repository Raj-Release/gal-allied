...
/**
 * The persistent class for the MAS_ADMISSION_TYPE_T database table.
 * 
 */
@Entity
@Table(name="MAS_ADMISSION_TYPE")
@NamedQuery(name="AdmissionType.findAll", query="SELECT m FROM AdmissionType m")
public class AdmissionType implements Serializable {
    ...
    public boolean equals(Object obj) {
        if (obj == null || !getClass().isAssignableFrom(obj.getClass())) {
            ...
            return getKey().equals(((AdmissionType) obj).getKey());
        }
    }
