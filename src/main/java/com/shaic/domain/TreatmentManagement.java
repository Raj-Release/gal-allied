...
/**
 * The persistent class for the MAS_TREATMENT_MANAGEMENT_T database table.
 * 
 */
@Entity
@Table(name="MAS_TREATMENT_MANAGEMENT")
@NamedQuery(name="TreatmentManagement.findAll", query="SELECT m FROM TreatmentManagement m")
