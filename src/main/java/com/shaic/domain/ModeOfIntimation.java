...
/**
 * The persistent class for the MAS_MODE_OF_INTIMATION_T database table.
 * 
 */
@Entity
@Table(name="MAS_MODE_OF_INTIMATION")
@NamedQuery(name="ModeOfIntimation.findAll", query="SELECT m FROM ModeOfIntimation m")
public class ModeOfIntimation implements Serializable {
