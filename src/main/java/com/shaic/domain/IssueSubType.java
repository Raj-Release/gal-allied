...
/**
 * The persistent class for the MAS_ISSUE_SUB_TYPE_T database table.
 * 
 */
@Entity
@Table(name="MAS_ISSUE_SUB_TYPE")
@NamedQuery(name="IssueSubType.findAll", query="SELECT m FROM IssueSubType m")
public class IssueSubType implements Serializable {
