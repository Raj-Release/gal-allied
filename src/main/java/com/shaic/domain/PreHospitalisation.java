...
@Entity
@Table(name="IMS_CLS_PRE_HOSPITALIZATION")
@NamedQueries( {
@NamedQuery(name="PreHospitalisation.findAll", query="SELECT m FROM PreHospitalisation m"),
@NamedQuery(name = "PreHospitalisation.findByReimbursement",query = "select o from PreHospitalisation o where o.reimbursement.key = :reimbursementKey")
})

public class PreHospitalisation {
