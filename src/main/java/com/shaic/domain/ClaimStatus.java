...
/**
 * The persistent class for the MAS_CLAIM_STATUS_T database table.
 * 
 */
@Entity
@Table(name="MAS_CLAIM_STATUS")
@NamedQuery(name="ClaimStatus.findAll", query="SELECT m FROM ClaimStatus m")
