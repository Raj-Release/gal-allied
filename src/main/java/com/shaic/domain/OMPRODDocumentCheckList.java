 ...
 */
@Entity
@Table(name = "IMS_CLS_OMP_ROD_DOCUMENT_LIST")
@NamedQueries({
	@NamedQuery(name = "OMPRODDocumentCheckList.findAll", query = "SELECT i FROM OMPRODDocumentCheckList i"),
	@NamedQuery(name = "OMPRODDocumentCheckList.findByKey", query = "SELECT o FROM OMPRODDocumentCheckList o where o.key = :docListKey and o.docTypeId is not null"),
	@NamedQuery(name = "OMPRODDocumentCheckList.findByDocAck", query = "SELECT o FROM OMPRODDocumentCheckList o where o.docAcknowledgement.key = :docAck and o.docTypeId is not null"),
	@NamedQuery(name = "OMPRODDocumentCheckList.findByDocKey", query = "SELECT o FROM OMPRODDocumentCheckList o where o.docAcknowledgement.key = :docKey and o.docTypeId is not null")
})
public class OMPRODDocumentCheckList  extends AbstractEntity{
	
	@Id
	@SequenceGenerator(name="IMS_CLS_OMP_ROD_DOCUMENT_LIST_KEY_GENERATOR", sequenceName = "SEQ_OMP_DOCUMENT_LIST_KEY", allocationSize = 1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="IMS_CLS_OMP_ROD_DOCUMENT_LIST_KEY_GENERATOR" ) 
