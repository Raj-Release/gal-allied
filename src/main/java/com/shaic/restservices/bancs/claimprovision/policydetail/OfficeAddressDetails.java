...
public class OfficeAddressDetails {
	...
	private String phoneNoOfDirectLine;
	private String stdCodeOfDirectLine;
	...
	public String getPhoneNoOfDirectLine() {
		return phoneNoOfDirectLine;
	}
	public void setPhoneNoOfDirectLine(String phoneNoOfDirectLine) {
		this.phoneNoOfDirectLine = phoneNoOfDirectLine;
	}
	public String getStdCodeOfDirectLine() {
		return stdCodeOfDirectLine;
	}
	public void setStdCodeOfDirectLine(String stdCodeOfDirectLine) {
		this.stdCodeOfDirectLine = stdCodeOfDirectLine;
	}
