 ...
 *
 */
public class SearchGenerateRemainderViewImpl extends AbstractMVPView implements SearchGenerateRemainderView{

	
	@Inject
	private SearchGenerateRemainderForm  searchForm;
	
	@Inject
	private SearchGenerateRemainderTable searchResultTable;
	
	@Inject
	private ShowReminderLetterPage showReminderLetterPage;
	...
	public void doSearch() {
		...
		searchDTO.setLobId(ReferenceTable.HEALTH_LOB_KEY);
		Pageable pageable = searchResultTable.getPageable();
		searchDTO.setPageable(pageable);
		String userName=(String)getUI().getSession().getAttribute(BPMClientContext.USERID);
		String passWord=(String)getUI().getSession().getAttribute(BPMClientContext.PASSWORD);
		fireViewEvent(SearchGenerateRemainderPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
...
//		}
	...
	public void submitReminderLetter(){
		...
		fireViewEvent(SearchGenerateRemainderPresenter.SUBMIT_LETTER, reminderLetterDto);
	}
	...
	public void addFooterButtons(){
		...
		closeButton.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				fireViewEvent(SearchGenerateRemainderPresenter.CLEAR_SEARCH_FORM,null);
				fireViewEvent(MenuItemBean.GENERATE_REMINDER_LETTER_CLAIM_WISE,null);				
			}
		});
		...
		clearButton.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				fireViewEvent(SearchGenerateRemainderPresenter.RESET_SEARCH_FORM,null);
