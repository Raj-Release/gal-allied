...
public class GenerateReminderLetterDetailViewImpl extends AbstractMVPView implements GenerateReminderLetterDetailView{

	@Inject
	private Instance<RevisedCarousel> commonCarouselInstance;
	
	private GenerateReminderLetterDetailPage generateReminderLetterPage;
	
	@Inject
	private Instance<GenerateReminderLetterDetailPage> generateReminderLetterDetailPageInstance;
