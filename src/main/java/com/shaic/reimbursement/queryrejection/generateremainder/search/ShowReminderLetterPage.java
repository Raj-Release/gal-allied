...
public class ShowReminderLetterPage extends ViewComponent {
	
	private ShowReminderLetterPage instance;
	SearchGenerateRemainderViewImpl parent;
	
	public void initView(final SearchGenerateRemainderViewImpl parent, String fileUrl) {
		this.instance = this;
		this.parent = parent;
