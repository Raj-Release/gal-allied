 ...
 *
 */
public class SearchProcessDraftRejectionViewImpl extends AbstractMVPView implements SearchProcessDraftRejectionView{

	
	@Inject
	private SearchProcessDraftRejectionForm  searchForm;
	
	@Inject
	private SearchProcessDraftRejectionTable searchResultTable;
	...
	public void doSearch() {
		...
		fireViewEvent(SearchProcessDraftRejectionPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchProcessDraftRejectionTable)
			{
				((SearchProcessDraftRejectionTable) comp).removeRow();
			}
		}
	...
	public void list(Page<SearchProcessDraftRejectionTableDTO> tableRows) {
		...
		{	
			...
			for (SearchProcessDraftRejectionTableDTO tableDto : tableRows.getPageItems()) {
