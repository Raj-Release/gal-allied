 ...
 *
 */
public class SearchProcessDraftRejectionForm extends SearchComponent<SearchProcessDraftRejectionFormDTO> {
	
	@Inject
	private SearchProcessDraftRejectionTable searchTable;
	...
	public SearchProcessDraftRejectionFormDTO getSearchDTO()
	{
		try {
			this.binder.commit();
			SearchProcessDraftRejectionFormDTO bean = this.binder.getItemDataSource().getBean();
			return  bean;
	...
	{
		this.binder = new BeanFieldGroup<SearchProcessDraftRejectionFormDTO>(SearchProcessDraftRejectionFormDTO.class);
		this.binder.setItemDataSource(new SearchProcessDraftRejectionFormDTO());
