 ...
 *
 */
public class SearchProcessDraftQueryViewImpl extends AbstractMVPView implements SearchProcessDraftQueryView{

	
	@Inject
	private SearchProcessDraftQueryForm  searchForm;
	
	@Inject
	private SearchProcessDraftQueryTable searchResultTable;
	...
	public void doSearch() {
		...
		fireViewEvent(SearchProcessDraftQueryPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchProcessDraftQueryTable)
			{
				((SearchProcessDraftQueryTable) comp).removeRow();
			}
		}
	...
	public void list(Page<SearchProcessDraftQueryTableDTO> tableRows) {
		...
		{	
			...
			for (SearchProcessDraftQueryTableDTO tableDto : tableRows.getPageItems()) {
		...
		else
		{
			...
			homeButton.addClickListener(new ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					dialog.close();
					fireViewEvent(MenuItemBean.PROCESS_DRAFT_QUERY_LETTER, null);
