 ...
 *
 */
public class SearchDraftQueryLetterForm extends SearchComponent<SearchDraftQueryLetterFormDTO> {

	private BeanFieldGroup<SearchDraftQueryLetterFormDTO> binder;
	
	@Inject
	private SearchDraftQueryLetterTable searchTable;
	...
	public SearchDraftQueryLetterFormDTO getSearchDTO()
	{
		try {
			this.binder.commit();
			SearchDraftQueryLetterFormDTO bean = this.binder.getItemDataSource().getBean();
			return  bean;
