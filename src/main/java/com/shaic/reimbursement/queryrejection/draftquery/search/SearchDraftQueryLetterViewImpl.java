 ...
 *
 */
public class SearchDraftQueryLetterViewImpl extends AbstractMVPView implements SearchDraftQueryLetterView{

	
	@Inject
	private SearchDraftQueryLetterForm  searchForm;
	
	@Inject
	private SearchDraftQueryLetterTable searchResultTable;
	...
	public void doSearch() {
		...
		fireViewEvent(SearchDraftQueryLetterPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchDraftQueryLetterTable)
			{
				((SearchDraftQueryLetterTable) comp).removeRow();
			}
		}
	...
	public void list(Page<SearchDraftQueryLetterTableDTO> tableRows) {
		...
		{	
			...
			for (SearchDraftQueryLetterTableDTO tableDto : tableRows.getPageItems()) {
