...
public class ShowReminderLetterBulkPage extends ViewComponent {
	
	private ShowReminderLetterBulkPage instance;
	SearchGenerateRemainderBulkViewImpl parent;
	
	public void initView(final SearchGenerateRemainderBulkViewImpl parent, String fileUrl,BulkReminderResultDto bulkReminderDto) {
		this.instance = this;
		this.parent = parent;
