...
public class BulkReminderResultDto {
	...
	private List<SearchGenerateReminderBulkTableDTO> resultListDto;
...
//	private List<String> selectedFileUrls;
	...
	public List<SearchGenerateReminderBulkTableDTO> getResultListDto() {
		return resultListDto;
	}
	public void setResultListDto(
			List<SearchGenerateReminderBulkTableDTO> resultListDto) {
