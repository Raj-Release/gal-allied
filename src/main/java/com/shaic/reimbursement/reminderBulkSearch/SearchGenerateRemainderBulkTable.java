 ...
 *
 */
public class SearchGenerateRemainderBulkTable extends GBaseTable<BulkReminderResultDto>{
	...
	private SearchGenerateRemainderBulkView parent;
		
	public void initview(SearchGenerateRemainderBulkView parent){
		this.parent = parent;
	}
...
//							}
							...
							fireViewEvent(SearchGenerateRemainderBulkPresenter.EXPORT_BULK_REMINDER_LIST,reminderBulkDto);
								...
								.addClickListener(new Button.ClickListener() {
									public void buttonClick(
										...
										if(reminderDto != null){
												...
												fireViewEvent(SearchGenerateRemainderBulkPresenter.GENERATE_BULK_LETTER, reminderDto);
