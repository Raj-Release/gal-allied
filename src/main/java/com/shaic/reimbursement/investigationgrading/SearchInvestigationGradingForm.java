...
public class SearchInvestigationGradingForm extends SearchComponent<SearchAssignInvestigationFormDTO>{

	@Inject
	private SearchInvestigationGradingTable searchTable;
...
//	private ComboBox cmbPriorityNew;
	...
	public void init() {
		...
		mainPanel.setCaption("Investigation Grading");
...
//		cmbPriorityNew = binder.buildAndBind("Priority","priorityNew",ComboBox.class);
		...
		mainVerticalLayout.addComponent(absoluteLayout_3);
		 ...
		 absoluteLayout_3.setHeight("228px");
