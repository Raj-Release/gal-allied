...
public class SearchInvestgationGradingViewImpl extends AbstractMVPView implements SearchInvestigationGradingView{
	...
	@Inject
	private SearchInvestigationGradingForm  searchForm;
	
	@Inject
	private SearchInvestigationGradingTable	 searchResultTable;
	...
	public void doSearch() {
		...
		fireViewEvent(SearchInvestigationGradingPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchInvestigationGradingTable)
			{
				((SearchInvestigationGradingTable) comp).removeRow();
			}
		}
	...
	public void list(Page<SearchAssignInvestigationTableDTO> tableRows) {
		...
		else
		{
			...
			Button homeButton = new Button("Investigation Grading Home");
