...
public class AssignInvestigationWizardViewImpl extends AbstractMVPView
	...
	public void initView(AssignInvestigatorDto assignInvestigatorDto) {
		...
		//	confirmationViewImpl.init(assignInvestigatorDto);
			...
			String hospAddressValue = dbCalculationService.getHospitalAddress(this.assignInvestigatorDto.getClaimDto()
			...
			String proposerAddressValue = dbCalculationService.getProposerAddress(this.assignInvestigatorDto.getClaimDto()
	...
	private HorizontalLayout commonButtonsLayout() {
		...
		if(assignInvestigatorDto.getPreauthDTO().getNewIntimationDTO() !=null && assignInvestigatorDto.getPreauthDTO().getNewIntimationDTO().getPolicy().getProduct().getCode() != null
				&& assignInvestigatorDto.getPreauthDTO().getNewIntimationDTO().getPolicy().getProduct().getCode().equalsIgnoreCase(SHAConstants.PRODUCT_CODE_78)){
			buyBackPedHLayout = SHAUtils.buyBackPed(assignInvestigatorDto.getPreauthDTO());
			icrAgentBranch.addComponent(buyBackPedHLayout);
		}
		if(assignInvestigatorDto.getPreauthDTO().getNewIntimationDTO() !=null && assignInvestigatorDto.getPreauthDTO().getNewIntimationDTO().getPolicy().getProduct().getCode() != null
				&& assignInvestigatorDto.getPreauthDTO().getNewIntimationDTO().getPolicy().getProduct().getCode().equalsIgnoreCase(SHAConstants.PRODUCT_CODE_88)){
			buyBackPedHLayout = SHAUtils.buyBackPed(assignInvestigatorDto.getPreauthDTO());
			icrAgentBranch.addComponent(buyBackPedHLayout);
		}
