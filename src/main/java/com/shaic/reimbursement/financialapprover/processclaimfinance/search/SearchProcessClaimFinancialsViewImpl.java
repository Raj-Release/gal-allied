...
//	}
		...
		else
		{
			...
			if(searchDTO.getIntimationNo() != null && !searchDTO.getIntimationNo().isEmpty() && searchDTO.getIntimationNo().length() > 0  && 
					(null == searchDTO.getPolicyNo() ||  searchDTO.getPolicyNo().isEmpty()) && (null == searchDTO.getCpuCode())  
					 && (null == searchDTO.getType()) && (null == searchDTO.getProductName()) && (null == searchDTO.getClaimType())
					 && (null == searchDTO.getSource()) && (null == searchDTO.getPriority()) && (null == searchDTO.getClaimedAmountFrom())
					 && (null == searchDTO.getClaimedAmountTo() && (null == searchDTO.getNetworkHospType()))
					) {
	...
	public void setUpDropDownValues(BeanItemContainer<SelectValue> claimType,
		...
		searchForm.setUpDropDownValues(claimType,productName,cpuCode,type,statusByStage,networkHospTypeParameter);
