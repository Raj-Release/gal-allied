...
//>>>>>>> 33089fd2ea65506eb901441220d70fd5f3dc2bf6
					...
					if(null != searchFormDTO.getNetworkHospType()) {
						
						if(searchFormDTO.getNetworkHospType().getId() != null && searchFormDTO.getNetworkHospType().getId().equals(ReferenceTable.NETWORK_HOSPITAL)){
							strNetworkHospType=searchFormDTO.getNetworkHospType().getValue();
							mapValues.put(SHAConstants.NETWORK_TYPE, strNetworkHospType);
							
						}else if(searchFormDTO.getNetworkHospType().getId() != null && searchFormDTO.getNetworkHospType().getId().equals(ReferenceTable.AGREED_NETWORK_HOSPITAL)){
							strNetworkHospType=searchFormDTO.getNetworkHospType().getValue();
							mapValues.put(SHAConstants.NETWORK_TYPE, strNetworkHospType);
							
						}else if(searchFormDTO.getNetworkHospType().getId() != null && searchFormDTO.getNetworkHospType().getId().equals(ReferenceTable.GREEN_NETWORK_HOSPITAL)){
							strNetworkHospType=searchFormDTO.getNetworkHospType().getValue();
						
							mapValues.put(SHAConstants.NETWORK_TYPE, strNetworkHospType);
						
						}else if(searchFormDTO.getNetworkHospType().getId() != null && searchFormDTO.getNetworkHospType().getId().equals(ReferenceTable.FSP)){
							strNetworkHospType=searchFormDTO.getNetworkHospType().getValue();
