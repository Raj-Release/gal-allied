...
//		cmbPriorityNew = binder.buildAndBind("Priority","priorityNew",ComboBox.class);
		...
		FormLayout formLayoutLeft = new FormLayout(txtIntimationNo,cmbCpuCode,cmbPriority,priority);
		...
		FormLayout formLayoutRight = new FormLayout(txtClaimedAmountFrom,txtClaimedAmountTo,cmbNetworkHospType);
	...
	public void setUpDropDownValues(BeanItemContainer<SelectValue> claimType,
		...
		cmbNetworkHospType.setContainerDataSource(networkHospTypeParameter);
