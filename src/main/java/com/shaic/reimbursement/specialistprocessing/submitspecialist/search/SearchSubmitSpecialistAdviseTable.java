 ...
 *
 */
public class SearchSubmitSpecialistAdviseTable extends GBaseTable<SearchSubmitSpecialistAdviseTableDTO>{

	private final static Object[] NATURAL_COL_ORDER = new Object[]{"serialNumber","specialityType","intimationNo", "claimNo", "policyNo", 
		"insuredPatientName", "cpuCode", "hospitalName", "hospitalAddress", "hospitalCity",  "reasonForAdmission","claimStatus"};
	...
	public void initTable() {
		...
		table.setContainerDataSource(new BeanItemContainer<SearchSubmitSpecialistAdviseTableDTO>(SearchSubmitSpecialistAdviseTableDTO.class));
	...
	public void tableSelectHandler(
			SearchSubmitSpecialistAdviseTableDTO t) {
...
//			e.printStackTrace();
	...
	public String textBundlePrefixString() {
		...
		return "search-submit-specialist-advice-";
	}
