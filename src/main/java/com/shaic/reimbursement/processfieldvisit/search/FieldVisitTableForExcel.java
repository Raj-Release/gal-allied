...
public class FieldVisitTableForExcel extends GBaseTable<SearchFieldVisitTableDTO>{

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private final static Object[] NATURAL_COL_ORDER = new Object[]{"serialNumber","intimationNo","strDateOfAdmission","policyNo", 
		"strCpuCode","strFvrCpuCode","insuredPatiendName","intimaterName","hospitalName","intimationMode","intimatedBy","admissionType","strDateOfIntimation","callerMobileNumber","reasonForAdmission"}; 
