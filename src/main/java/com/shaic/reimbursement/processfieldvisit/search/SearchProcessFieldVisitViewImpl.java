 ...
 *
 */
public class SearchProcessFieldVisitViewImpl extends AbstractMVPView implements SearchProcessFieldVisitView{

	
	@Inject
	private SearchProcessFieldVisitForm  searchForm;
	
	@Inject
	private SearchProcessFieldVisitTable searchResultTable;
	...
	public void doSearch() {
		...
		fireViewEvent(SearchProcessFieldVisitPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchProcessFieldVisitTable)
			{
				((SearchProcessFieldVisitTable) comp).removeRow();
			}
		}
		...
		else
		{
			...
			homeButton.addClickListener(new ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					dialog.close();
					fireViewEvent(MenuItemBean.SHOW_PROCESS_FIELD_VISIT, null);
