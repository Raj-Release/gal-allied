 ...
 *
 */
public class SearchProcessFieldVisitForm extends SearchComponent<SearchProcessFieldVisitFormDTO> {
	...
	public VerticalLayout mainVerticalLayout(){
		...
		FormLayout formLayoutLeft = new FormLayout(txtIntimationNo,cbxCPUCode,cmbPriority,cmbSource,cmbfvrCode);
		FormLayout formLayoutReight = new FormLayout(txtPolicyNo,cmbType,cmbHospitalType,cmbProductCode,intimationDateField);	
