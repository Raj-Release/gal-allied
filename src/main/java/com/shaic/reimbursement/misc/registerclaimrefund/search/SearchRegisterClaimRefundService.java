 ...
 */
@Stateless
public class SearchRegisterClaimRefundService extends AbstractDAO<Intimation>{
	...
	public SearchRegisterClaimRefundService() {
		super();
	}

	public  Page<SearchRegisterClaimRefundTableDTO> search(
			SearchRegisterClaimRefundFormDTO searchFormDTO,
		...
		List<SearchRegisterClaimRefundTableDTO> tableDTO = SearchRegisterClaimRefundMapper.getInstance().getIntimationDTO(doList);
		...
		List<SearchRegisterClaimRefundTableDTO> result = new ArrayList<SearchRegisterClaimRefundTableDTO>();
		result.addAll(tableDTO);
		Page<SearchRegisterClaimRefundTableDTO> page = new Page<SearchRegisterClaimRefundTableDTO>();
	...
	private List<SearchRegisterClaimRefundTableDTO> getclaimNumber(List<SearchRegisterClaimRefundTableDTO> intimationList){
		Claim a_claim = null;
	...
	private List<SearchRegisterClaimRefundTableDTO> getHospitalDetails(
			List<SearchRegisterClaimRefundTableDTO> tableDTO) {
