 ...
 *
 */
public class SearchRegisterClaimRefundForm extends SearchComponent<SearchRegisterClaimRefundFormDTO> {
	
	@Inject
	private SearchRegisterClaimRefundTable searchTable;
	...
	public void init() {
		...
		mainPanel.setCaption("Register Claim Refund");
	...
	public VerticalLayout mainVerticalLayout(){
		...
		//formLayoutLeft.setHeight("10px");
		FormLayout formLayoutReight = new FormLayout(txtPolicyNo);	
		//formLayoutReight.setHeight("10px");
	...
	{
		this.binder = new BeanFieldGroup<SearchRegisterClaimRefundFormDTO>(SearchRegisterClaimRefundFormDTO.class);
		this.binder.setItemDataSource(new SearchRegisterClaimRefundFormDTO());
