 ...
 *
 */
public class SearchProcessClaimRequestBenefitsViewImpl extends AbstractMVPView implements SearchProcessClaimRequestBenefitsView{

	
	@Inject
	private SearchProcessClaimRequestBenefitsForm  searchForm;
	
	@Inject
	private SearchProcessClaimRequestBenefitsTable searchResultTable;
	...
	public void doSearch() {
		SearchProcessClaimRequestBenefitsFormDTO searchDTO = searchForm.getSearchDTO();
		Pageable pageable = searchResultTable.getPageable();
		searchDTO.setPageable(pageable);
		String userName=(String)getUI().getSession().getAttribute(BPMClientContext.USERID);
		String passWord=(String)getUI().getSession().getAttribute(BPMClientContext.PASSWORD);
		fireViewEvent(SearchProcessClaimRequestBenefitsPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchProcessClaimRequestBenefitsTable)
			{
				((SearchProcessClaimRequestBenefitsTable) comp).removeRow();
			}
		}
