 ...
 *
 */
public class SearchProcessClaimRequestBenefitsForm extends SearchComponent<SearchProcessClaimRequestBenefitsFormDTO> {
	
	@Inject
	private SearchProcessClaimRequestBenefitsTable searchTable;
	
	@Inject
	private SearchProcessClaimRequestBenefitsService service;
	...
	{
		this.binder = new BeanFieldGroup<SearchProcessClaimRequestBenefitsFormDTO>(SearchProcessClaimRequestBenefitsFormDTO.class);
		this.binder.setItemDataSource(new SearchProcessClaimRequestBenefitsFormDTO());
			...
			public void valueChange(Property.ValueChangeEvent event) {
				...
				if(cbxTreatmentType.getValue() != null ){
					...
					if(ReferenceTable.MEDICAL.equals(cbxTreatmentType.getValue().toString())){
						fireViewEvent(SearchProcessClaimRequestBenefitsPresenter.SPECIALITY, ReferenceTable.MEDICAL_CODE );
						...
						fireViewEvent(SearchProcessClaimRequestBenefitsPresenter.SPECIALITY, ReferenceTable.SURGICAL_CODE );
						cbxSpeciality.setContainerDataSource(Speicalityvalue);
						cbxSpeciality.setItemCaptionMode(ItemCaptionMode.PROPERTY);
						cbxSpeciality.setItemCaptionPropertyId("value");
					}
