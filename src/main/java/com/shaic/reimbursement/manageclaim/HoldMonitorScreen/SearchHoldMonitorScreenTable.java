...
public class SearchHoldMonitorScreenTable extends GBaseTable<SearchHoldMonitorScreenTableDTO>{
		      ...
		      public Object generateCell(final Table source, final Object itemId, Object columnId) {
		    	...
		    	releaseBtn.addClickListener(new Button.ClickListener() {
					...
					public void buttonClick(ClickEvent event) {
				        	...
				        	SearchHoldMonitorScreenTableDTO data = (SearchHoldMonitorScreenTableDTO) itemId;
				        	if(data !=null){
				        		data.setScreenName(getScreenName());
				        		fireViewEvent(SearchMonitorScreenPreseneter.RELEASE_BUTTON,data);
