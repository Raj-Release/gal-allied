 ...
 *
 */
public class SearchCloseClaimFormRodLevel extends SearchComponent<SearchCloseClaimFormDTORODLevel> {
	
	@Inject
	private SearchCloseClaimTableRODLevel searchAcknowledgementDocumentReceiverTable;
	...
	{
		this.binder = new BeanFieldGroup<SearchCloseClaimFormDTORODLevel>(SearchCloseClaimFormDTORODLevel.class);
		this.binder.setItemDataSource(new SearchCloseClaimFormDTORODLevel());
