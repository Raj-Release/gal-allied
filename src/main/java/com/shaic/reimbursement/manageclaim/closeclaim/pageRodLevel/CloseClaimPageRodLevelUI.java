...
public class CloseClaimPageRodLevelUI extends ViewComponent{
	...
	@Inject
	private CloseClaimDocumentDetailsTableRodLevel documentDetailsTable;
	...
	public void init(SearchCloseClaimTableDTORODLevel searchDTO){
		...
		fireViewEvent(CloseClaimPageRodLevelPresenter.SET_TABLE_DATA, searchDTO);
		...
		fireViewEvent(CloseClaimPageRodLevelPresenter.SET_DATA_FIELD, searchDTO);
	...
	public boolean validatePage() {
		...
		if(documentDetailsTable != null){
			...
			if(isValid){
				eMsg.append("Please Select atlease one ROD for Closing Claim");
				hasError = true;
			}
		}
