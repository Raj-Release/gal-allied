...
public class CloseClaimViewImpl extends AbstractMVPView implements CloseClaimView{
	...
	@Inject
	private Instance<CloseClaimPageUI> closeClaimInstance;
	
	private CloseClaimPageUI closeClaimObj;
