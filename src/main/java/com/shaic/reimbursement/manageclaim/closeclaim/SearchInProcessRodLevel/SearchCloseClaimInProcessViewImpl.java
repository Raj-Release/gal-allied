 ...
 *
 */
public class SearchCloseClaimInProcessViewImpl extends AbstractMVPView implements SearchCloseClaimInProcessView {
	...
	@Inject
	private SearchCloseClaimInProcessForm  searchForm;
	
	@Inject
	private SearchCloseClaimInProcessTable searchResultTable;
...
//		mainPanel.setHeight("625px");
	...
	public void doSearch() {
		...
		fireViewEvent(SearchCloseClaimInProcessPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
	}
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchCloseClaimInProcessTable)
			{
				((SearchCloseClaimInProcessTable) comp).removeRow();
			}
		}
	}
		...
		else
		{
			...
			homeButton.addClickListener(new ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					dialog.close();
					fireViewEvent(MenuItemBean.CLOSE_CLAIM_IN_PROCESS_ROD_LEVEL, null);
