...
public class CloseClaimDocumentDetailsTableRodLevel extends GBaseTable<ViewDocumentDetailsDTO> {
	...
	public void initTable() {
		...
		table.addGeneratedColumn("closeClaim", new Table.ColumnGenerator() {
			...
			public Object generateCell(Table source, final Object itemId, Object columnId) {
				...
				if(rodDTO.getDbOutArray() != null ||(rodDTO.getStatusKey() != null && rodDTO.getStatusKey().equals(ReferenceTable.PAYMENT_REJECTED))){
