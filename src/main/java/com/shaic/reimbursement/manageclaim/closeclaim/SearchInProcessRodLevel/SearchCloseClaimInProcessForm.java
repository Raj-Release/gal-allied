...
public class SearchCloseClaimInProcessForm extends SearchComponent<SearchCloseClaimFormDTORODLevel> {
	
	@Inject
	private SearchCloseClaimInProcessTable searchAcknowledgementDocumentReceiverTable;
