...
public class CloseClaimPageRodLevelViewImpl extends AbstractMVPView implements CloseClaimRodLevelView {
	...
	@Inject
	private Instance<CloseClaimPageRodLevelUI> closeClaimPageInstance;
	
	private CloseClaimPageRodLevelUI closeClaimPageObj;
