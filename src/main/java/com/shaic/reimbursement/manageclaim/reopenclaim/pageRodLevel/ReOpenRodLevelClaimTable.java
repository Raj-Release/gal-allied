...
public class ReOpenRodLevelClaimTable extends GBaseTable<ViewDocumentDetailsDTO> {
...
/*	public static final Object[] NATURAL_COL_ORDER = new Object[] {"serialNumber","acknowledgeNumber","rodNumber","receivedFromValue","documentReceivedDate","modeOfReceipt"
	...
	public void initTable() {
		...
		table.removeGeneratedColumn("reOpenClaim");
		table.addGeneratedColumn("reOpenClaim", new Table.ColumnGenerator() {
			...
			public Object generateCell(Table source, final Object itemId, Object columnId) {
				...
				if(rodDTO.getDbOutArray() != null || (rodDTO.getRodStatusKey() != null && rodDTO.getRodStatusKey().equals(ReferenceTable.PAYMENT_PROCESS_CLOSED))){
		...
		table.setColumnHeader("reOpenClaim", "Re-Open Claim");
	...
	public void reConfirmMessage(final ViewDocumentDetailsDTO rodDTO,final CheckBox chkBox){
		...
		ConfirmDialog dialog = ConfirmDialog.show(getUI(),"Confirmation", "Do You want to Re-Open the Claim and its selected ROD?",
