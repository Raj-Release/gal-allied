 ...
 *
 */
public class SearchReOpenClaimForm extends SearchComponent<SearchReOpenClaimFormDTO> {
	
	@Inject
	private SearchReOpenClaimTable searchAcknowledgementDocumentReceiverTable;
	...
	{
		this.binder = new BeanFieldGroup<SearchReOpenClaimFormDTO>(SearchReOpenClaimFormDTO.class);
		this.binder.setItemDataSource(new SearchReOpenClaimFormDTO());
