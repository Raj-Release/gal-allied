...
public class CloseClaimInProcessViewImpl extends AbstractMVPView implements CloseClaimInProcessView {
	...
	@Inject
	private Instance<CloseClaimInProcessPageUI> closeClaimPageInstance;
	
	private CloseClaimInProcessPageUI closeClaimPageObj;
