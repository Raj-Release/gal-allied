...
public class SearchProcessClaimRequestTableDTO extends AbstractTableDTO  implements Serializable{
	...
	private Boolean isAutoAllocationTrue = false ;
	...
	public Boolean getIsAutoAllocationTrue() {
		return isAutoAllocationTrue;
	}
	public void setIsAutoAllocationTrue(Boolean isAutoAllocationTrue) {
		this.isAutoAllocationTrue = isAutoAllocationTrue;
	}
