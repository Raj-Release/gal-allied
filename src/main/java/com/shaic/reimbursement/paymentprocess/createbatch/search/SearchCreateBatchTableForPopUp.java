...
public class SearchCreateBatchTableForPopUp extends GBaseTable<CreateAndSearchLotTableDTO>{
	...
	/*private final static Object[] NATURAL_COL_ORDER = new Object[]{"serialNumber","intimationNo", "claimNo", "policyNo","product","accountBatchNo","typeOfClaim","paymentType",
		"lotNo","approvedAmt","serviceTax","sumOfApprovedAndServiceTax","tdsAmt","netAmnt","tdsPercentage","payeeName","gmcProposerName","gmcEmployeeName","payableAt","paymentCpuCode","ifscCode","beneficiaryAcntNo","branchName","chequeNo",
	...
	private final static Object[] NATURAL_COL_ORDER = new Object[]{"serialNumber","lotNo","intimationNo","claimNo",
		"policyNo","accountBatchNo","product","typeOfClaim","approvedAmt","tdsAmt","netAmnt",
		"intrestAmount","paymentType","beneficiaryAcntNo","ifscCode","payeeName","payableAt","providerCode",
		"paymentCpuCode","lastAckDateValue","nextDayOfFaApprovedDateValue","numberofdays","irdaTAT","noofdaysexceeding",
		"tdsPercentage","gmcProposerName","gmcEmployeeName","branchName","chequeNo","chequeDate","bankCode","bankName",
		"panNo","refNo","paymentReqDateValue","userId","emailID","reconsiderationFlag","penalTotalAmnt","remarks"}; 
	
	/**
	 * As discussed with Ravi, below coloumn has been removed from the table (
	 */
	//"serviceTax","sumOfApprovedAndServiceTax",
