...
public class CreateBatchTableForPopUpForExcel extends GBaseTable<CreateAndSearchLotTableDTO>{
	...
	private final static Object[] NATURAL_COL_ORDER = new Object[]{"serialNumber","lotNo","intimationNo",
		"policyNo","product","accountBatchNo","typeOfClaim","approvedAmt","tdsAmt","netAmnt",
		"intrestAmount","payeeName","payableAt","providerCode","paymentCpuCode","paymentCpuCodeName","paymentType","beneficiaryAcntNo",
		"ifscCode","bankName","chequeNo","chequeDate","bankCode","patientName","lastAckDateValue","nextDayOfFaApprovedDateValue","numberofdays","irdaTAT","noofdaysexceeding"}; 
