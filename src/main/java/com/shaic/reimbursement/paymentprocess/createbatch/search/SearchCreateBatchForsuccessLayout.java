...
public class SearchCreateBatchForsuccessLayout extends GBaseTable<CreateAndSearchLotTableDTO>{

	private static final Object[] NATURAL_COL_ORDER = new Object[] {
		"claimType","claimCount","approvedAmt","intrestAmount","sumOfApproveIntAmnt"};
