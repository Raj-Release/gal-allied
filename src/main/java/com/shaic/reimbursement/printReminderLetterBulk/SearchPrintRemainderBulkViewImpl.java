 ...
 *
 */
public class SearchPrintRemainderBulkViewImpl extends AbstractMVPView implements SearchPrintRemainderBulkView{
	...
	@Inject
	private SearchPrintRemainderBulkForm  searchForm;
	
	private SearchPrintRemainderBulkTable searchResultTable;
	
	@Inject
	private ShowPrintReminderLetterBulkPage showReminderLetterPage;
...
//		searchForm.refresh();
	...
	public void doSearch() {
		...
		if(searchDTO != null){
			...
			fireViewEvent(SearchPrintRemainderBulkPresenter.SEARCH_BULK_PRINT_BUTTON_CLICK, searchDTO,userName,passWord);	
		}
		else{
			return;
		}
