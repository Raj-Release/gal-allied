 ...
 *
 */
public class SearchPrintRemainderBulkMapper {
	private static MapperFacade tableMapper;
	static {
		MapperFactory mapperFactor = MappingUtil.getMapperFactory(true);
		ClassMapBuilder<Claim, SearchPrintReminderBulkTableDTO> claimClassMap = mapperFactor.classMap(Claim.class, SearchPrintReminderBulkTableDTO.class);
	...
	public static List<SearchPrintReminderBulkTableDTO> getClaimDTO(List<Claim> claimData){
		List<SearchPrintReminderBulkTableDTO> mapAsList = 
										tableMapper.mapAsList(claimData, SearchPrintReminderBulkTableDTO.class);
		return mapAsList;
