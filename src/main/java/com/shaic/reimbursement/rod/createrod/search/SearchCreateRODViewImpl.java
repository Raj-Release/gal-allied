 ...
 *
 */
public class SearchCreateRODViewImpl extends AbstractMVPView implements SearchCreateRODView{

	
	@Inject
	private SearchCreateRODForm  searchForm;
	
	@Inject
	private SearchCreateRODTable searchResultTable;
	...
	public void doSearch() {
		...
		fireViewEvent(SearchCreateRODPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
