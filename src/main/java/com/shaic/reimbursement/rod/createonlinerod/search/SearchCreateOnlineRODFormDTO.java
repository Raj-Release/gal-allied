 ...
 *
 */
public class SearchCreateOnlineRODFormDTO extends AbstractSearchDTO implements Serializable{
	
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 3007227738449261281L;
