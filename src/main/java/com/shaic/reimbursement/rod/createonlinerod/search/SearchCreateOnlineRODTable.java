 ...
 *
 */
public class SearchCreateOnlineRODTable extends GBaseTable<SearchCreateOnlineRODTableDTO>{
	...
	public void initTable() {
		...
		table.setContainerDataSource(new BeanItemContainer<SearchCreateOnlineRODTableDTO>(SearchCreateOnlineRODTableDTO.class));
	...
	public void alertMessage(final SearchCreateOnlineRODTableDTO t, String message) {
...
//				 fireViewEvent(MenuPresenter.SHOW_CREATE_ROD_WIZARD, t);
					try{
						if(isActiveHumanTask){
							...
							fireViewEvent(MenuPresenter.SHOW_CREATE_ONLINE_ROD_WIZARD, t);
						}else{
	...
	@Override
	public void tableSelectHandler(SearchCreateOnlineRODTableDTO t) {
