 ...
 */
@Stateless
public class SearchCreateOnlineRODService extends AbstractDAO<Intimation>{
	...
	public SearchCreateOnlineRODService() {
		super();
	}

	public  Page<SearchCreateOnlineRODTableDTO> search(
			SearchCreateOnlineRODFormDTO searchFormDTO,
		...
		try{
			...
			taskProcedure = dbCalculationService.revisedGetTaskRODOnlineProcedure(setMapValues);	
			...
			List<SearchCreateOnlineRODTableDTO> tableDTO = new ArrayList<SearchCreateOnlineRODTableDTO>();
			...
			List<SearchCreateOnlineRODTableDTO> ackDocUploadList = new ArrayList<SearchCreateOnlineRODTableDTO>();
			List<SearchCreateOnlineRODTableDTO> nonAckDocUploadList = new ArrayList<SearchCreateOnlineRODTableDTO>();
			if(null != docUpload)
			{	
				for (SearchCreateOnlineRODTableDTO searchCreateRODTableDTO2 : tableDTO) {
			...
			Page<SearchCreateOnlineRODTableDTO> page = new Page<SearchCreateOnlineRODTableDTO>();
	...
	private List<SearchCreateOnlineRODTableDTO> getIntimationData(String intimationNo, Long ackKey/*, HumanTask humanTask*//*,Integer taskNumber*/,String docUpload){
		...
		try{
			...
			List<SearchCreateOnlineRODTableDTO> tableDTO = SearchCreateOnlineRODMapper.getInstance().getIntimationDTO(listIntimations);
			for (SearchCreateOnlineRODTableDTO searchCreateRODTableDTO : tableDTO) {
	...
	private List<SearchCreateOnlineRODTableDTO> getclaimNumber(List<SearchCreateOnlineRODTableDTO> intimationList){
		Claim a_claim = null;
	...
	private List<SearchCreateOnlineRODTableDTO> getHospitalDetails(
			List<SearchCreateOnlineRODTableDTO> tableDTO, Long ackKey/*, HumanTask humanTaskListDTO*//*,Integer taskNumber*/) {
	...
	public  Page<SearchCreateOnlineRODTableDTO> searchForCancelAcknowledgement(
			SearchCreateOnlineRODFormDTO searchFormDTO,
			String userName, String passWord) {
