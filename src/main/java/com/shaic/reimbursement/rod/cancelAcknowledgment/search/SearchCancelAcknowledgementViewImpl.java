...
public class SearchCancelAcknowledgementViewImpl extends AbstractMVPView implements SearchCancelAcknowledgementView {
	...
	@Inject
	private SearchCancelAcknowledgementForm searchForm;
	
	@Inject
	private SearchCancelAcknowledgementTable searchResultTable;
	...
	public void doSearch() {
		...
		SearchCreateRODFormDTO searchDTO = searchForm.getSearchDTO();
		Pageable pageable = searchResultTable.getPageable();
		searchDTO.setPageable(pageable);
		String userName=(String)getUI().getSession().getAttribute(BPMClientContext.USERID);
		String passWord=(String)getUI().getSession().getAttribute(BPMClientContext.PASSWORD);
		fireViewEvent(SearchCancelAcknowledgementPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
	}
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchCancelAcknowledgementTable)
			{
				((SearchCancelAcknowledgementTable) comp).removeRow();
			}
		}
	}
