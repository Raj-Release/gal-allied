 ...
 *
 */
public class SearchAcknowledgementDocumentReceiverTable extends GBaseTable<SearchAcknowledgementDocumentReceiverTableDTO>{
	...
	private final static Object[] NATURAL_COL_ORDER = new Object[]{"serialNumber","intimationNo", "claimNo", "policyNo", "healthCardNo",
		"insuredPatientName", "strCpuCode", "hospitalName", "hospitalAddress", "hospitalCity","hospitalType", "dateOfAdmission", "reasonForAdmission"}; 
		...
		homeButton.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				 ...
				 if(t.getClaimNo() != null) {
						fireViewEvent(MenuItemBean.ACKNOWLEDGE_DOCUMENT_RECEIVED, t);
				}
			}
		});
	}
