 ...
 *
 */
public class SearchDraftInvestigationForm extends SearchComponent<SearchDraftInvestigationFormDTO> {
	
	@Inject
	private SearchDraftInvestigationTable searchTable;
...
//	private ComboBox cmbPriorityNew;
	...
	public void init() {
		...
		mainPanel.setCaption("Draft Investigation Letter");
...
//		cmbPriorityNew = binder.buildAndBind("Priority", "priorityNew", ComboBox.class);
	...
	{
		this.binder = new BeanFieldGroup<SearchDraftInvestigationFormDTO>(SearchDraftInvestigationFormDTO.class);
		this.binder.setItemDataSource(new SearchDraftInvestigationFormDTO());
