 ...
 *
 */
public class SearchAckInvestigationCompletedForm extends SearchComponent<SearchAckInvestigationCompletedFormDTO> {
	...
	public void init() {
		...
		mainPanel.setCaption("Acknowlege Investigation Completed");
	...
	public VerticalLayout mainVerticalLayout(){
		...
		FormLayout formLayoutLeft = new FormLayout(txtIntimationNo,cbxCPUCode,cmbPriority,cmbSource);
		FormLayout formLayoutReight = new FormLayout(txtClaimNo,cmbClaimType,cmbType);	
		...
		mainVerticalLayout.addComponent(absoluteLayout_3);
		 ...
		 absoluteLayout_3.setHeight("229px");
		addListener();
	...
	{
		this.binder = new BeanFieldGroup<SearchAckInvestigationCompletedFormDTO>(SearchAckInvestigationCompletedFormDTO.class);
		this.binder.setItemDataSource(new SearchAckInvestigationCompletedFormDTO());
