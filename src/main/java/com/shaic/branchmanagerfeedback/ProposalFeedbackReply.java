...
public class ProposalFeedbackReply  extends GBaseTable<BranchManagerFeedbackTableDTO> {

	
	private final static Object[] NATURAL_COL_ORDER = new Object[]{"serialNumber", "proposalNumber", "policyRemarks", "corporateMedicalUnderwritingReply"};
	...
	public void initTable() {
		...
		table.addGeneratedColumn("corporateMedicalUnderwritingReply", new Table.ColumnGenerator() {
			...
			public Object generateCell(final Table source, final Object itemId,
				...
				SHAUtils.handlePopUpFeedbackRemarks(textarea,null,getUI(),SHAConstants.FEEDBACK_PROPOSAL);
	...
	public String textBundlePrefixString() {
		return "proposal-feedback-reply-";
	}
		...
		.addValueChangeListener(new Property.ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				{  
					...
					tableDTO.setCorporateMedicalUnderwritingReply(value);
				}
			}
		});
	}
