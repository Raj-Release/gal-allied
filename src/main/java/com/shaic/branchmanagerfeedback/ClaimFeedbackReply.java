...
public class ClaimFeedbackReply extends GBaseTable<BranchManagerFeedbackTableDTO>{


	
	private final static Object[] NATURAL_COL_ORDER = new Object[]{"serialNumber", "intimationNo", "claimRemarks", "claimsDepartmentReply"};
	...
	public void initTable() {
		table.removeGeneratedColumn("claimRemarks");
		table.addGeneratedColumn("claimRemarks", new Table.ColumnGenerator() {
			...
			public Object generateCell(final Table source, final Object itemId,
				...
				if(null != data){
					...
					if(null != data.getClaimRemarks()){
						remarks.setValue(data.getClaimRemarks());
					}
		...
		table.addGeneratedColumn("claimsDepartmentReply", new Table.ColumnGenerator() {
			...
			public Object generateCell(final Table source, final Object itemId,
				...
				textarea.setData(branchManagerFeedbackTableDTO);
				 SHAUtils.handlePopUpFeedbackRemarks(textarea,null,getUI(),SHAConstants.FEEDBACK_CLAIM);
		...
		table.setColumnWidth("claimRemarks", 500);
		...
		table.setColumnHeader("claimRemarks", "Claim Remarks");
	}
		...
		.addValueChangeListener(new Property.ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				{  
					...
					tableDTO.setClaimsDepartmentReply(value);
				}
			}
		});
	}
