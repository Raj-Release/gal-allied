...
public class ProposalTeamFeedbackTable extends GBaseTable<BranchManagerFeedbackTableDTO>{
	...
	private final static Object[] NATURAL_COL_ORDER = new Object[]{"serialNumber","Link", "branchDetails", "reportedDate","feedBack","feedbackType", "feedbackStatus",
		"proposalNumber","fbCategory","feedbackRemarksOverall", "corporateMedicalUnderwritingReply"};
	...
	public void initTable() {
				...
				searchButton.addClickListener(new Button.ClickListener() {
					...
					public void buttonClick(ClickEvent event) {
						...
						if(currentItemId.getFeedbackStatusId().equals(ReferenceTable.FEEDBACK_REPORTED_KEY)){
							...
							fireViewEvent(BranchManagerFeedbackPresenter.PROPOSAL_REPLY_FEEDBACK, currentItemId);
						}else {
		...
		table.removeGeneratedColumn("corporateMedicalUnderwritingReply");
		table.addGeneratedColumn("corporateMedicalUnderwritingReply", new Table.ColumnGenerator() {
			private static final long serialVersionUID = 5936665477260011479L;
			...
			public Object generateCell(final Table source, final Object itemId,
				...
				if(null != data){
					remarks.setReadOnly(Boolean.FALSE);
					if(null != data.getCorporateMedicalUnderwritingReply()){
						remarks.setValue(data.getCorporateMedicalUnderwritingReply());
					}
					remarks.setReadOnly(Boolean.TRUE);
				}
	...
	public String textBundlePrefixString() {
		...
		return "branch-manager-proposal-feedback-";
	} 
