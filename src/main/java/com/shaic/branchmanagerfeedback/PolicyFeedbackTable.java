...
public class PolicyFeedbackTable extends GBaseTable<BranchManagerFeedbackTableDTO>{

	@Inject
	TechnicalTeamReplyOnFeedback technicalTeamReplyOnFeedback;
	...
	private final static Object[] NATURAL_COL_ORDER = new Object[]{"serialNumber", "Link", "branchDetails", "reportedDate", "feedBack","feedbackType", "feedbackStatus",
		"policyNumber","fbCategory","feedbackRemarksOverall", "technicalTeamReply"};
				...
				searchButton.addClickListener(new Button.ClickListener() {
					...
					public void buttonClick(ClickEvent event) {
						...
						if(currentItemId.getFeedbackStatusId().equals(ReferenceTable.FEEDBACK_REPORTED_KEY)){
							...
							fireViewEvent(BranchManagerFeedbackPresenter.POLICY_REPLY_FEEDBACK, currentItemId);
						}else {
...
//				final FormLayout image = new FormLayout();
	...
	public String textBundlePrefixString() {
		...
		return "branch-manager-policy-feedback-";
	} 
