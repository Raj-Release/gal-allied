...
public class OMPCloseClaimUI extends SearchComponent<OMPCloseClaimFormDto>{
	
	private OMPCloseClaimFormDto searchDto;
	private OMPCloseClaimDetailTable searchTable;
	...
	public void init() {
		...
		mainPanel.setCaption("Close Claim");
	...
	{
		this.binder = new BeanFieldGroup<OMPCloseClaimFormDto>(OMPCloseClaimFormDto.class);
		this.binder.setItemDataSource(new OMPCloseClaimFormDto());
