...
public class OMPOutstandingDetailReportUI extends SearchComponent<OMPOutstandingDetailReportFormDto>{
	
	
	private OMPOutstandingDetailReportFormDto searchDto;
	private OMPOutstandingDetailReportDetailTable searchTable;
	...
	public void init() {
		...
		mainPanel.setCaption("Outstanding Detail Report");
	...
	{
		this.binder = new BeanFieldGroup<OMPOutstandingDetailReportFormDto>(OMPOutstandingDetailReportFormDto.class);
		this.binder.setItemDataSource(new OMPOutstandingDetailReportFormDto());
