 ...
 *
 */
@ViewInterface(OMPAckDocUploadDocumentsView.class)
public class OMPAckDocUploadDocumentsPresenter  extends AbstractMVPPresenter<OMPAckDocUploadDocumentsView>
{
	...
	public static final String OMP_UPLOAD_DOC_SETUP_DROPDOWN_VALUES = "omp_Ack_Doc_upload_doc_setup_dropdown_values";
	
	public static final String OMP_SUBMIT_UPLOADED_DOCUMENTS = "omp_ACK_Doc_entry_submit_uploaded_documents";
	
	public static final String OMP_DELETE_UPLOADED_DOCUMENTS = "omp_Ack_Doc_entry_delete_uploaded_documents";	
	
	public static final String OMP_EDIT_UPLOADED_DOCUMENTS = "omp_Ack_Doc_entry_edit_uploaded_documents";
	
	public static final String OMP_SAVE_UPLOADED_DOCUMENTS = "omp_Ack_Doc_entry_edit_uploaded_documents";
