...
import com.shaic.claim.OMPreceiptofdocumentsbillentry.page.OMPUploadDocumentGridForm;
import com.shaic.claim.OMPreceiptofdocumentsbillentry.page.UploadedDocumentsForOMP;
...
public class OMPAckDocUploadDocumentsPage extends ViewComponent {
	...
	{	
		...
		fireViewEvent(OMPAckDocUploadDocumentsPresenter.OMP_UPLOAD_DOC_SETUP_DROPDOWN_VALUES, bean);
...
//			this.uploadDocsTable.init(new UploadDocumentDTO(), SHAConstants.OMP_ROD);
	...
	public void loadUploadedDocsTableValues(UploadDocumentDTO uploadDocsDTO)
	{
		if(null != this.uploadedDocsTable)
		{
			...
			fireViewEvent(OMPAckDocUploadDocumentsPresenter.OMP_SAVE_UPLOADED_DOCUMENTS, uploadDocsDTO);
//			List<UploadDocumentDTO> uploadDocsList = receiptOfDocumentsDTO.getUploadDocsList();//DD
	...
	public void deleteUploadDocumentDetails(UploadDocumentDTO dto) {
		...
		if(null != this.uploadDocsTable)
		{
			...
			fireViewEvent(OMPAckDocUploadDocumentsPresenter.OMP_SAVE_UPLOADED_DOCUMENTS, dto);
