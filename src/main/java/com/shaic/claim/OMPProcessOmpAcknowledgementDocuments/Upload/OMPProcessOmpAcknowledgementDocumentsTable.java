...
public class OMPProcessOmpAcknowledgementDocumentsTable extends GBaseTable<OMPProcessOmpAcknowledgementDocumentsTableDTO>{

	private final static Object[] NATURAL_HDCOL_ORDER = new Object[]{"serialNumber","intimationNo","claimno","policyno","insuredName","lossdate","eventcode","ailment"}; 
	...
	public void initTable() {
		...
		table.setContainerDataSource(new BeanItemContainer<OMPProcessOmpAcknowledgementDocumentsTableDTO>(OMPProcessOmpAcknowledgementDocumentsTableDTO.class));
	...
	public void alertMessage(final OMPProcessOmpAcknowledgementDocumentsTableDTO t, String message) {
		...
		homeButton.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				dialog.close();
				fireViewEvent(OMPMenuPresenter.OMP_PROCESS_OMP_CLAIM_PROCESSOR, t);
			}
		});
	}
	...
	@Override
	public void tableSelectHandler(OMPProcessOmpAcknowledgementDocumentsTableDTO t) {
		...
		/* VaadinSession session = getSession();
			...
			if (sucessMsg != null && sucessMsg.equalsIgnoreCase("SUCCESS")){
				...
				if(isActiveHumanTask){
					...
					fireViewEvent(OMPMenuPresenter.OMP_PROCESS_DETAIL_PAGE, t);
...
//				getErrorMessage(callLockProcedure);  
	...
	public String textBundlePrefixString() {
		return "ompprocessompacknowledgementdocumentsreceived-";
	}
