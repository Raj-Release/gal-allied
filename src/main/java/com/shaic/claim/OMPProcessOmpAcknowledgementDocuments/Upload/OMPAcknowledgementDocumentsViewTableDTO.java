...
public class OMPAcknowledgementDocumentsViewTableDTO {
	
	
	public OMPAcknowledgementDocumentsViewTableDTO(){
	...
	private OMPClaimProcessorAckDocumentsDTO oMPClaimProcessorAckDocumentsDTO;
	...
	public OMPClaimProcessorAckDocumentsDTO getClaimProcessorDTO() {
		return oMPClaimProcessorAckDocumentsDTO;
	}
	public void setClaimProcessorDTO(OMPClaimProcessorAckDocumentsDTO claimProcessorDTO) {
		this.oMPClaimProcessorAckDocumentsDTO = claimProcessorDTO;
	}
