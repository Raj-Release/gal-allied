...
public class OMPClaimProcessorAckDocumentsDTO extends AbstractTableDTO{

	public OMPClaimProcessorAckDocumentsDTO() {
...
//	@NotNull(message ="Please Enter Reason for Approval")
	...
	private List<OMPAcknowledgementDocumentsViewTableDTO> claimCalculationViewTable;
	...
	public List<OMPAcknowledgementDocumentsViewTableDTO> getClaimCalculationViewTable() {
		return claimCalculationViewTable;
	}

	public void setClaimCalculationViewTable(
			List<OMPAcknowledgementDocumentsViewTableDTO> claimCalculationViewTable) {
