...
public class UpdateAadharDetailsTable extends GBaseTable<UpdateAadharDetailsDTO>{
	
	@Inject
	private UpdateAadharFilePage updateAadharPage;
	...
	public void initTable() {
		table.setContainerDataSource(new BeanItemContainer<UpdateAadharDetailsDTO>(
				UpdateAadharDetailsDTO.class));
		...
		table.addGeneratedColumn("fileName",
				new Table.ColumnGenerator() {
					...
					public Object generateCell(Table source, final Object itemId,
							Object columnId) {
						UpdateAadharDetailsDTO dto = (UpdateAadharDetailsDTO)itemId;
						...
						button.addClickListener(new Button.ClickListener() {
							...
							public void buttonClick(ClickEvent event) {
								...
								updateAadharPage.init(name,token);
								Window popup = new com.vaadin.ui.Window();
								popup.setCaption("");
								popup.setWidth("75%");
								popup.setHeight("85%");
								popup.setContent(updateAadharPage);
				...
				new Table.ColumnGenerator() {
					...
					public Object generateCell(final Table source,
						...
						updateAadharButton.addClickListener(new Button.ClickListener() {
							...
							@Override
							public void buttonClick(ClickEvent event) {
								UpdateAadharDetailsDTO tableDTO = (UpdateAadharDetailsDTO) itemId;
	...
	@Override
	public void tableSelectHandler(UpdateAadharDetailsDTO t) {
		// TODO Auto-generated method stub
	...
	public String textBundlePrefixString() {
	 ...
	 public List<UpdateAadharDetailsDTO> getValues() {
	    	@SuppressWarnings("unchecked")
			List<UpdateAadharDetailsDTO> itemIds = (List<UpdateAadharDetailsDTO>) this.table.getItemIds() ;
	    	return itemIds;
	    }
