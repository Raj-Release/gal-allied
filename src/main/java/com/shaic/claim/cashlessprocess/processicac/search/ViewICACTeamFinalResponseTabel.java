...
public class ViewICACTeamFinalResponseTabel extends GBaseTable<ProcessingICACTeamResponseDTO>{
	...
	public void initTable() {
		...
		Object[] VISIBLE_COLUMNS = new Object[] {"repliedDate","icacFinalResponseRemarks","responseGivenBY"};
