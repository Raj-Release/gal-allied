...
public class SalesManagerProfileDetailTable extends GBaseTable<ViewBusinessProfilChartDTO>{
	...
	public void initTable() {
		...
		table.setColumnHeader("labelName", "SM Details");
