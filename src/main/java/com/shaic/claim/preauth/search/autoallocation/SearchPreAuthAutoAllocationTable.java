...
public class SearchPreAuthAutoAllocationTable extends GBaseTable<SearchPreauthTableDTO> {
				 ...
				 VaadinSession session = getSession();
					...
					try{
						if(isActiveHumanTask){
							...
							//added for FLP bypass in autoalloation screen
							if(t.getPreauthCurrentQ() && cashlessKey == 0){
								fireViewEvent(MenuPresenter.SHOW_TATA_POLICY_PREAUTH_WIZARD, t);
							}
							else if(t.getPreauthCurrentQ()){
