...
@Alternative
public class PreauthButtons extends PreauthButtonsUI implements PreauthButtonListeners {
	...
	public boolean isValid()
	{
		...
		if(binder == null) {
			hasError = true;
			eMsg.append(eMsg ).append("Please Select Query or Rejection or Send For Processing");
			return !hasError;
		}
