...
//		
	...
	public String getBlockAlertFlag() {
		return blockAlertFlag;
	}

	public void setBlockAlertFlag(String blockAlertFlag) {
		this.blockAlertFlag = blockAlertFlag;
	}
