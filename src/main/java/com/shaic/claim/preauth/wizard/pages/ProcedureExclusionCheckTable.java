...
public class ProcedureExclusionCheckTable extends GRowHandlerTable<ProcedureDTO> {
	...
	public ProcedureExclusionCheckTable() {
	 ...
	 public boolean isValid()
		{
			...
			for (ProcedureDTO procBean : itemIds) {
				...
				if(null == procBean.getExclusionDetails() && procBean.getIsGMC() != null && !procBean.getIsGMC())
				{
					hasError = true;
					errorMessages.add("Please Select Exclusion details for procedure in procedure exclusion table");
				}
				if(null == procBean.getProcedureStatus()  && procBean.getIsGMC() != null && !procBean.getIsGMC())
				{
					hasError = true;
					errorMessages.add("Please Select procedure status for procedure in procedure exclusion table");
				}
				
				if(null == procBean.getCopay() && !procBean.getIsTata() && !procBean.getIsPayaas())
				{
					hasError = true;
