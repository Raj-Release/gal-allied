...
public class SearchProcessDataCorrectionPriorityForm extends ViewComponent{
	...
	public void init() {
		...
		processRejectionPanel.setCaption("Data Validation Priority");
			...
			searchBtn.addClickListener(new Button.ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					if(txtIntimationNo.getValue() != null && !txtIntimationNo.isEmpty()) {
						...
						fireViewEvent(SearchProcessDataCorrectionPriorityPresenter.SEARCH_INTIMATION_DATA_CORRECTION_PRIORITY, txtIntimationNo.getValue(),userName);
					}else {
