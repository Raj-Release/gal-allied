...
public class SearchPrintPaymentBulkTable extends GBaseTable<PrintBulkPaymentResultDto> {

	private final static Object[] NATURAL_COL_ORDER = new Object[]{"sno", "totalNoofRecords" }; 
	...
	public void initTable() {
		table.setContainerDataSource(new BeanItemContainer<PrintBulkPaymentResultDto>(PrintBulkPaymentResultDto.class));
		...
		table.addGeneratedColumn("DownloadPDF",
			new Table.ColumnGenerator() {
				...
				public Object generateCell(Table source,
					...
					if((PrintBulkPaymentResultDto)itemId != null){
					
						final PrintBulkPaymentResultDto letterDto = (PrintBulkPaymentResultDto)itemId;
						String btnCaption = "";
						...
						generateLetterButton
								.addClickListener(new Button.ClickListener() {
									public void buttonClick(
											ClickEvent event) {
										PrintBulkPaymentResultDto reminderDto = (PrintBulkPaymentResultDto) event
												.getButton()
												.getData();
										if(reminderDto != null){
											
												fireViewEvent(SearchPrintPaymentBulkPresenter.PRINT_PAYMENT_BULK_LETTER, reminderDto);
...
//							
	...
	/*@Override
	public void tableSelectHandler(PrintBulkPaymentResultDto t) {
