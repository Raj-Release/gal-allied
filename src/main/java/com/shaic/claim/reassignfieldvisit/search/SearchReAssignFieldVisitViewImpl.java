...
import com.shaic.claim.fieldvisit.search.SearchFieldVisitTable;
...
public class SearchReAssignFieldVisitViewImpl extends AbstractMVPView implements SearchReAssignFieldVisitView, Searchable {
	
	private static final long serialVersionUID = 1934939436987293748L;

	@Inject
	private SearchReAssignFieldVisitForm searchForm;
	
	@Inject
	private SearchReAssignFieldVisitTable searchResultTable;	
	...
	public void list(Page<SearchReAssignFieldVisitTableDTO> tableRows) {
		...
		else
		{
			...
			Button homeButton = new Button("Re-Assign Feild Visit Representative Home");
	...
	public void doSearch() {
		...
		SearchReAssignFieldVisitFormDTO searchDTO = searchForm.getSearchDTO();
		...
		fireViewEvent(SearchReAssignFieldVisitPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
		} else {
			
			showErrorMessage("Please select anyone of the field");
		}
	}
