...
public class OMPCloseClaimClaimLevelSearchBasedUI extends SearchComponent<OMPCloseClaimClaimLevelSearchBasedFormDto>{
	
	private OMPCloseClaimClaimLevelSearchBasedFormDto searchDto;
	private OMPCloseClaimClaimLevelSearchBasedDetailTable searchTable;
...
//		VerticalLayout verticalLayout = new VerticalLayout();
	...
	{
		this.binder = new BeanFieldGroup<OMPCloseClaimClaimLevelSearchBasedFormDto>(OMPCloseClaimClaimLevelSearchBasedFormDto.class);
		this.binder.setItemDataSource(new OMPCloseClaimClaimLevelSearchBasedFormDto());
