...
public class OMPCreateIntimationRevisedCarousel extends ViewComponent{
	...
	public void init(OMPCreateIntimationTableDTO ompIntimationDTO, String caption) {
		...
		BeanItem<OMPCreateIntimationTableDTO> item = new BeanItem<OMPCreateIntimationTableDTO>(ompIntimationDTO);
