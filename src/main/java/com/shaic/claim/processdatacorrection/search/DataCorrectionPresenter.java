...
public class DataCorrectionPresenter extends AbstractMVPPresenter<DataCorrectionView>{
	...
	public static final String DC_PP_GENERATE_EVENT = "dc_pp_generate_event";
	public static final String ACTUAL_TOA_CHANGED = "actual_toa_changed";
	
	public static final String RESET_HOSPITAL_SCORING = "reset_hospital_scoring";
	
	public static final String REFERENCE_DATA_CLEAR = "reference_clear_data_coding";
	
	public static final String DATA_VALIDATION_GENERATE_COVID19VARIANT_FIELDS = "data_validation_generate_covid19vaiantfields";
	...
	public void generatePPCoadingField(@Observes @CDIEvent(DC_PP_GENERATE_EVENT) final ParameterDTO parameters)
	{
	...
	public void generateFieldsBasedOnTOA(@Observes @CDIEvent(ACTUAL_TOA_CHANGED) final ParameterDTO parameters)
	{
		Boolean isCked = (Boolean) parameters.getPrimaryParameter();
		view.generateFieldsBasedOnTOA(isCked);
	}
	
	public void resetScoringchanges(@Observes @CDIEvent(RESET_HOSPITAL_SCORING) final ParameterDTO parameters) {
	...
	public void generateCovid19VariantFields(@Observes @CDIEvent(DATA_VALIDATION_GENERATE_COVID19VARIANT_FIELDS) final ParameterDTO parameters)
	{
