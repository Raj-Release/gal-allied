...
public class SearchProcessDataCorrectionForm extends ViewComponent{
	...
	public void init() {
		...
		processRejectionPanel.setCaption("Data Validation");
			...
			searchBtn.addClickListener(new Button.ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					if(txtIntimationNo.getValue() != null && !txtIntimationNo.isEmpty()) {
						...
						fireViewEvent(SearchProcessDataCorrectionPresenter.SEARCH_INTIMATION_DATA_CORRECTION, txtIntimationNo.getValue(),userName);
					}else {
