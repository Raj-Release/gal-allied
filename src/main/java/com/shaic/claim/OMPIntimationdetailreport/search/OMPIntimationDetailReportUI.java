...
public class OMPIntimationDetailReportUI extends SearchComponent<OMPIntimationDetailReportFormDto>{
		...
		public void init() {
			...
			mainPanel.setCaption("Intimation Detail Report");
		...
		{
			this.binder = new BeanFieldGroup<OMPIntimationDetailReportFormDto>(OMPIntimationDetailReportFormDto.class);
			this.binder.setItemDataSource(new OMPIntimationDetailReportFormDto());
