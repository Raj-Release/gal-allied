...
public class OMPIntimationDetailReportViewImpl extends AbstractMVPView implements OMPIntimationDetailReportView{
	
	@Inject
	private OMPIntimationDetailReportUI searchForm;
		
	@Inject
	private OMPIntimationDetailReportDetailTable searchResultTable;
...
private VerticalSplitPanel mainPanel;
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof OMPIntimationDetailReportDetailTable)
			{
				((OMPIntimationDetailReportDetailTable) comp).removeRow();
			}
		}
	...
	public void doSearch() {
		OMPIntimationDetailReportFormDto searchDTO = searchForm.getSearchDTO();
		Pageable pageable = searchResultTable.getPageable();
		searchDTO.setPageable(pageable);
		String userName=(String)getUI().getSession().getAttribute(BPMClientContext.USERID);
		String passWord=(String)getUI().getSession().getAttribute(BPMClientContext.PASSWORD);
		fireViewEvent(OMPIntimationDetailReportPresenter.SUBMIT_SEARCH, searchDTO,userName,passWord);
