...
public class OMPReOpenClaimUI extends SearchComponent<OMPReOpenClaimFormDto>{
	
	private OMPReOpenClaimFormDto searchDto;
	private OMPReOpenClaimDetailTable searchTable;
	...
	{
		this.binder = new BeanFieldGroup<OMPReOpenClaimFormDto>(OMPReOpenClaimFormDto.class);
		this.binder.setItemDataSource(new OMPReOpenClaimFormDto());
