...
import com.shaic.claim.viewEarlierRodDetails.Page.ViewPreauthPresenter;
...
public class DiagnosisPreauthViewTable extends ViewComponent {
...
private Map<DiagnosisProcedureTableDTO, HashMap<String, AbstractField<?>>> tableItem = new HashMap<DiagnosisProcedureTableDTO, HashMap<String, AbstractField<?>>>();
	...
	public Object[] VISIBLE_COLUMNS = new Object[] {
			"diagOrProcedure", "description","sublimitApplicable","sublimitName","considerForPayment", "pedOrExclusion","amountConsidered", "packageAmt", "restrictionSI","utilizedAmt", "availableAmout", "minimumAmount","coPayPercentage", "coPayAmount", "netAmount", "subLimitAmount", "subLimitUtilAmount", "subLimitAvaliableAmt", "netApprovedAmt","remarks"};
	
	public Object[] SPECIFIC_PRODUCT_VISIBLE_COLUMNS = new Object[] {
			"diagOrProcedure", "description","sublimitApplicable","sublimitName","considerForPayment", "pedOrExclusion","amountConsidered", "packageAmt", "restrictionSI","utilizedAmt", "availableAmout", "subLimitAmount", "subLimitUtilAmount", "subLimitAvaliableAmt", "minimumAmount","coPayPercentage", "coPayAmount", "netApprovedAmt","remarks"};
	
	public Object[] CLAIM_REQUEST_VISIBLE_COLUMNS = new Object[] {
			"diagOrProcedure", "description","sublimitApplicable","sublimitName","considerForPayment", "pedOrExclusion", "packageAmt", "restrictionSI","utilizedAmt", "availableAmout", "subLimitAmount", "subLimitUtilAmount", "subLimitAvaliableAmt"};
	
	public TextField dummyField;
	
	public Boolean isMoreDetails = false;
	
	public void init(PreauthDTO bean,Boolean isMoreDetails) {
...
//		table.setWidth("100%");
		...
		table.setColumnHeader("sublimitApplicable", "Sublimit Applicable");
		table.setColumnHeader("sublimitName", "Sublimit Name");
...
//		manageListeners();
	...
	public class ImmediateFieldFactory extends DefaultFieldFactory {
		...
		public Field<?> createField(Container container, Object itemId,
			...
			if("amountConsidered".equals(propertyId)) {
...
//				consideredAmountListener(null,field);
				...
				if(tableRow.get("coPayPercentage") != null){
					calculationMethodForMedicalDecision(tableRow.get("coPayPercentage"), true);
				}
...
//		field.setValue(null);
	...
	public Integer calculateTotal() {
		...
		if(! isMoreDetails){
		fireViewEvent(ViewPreauthPresenter.SET_VALUES, netApprovedAmtTotal);
		}
		else{
			fireViewEvent(ViewPreauthMoreDetailsPresenter.SET_VALUE, netApprovedAmtTotal);
		}
		return total;
	}
