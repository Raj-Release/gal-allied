...
public class ViewTreatementVerificationTable extends GBaseTable<MedicalVerificationDTO> {
	
/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
/*public static final Object[] VISIBLE_COLUMNS = new Object[] {"description", "verifiedFlag", "remarks" };*/
...
//		table.setColumnWidth("remarks", 160);
		Object[] VISIBLE_COLUMNS = new Object[] {"description", "verifiedFlag", "remarks" };
