 ...
 *
 */
public class ErrorLogTable extends GBaseTable<SearchShadowProvisionDTO>{

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private final static Object[] NATURAL_COL_ORDER = new Object[]{"intimationNumber","existingProvision","newProvision","errCode","errDescription"};
