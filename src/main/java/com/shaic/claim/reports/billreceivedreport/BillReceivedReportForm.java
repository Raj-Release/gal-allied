...
public class BillReceivedReportForm extends SearchComponent<BillReceivedReportFormDTO>{
	private PopupDateField dateField;
	private PopupDateField toDateField;
	private Button xmlReport;
	private BillReceivedReportFormDTO bean;
	...
	//	initBinder();
		...
		mainPanel.setCaption("Bill Received Status Report");
	...
	public VerticalLayout mainVerticalLayout(){
		...
		mainVerticalLayout = new VerticalLayout();		
		dateField = new PopupDateField("Bill Rec From");
		dateField.setTextFieldEnabled(false);
		dateField.setDateFormat("dd/MM/yyyy");
		toDateField = new PopupDateField("Bill Rec To");
		...
		xmlReport.addClickListener(new ClickListener() {
			...
			private static final long serialVersionUID = 1L;
				...
				public void buttonClick(ClickEvent event) {
					fireViewEvent(BillReceivedReportPresenter.GENERATE_REPORT, null,null);
	...
	public BillReceivedReportFormDTO  validate()
	{
		String err = "";
		bean = new BillReceivedReportFormDTO();
	...
	{
		this.binder = new BeanFieldGroup<BillReceivedReportFormDTO>(BillReceivedReportFormDTO.class);
		this.binder.setItemDataSource(new BillReceivedReportFormDTO());
