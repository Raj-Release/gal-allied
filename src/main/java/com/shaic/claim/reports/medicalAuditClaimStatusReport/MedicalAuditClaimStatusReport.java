...
@UIScoped
public class MedicalAuditClaimStatusReport extends ViewComponent {
	...
	@Inject
	private MedicalAuditClaimStatusReportTable medicalAuditClaimStatusTable;
	...
	public void init()
	{
		...
		medicalAuditClaimStatusTable.init("", false, false);
	...
	private Panel buildSearchPanel(){
		...
		searchPanel = new Panel("Medical Audit Claim Status Details");
	...
	private VerticalLayout buildSearchLayout(){
		...
		searchBtn.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				if(!filter.isEmpty()){
				fireViewEvent(MedicalAuditClaimStatusReportPresenter.SEARCH_MEDICAL_AUDIT_CLAIM_DETAILS_REPORT, filter);
				}				
			}
		});
...
//		}
	...
	public void showTableResult(List<MedicalAuditClaimStatusReportDto> resultDtoList){
		
		searchBtn.setEnabled(true);
		if(resultDtoList != null && !resultDtoList.isEmpty()){
			
			medicalAuditClaimStatusTable.setTableList(resultDtoList);			
			searchVerticalLayout.addComponent(medicalAuditClaimStatusTable);
			...
			Button homeButton = new Button("Medical Audit Claim Status Report Home");
			...
			homeButton.addClickListener(new ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					dialog.close();
					resetAlltheValues();
					fireViewEvent(MenuItemBean.MEDICAL_AUDIT_CLAIM_STATUS_REPORT, null);
	...
	public void resetAlltheValues(){
		...
		medicalAuditClaimStatusTable.setTableList(new ArrayList<MedicalAuditClaimStatusReportDto>());
		searchBtn.setEnabled(true);
		if(exportBtn != null){
			buttonLayout.removeComponent(exportBtn);
			buttonLayout.removeComponent(dummylabel);	
	...
	private void addExportButton() {
		...
		exportBtn.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				excelExport = new ExcelExport(medicalAuditClaimStatusTable.getTable());
				excelExport.setReportTitle("Medical Audit Claim Status Report");
