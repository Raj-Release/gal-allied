...
public class MedicalAuditClaimStatusReportTable extends GBaseTable<MedicalAuditClaimStatusReportDto> {
	...
	public void initTable() {
			setSizeFull();
			table.setContainerDataSource(new BeanItemContainer<MedicalAuditClaimStatusReportDto>(MedicalAuditClaimStatusReportDto.class));
			...
			table.addGeneratedColumn("dms",
				new Table.ColumnGenerator() {
					...
					public Object generateCell(Table source,
						...
						if(((MedicalAuditClaimStatusReportDto)itemId).getPolicyNumber() != null){
							
							String policyNumber = ((MedicalAuditClaimStatusReportDto)itemId).getPolicyNumber();
						
							String intimationNo = ((MedicalAuditClaimStatusReportDto)itemId).getIntimationNo();
				...
				new Table.ColumnGenerator() {
					...
					public Object generateCell(Table source,
						...
						if(((MedicalAuditClaimStatusReportDto)itemId).getPolicyNumber() != null){
							...
							final String intimationNo = ((MedicalAuditClaimStatusReportDto)itemId).getIntimationNo();
							
							final String claimNo = ((MedicalAuditClaimStatusReportDto)itemId).getClaimNumber();
...
//												audit Link integration to be done
				...
				new Table.ColumnGenerator() {
					...
					public Object generateCell(Table source,
						...
						if(((MedicalAuditClaimStatusReportDto)itemId).getPolicyNumber() != null){
							...
							final MedicalAuditClaimStatusReportDto medicalAuditClaimStatusReportDto = (MedicalAuditClaimStatusReportDto)itemId;
							...
							viewPolicyButton
									.addClickListener(new Button.ClickListener() {
										public void buttonClick(
												ClickEvent event) {
											MedicalAuditClaimStatusReportDto medicalAuditClaimStatusReportDto = (MedicalAuditClaimStatusReportDto) event
													.getButton()
													.getData();
			...
			table.addGeneratedColumn("previousclaims",
				new Table.ColumnGenerator() {
					...
					public Object generateCell(Table source,
							final Object itemId, Object columnId) {
						if(((MedicalAuditClaimStatusReportDto)itemId).getIntimationNo() != null){
									...
									.addClickListener(new Button.ClickListener() {
										public void buttonClick(
											...
											MedicalAuditClaimStatusReportDto medicalAuditClaimStatusReportDto = (MedicalAuditClaimStatusReportDto) event
													.getButton()
													.getData();
											String hospitalCode = medicalAuditClaimStatusReportDto.getHospitalCode();
...
//											}
	...
	@Override
	public void tableSelectHandler(MedicalAuditClaimStatusReportDto t) {
