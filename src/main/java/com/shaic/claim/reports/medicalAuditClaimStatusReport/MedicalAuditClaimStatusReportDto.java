...
public class MedicalAuditClaimStatusReportDto {
	...
	public MedicalAuditClaimStatusReportDto(ClaimDto claimDto){
	...
	public MedicalAuditClaimStatusReportDto(Claim claimObj, String hospCode){
