...
public class OPClaimReportForm extends SearchComponent<OPClaimReportFormDTO>{
	...
	public void init() {
		...
		mainPanel.setCaption("OP Claim Report");
		...
		xmlReport.addClickListener(new ClickListener() {
			...
			private static final long serialVersionUID = 1L;
				...
				public void buttonClick(ClickEvent event) {
					fireViewEvent(OPClaimReportPresenter.GENERATE_REPORT, null,null);
	...
	{
		this.binder = new BeanFieldGroup<OPClaimReportFormDTO>(OPClaimReportFormDTO.class);
		this.binder.setItemDataSource(new OPClaimReportFormDTO());
