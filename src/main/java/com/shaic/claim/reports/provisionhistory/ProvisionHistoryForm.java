...
public class ProvisionHistoryForm extends SearchComponent<ProvisionHistoryFormDTO> {
private static final long serialVersionUID = 1L;
	...
	public void init() {
		...
		mainPanel.setCaption("Provision History");
	...
	public VerticalLayout mainVerticalLayout(){
		...
		absoluteLayout_3.setHeight("150px");//150px
	...
	{
		this.binder = new BeanFieldGroup<ProvisionHistoryFormDTO>(ProvisionHistoryFormDTO.class);
		this.binder.setItemDataSource(new ProvisionHistoryFormDTO());
