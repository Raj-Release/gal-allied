...
public class OMPClaimProcessMakerUI extends SearchComponent<OMPClaimProcessMakerFormDto> {
	
private OMPClaimProcessMakerFormDto	searchDto;
private OMPClaimProcessMakerDetailTable	searchTable;
...
initBinder();
	...
	mainPanel.setCaption("Claim Process -Maker");
...
public VerticalLayout mainVerticalLayout(){
	...
	FormLayout formLayoutReight = new FormLayout(claimNumber);	
...
{
	this.binder = new BeanFieldGroup<OMPClaimProcessMakerFormDto>(OMPClaimProcessMakerFormDto.class);
	this.binder.setItemDataSource(new OMPClaimProcessMakerFormDto());
