...
public class OMPProcessOmpClaimProcessorDetailTable extends GBaseTable<OMPProcessOmpClaimProcessorTableDTO>{
	...
	table.setContainerDataSource(new BeanItemContainer<OMPProcessOmpClaimProcessorTableDTO>(OMPProcessOmpClaimProcessorTableDTO.class));
	...
	public static BufferedImage  byteArrayToImage(byte[] bytes){  
	 ...
	 public void alertMessage(final OMPProcessOmpClaimProcessorTableDTO t, String message) {
...
//			dialog.setCaption("Alert");
	 ...
	 @Override
		public void tableSelectHandler(OMPProcessOmpClaimProcessorTableDTO t) {
...
//				getErrorMessage(callLockProcedure);  
		...
		return "ompprocessompclaimprocessor-";
		}
