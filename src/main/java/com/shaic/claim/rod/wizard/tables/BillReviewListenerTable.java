				 ...
				 else
				 {
					 ...
					 if(selValue != null && selValue.getValue() != null && 
						 ...
						 if(bean.getProductKey().equals(ReferenceTable.SENIOR_CITIZEN_RED_CARPET_REVISED_PRODUCT_INDIVIDUAL) ||
								 ...
								 || bean.getProductKey().equals(ReferenceTable.STAR_CORONA_KAVACH_PRODUCT_KEY_IND)
								 ||  bean.getProductKey().equals(ReferenceTable.STAR_CORONA_KAVACH_PRODUCT_KEY_FLT)
								 ||  bean.getProductKey().equals(ReferenceTable.STAR_GRP_COVID_PROD_KEY_INDI)
								 || bean.getProductKey().equals(ReferenceTable.STAR_GRP_AROGYA_SANJEEVANI_PROD_KEY)
								 || bean.getProductKey().equals(ReferenceTable.GROUP_TOPUP_PROD_KEY)) {
