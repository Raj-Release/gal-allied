...
public class RODQueryTableForAcknowlegementDetails extends GBaseTable<RODQueryDetailsDTO>{
...
/*	@PersistenceContext(unitName = "PERSISTENCE_UNIT_NAME", type = PersistenceContextType.EXTENDED)
	...
	private static final Object[] NATURAL_COL_ORDER = new Object[] {
			...
			"serialNumber","rodNo", "billClassification", "diagnosis",
			"claimedAmount", "queryRaisedRole", "queryRaisedDate", "queryStatus","queryReplyStatus" };
	
	private static final Object[] NATURAL_COL_ORDER_PA = new Object[] {
		//"queryNo", "rodNo", "billClassification", "diagnosis",""
		"queryNo","rodNo", "benifitOrCover", "queryType",
		"claimedAmount", "queryRaisedRole", "queryRaisedDate", "queryStatus","queryReplyStatus" };
...
static {
		...
		fieldMap.put("queryReplyStatus", new TableFieldDTO("queryReplyStatus", TextField.class,String.class, false));
	}

	public void setPAColumnsForRODQuery()
	{
	table.setVisibleColumns(NATURAL_COL_ORDER_PA);
	table.setColumnHeader("queryType", "Query Type");
	table.setColumnHeader("queryNo", "Query No");
...
//				String replyStatus = "";
//				
//				dropDownValuesReq = new BeanItemContainer<SelectValue>(SelectValue.class);
//				SelectValue selectValue1 = new SelectValue();
//				selectValue1.setId(1l);
//				selectValue1.setValue("YES ");
//				dropDownValuesReq.addBean(selectValue1);
//				
//				SelectValue selectValue2 = new SelectValue();
//				selectValue2.setId(2l);
//				selectValue2.setValue("NO");
//				dropDownValuesReq.addBean(selectValue2);
//				
//				
