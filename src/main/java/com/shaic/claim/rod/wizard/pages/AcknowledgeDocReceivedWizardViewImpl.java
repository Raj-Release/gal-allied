...
public class AcknowledgeDocReceivedWizardViewImpl extends AbstractMVPView implements
AcknowledgeDocReceivedWizard {
...
//	private String[] arrScreenName ; 
	...
	private void initBinder() {
		...
		item.addNestedProperty("documentDetails.hospitalCash");
...
/*		item.addNestedProperty("documentDetails.documentCheckList");
	...
	public void initView(ReceiptOfDocumentsDTO rodDTO)
	{
		...
		viewDetails.initView(bean.getClaimDTO().getNewIntimationDto().getIntimationId(),0l, ViewLevels.ACK_ROD_PROCESS,"Acknowledge Receipt of Documents");
...
//		}
	...
	{
		fireViewEvent(AcknowledgeDocReceivedWizardPresenter.VALIDATE_ACK_DOC_REC_USER_RRC_REQUEST, preauthDTO);//, secondaryParameters);
	}
...
//		popup.setContent( viewDocumentDetailsPage);
	...
	public void buildValidationUserRRCRequestLayout(Boolean isValid) {
		...
		else
		{
			...
			//ViewDocumentDetailsDTO documentDetails =  new ViewDocumentDetailsDTO();
			//documentDetails.setClaimDto(bean.getClaimDTO());
			rewardRecognitionRequestViewObj.initPresenter(SHAConstants.ACKNOWLEDGE_DOC_RECEIVED);
...
//		hLayout.setMargin(true);
		...
		HashMap<String, String> buttonsNamewithType = new HashMap<String, String>();
		buttonsNamewithType.put(GalaxyButtonTypesEnum.OK.toString(), "Acknowledge Document Received Home");
		HashMap<String, Button> messageBoxButtons = GalaxyAlertBox
				.createInformationBox("Acknowledgement completed successfully !!!</b>", buttonsNamewithType);
	...
	public void setsubCategoryValues(BeanItemContainer<SelectValue> selectValueContainer,GComboBox subCategory,SelectValue value){
	 ...
	 public void setsourceValues(BeanItemContainer<SelectValue> selectValueContainer,GComboBox source,SelectValue value){
		...
		private void clearObject() {
			...
			acknowledgeReceiptViewImpl.setClearReferenceData();
		}
