...
import com.shaic.claim.rod.wizard.forms.BillEntryDetailsPage;
 ...
 *
 */
public class BillEntryDetailsViewImpl extends AbstractMVPView 
implements BillEntryDetailsView {
	
	@Inject
	private BillEntryDetailsPage billEntryDetailsPage;
	...
	public Component getContent() {
		...
		fireViewEvent(BillEntryDetailsPresenter.BILL_ENTRY_DETAILS_PAGE_UPLOADED_DOC_SETUP_DROPDOWN_VALUES, bean);
		// TODO Auto-generated method stub
		return comp;
	}
	...
	public void setClearReferenceData(){
		billEntryDetailsPage.setClearReferenceData();
	}

	@Override
	public void setUpdateOtherClaimsDetails(
			List<UpdateOtherClaimDetailDTO> updateOtherClaimDetails) {
	     billEntryDetailsPage.updatePreviousClaimDetails(updateOtherClaimDetails);
	}

	
	//added for new product
	@Override
	public void generateFieldsBasedOnHospitalCashProduct(Boolean selectedValue) {
		billEntryDetailsPage.generateFieldsBasedOnHospitalCashProduct(selectedValue);
