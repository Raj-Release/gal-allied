 ...
 *
 */
public class UploadedDocumentsTable extends GEditableTable<UploadDocumentDTO> {
	...
	public UploadedDocumentsTable() {
		super(UploadedDocumentsTable.class);
		setUp();
	}
...
//							    hsplitPanel.setFirstComponent(imagePanel);	
	...
	public void loadTableColumnsAsPerScreen(String argPresenterString){
		...
		if(SHAConstants.OUTPATIENT_FLAG.equalsIgnoreCase(argPresenterString)) {
			VISIBLE_COLUMNS = new Object[] {"fileTypeValue","fileName","billNo", "billDate", "noOfItems", "billValue"};
		}else{
