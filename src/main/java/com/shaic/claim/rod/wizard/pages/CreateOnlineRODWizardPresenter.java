 ...
 *
 */
@ViewInterface(CreateOnlineRODWizardView.class)
public class CreateOnlineRODWizardPresenter extends AbstractMVPPresenter<CreateOnlineRODWizardView>{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 3863726891021633838L;

	public static final String SUBMIT_ONLINE_ROD = "submit_online_rod";
	
	public static final String SHOW_ONLINE_PAYMENT_LETTER_POPUP = "show_online_payment_letter_popup";
	
	public static final String GET_ONLINE_SEC_COVER = "create_online_rod_get_sec_cover";

	public static final String GET_ONLINE_SUB_COVER = "create_online_rod_get_sub_cover";
	
	public static final String SUBMIT_ONLINE_ACKNOWLEDGE_DOC_RECEIVED = "submit_online_acknowledge_doc_received";
	
	public static final String VALIDATE_CREATE_ONLINE_ROD_USER_RRC_REQUEST = "validate_create_online_rod_user_rrc_request";
	
	public static final String CREATE_ONLINE_ROD_LOAD_RRC_REQUEST_DROP_DOWN_VALUES = "create_online_rod_load_rrc_request_drop_down_values";
	
	public static final String CREATE_ONLINE_ROD_SAVE_RRC_REQUEST_VALUES = "create_online_rod_save_rrc_request_values";
	
	public static final String CLAIMED_ONLINE_AMNT_ALERT = "claimed_online Amount Alert";
	
	public static final String UPDATE_ONLINE_ROD = "update_online_rod";
	
	public static final String CREATE_ONLINE_ROD_LOAD_RRC_REQUEST_SUB_CATEGORY_VALUES = "create_online_rod_load_rrc_request_sub_category_values";
	
	public static final String CREATE_ONLINE_ROD_LOAD_RRC_REQUEST_SOURCE_VALUES = "create_online_rod_load_rrc_request_source_values";
	 ...
	 * */
	public void validatUserForRRCRequest(@Observes @CDIEvent(VALIDATE_CREATE_ONLINE_ROD_USER_RRC_REQUEST) final ParameterDTO parameters){
	...
	public void saveRRCRequestValues(@Observes @CDIEvent(CREATE_ONLINE_ROD_SAVE_RRC_REQUEST_VALUES) final ParameterDTO parameters){
		PreauthDTO preauthDTO = (PreauthDTO) parameters.getPrimaryParameter();
	...
	public void loadRRCRequestDropDownValues(
			@Observes @CDIEvent(CREATE_ONLINE_ROD_LOAD_RRC_REQUEST_DROP_DOWN_VALUES) final ParameterDTO parameters) 
		{
	...
	public void submitWizard(
			@Observes @CDIEvent(SUBMIT_ONLINE_ROD) final ParameterDTO parameters) {
...
//							apiService.updateProvisionAmountToPremia(provisionAmtInput);
	...
	private void showPaymentLetterPopup(@Observes @CDIEvent(SHOW_ONLINE_PAYMENT_LETTER_POPUP) final ParameterDTO parameters)
	{
	...
	public void getSecCover(
			@Observes @CDIEvent(GET_ONLINE_SEC_COVER) final ParameterDTO parameters) {
	...
	public void getSubCover(
			@Observes @CDIEvent(GET_ONLINE_SUB_COVER) final ParameterDTO parameters) {
	...
	public void validateClaimedAmount(
			@Observes @CDIEvent(CLAIMED_ONLINE_AMNT_ALERT) final ParameterDTO parameters) 
	{
	...
	public void updateWizard(
			@Observes @CDIEvent(UPDATE_ONLINE_ROD) final ParameterDTO parameters) {
		ReceiptOfDocumentsDTO rodDTO = (ReceiptOfDocumentsDTO) parameters.getPrimaryParameter();
	...
	public void setUpSubCategoryValues(
			@Observes @CDIEvent(CREATE_ONLINE_ROD_LOAD_RRC_REQUEST_SUB_CATEGORY_VALUES) final ParameterDTO parameters) {
	...
	public void setUpsourceValues(
			@Observes @CDIEvent(CREATE_ONLINE_ROD_LOAD_RRC_REQUEST_SOURCE_VALUES) final ParameterDTO parameters) {
