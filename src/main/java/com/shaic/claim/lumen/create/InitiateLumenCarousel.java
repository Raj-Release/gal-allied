...
public class InitiateLumenCarousel extends ViewComponent{
	...
	public void init(LumenSearchResultTableDTO resultDTO, String caption) {
		...
		if(resultDTO != null ){
			classOfBusiness.setValue(resultDTO.getLob().getValue());
			...
			if(resultDTO.getPolicyInsured() != null){
				insuerdPatientId.setValue(resultDTO.getPolicyInsured().getHealthCardNumber());
				insuredName.setValue(resultDTO.getPolicyInsured().getInsuredName());
			}
		}
