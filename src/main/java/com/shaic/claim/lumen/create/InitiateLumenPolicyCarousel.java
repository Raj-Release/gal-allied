...
public class InitiateLumenPolicyCarousel extends ViewComponent{
	...
	public void init(LumenPolicySearchResultTableDTO resultDTO, String caption) {
		...
		if(resultDTO != null ){
			...
			policyType.setValue(resultDTO.getPolicyType());
			productType.setValue(resultDTO.getProductType());
			insuredPatientName.setValue(resultDTO.getProposerName());
