...
@UIScoped
public class LumenSearchCoordinatorReqForm extends SearchComponent<LumenSearchReqFormDTO>{
...
//	private ComboBox cmbCPUOffice;
	...
	@Inject
	SearchCoordinatorResultTable lumenTable;
	...
	public void init() {
		...
		mainPanel.setCaption("Process Co-ordinator Request");
...
//		cmbCPUOffice = binder.buildAndBind("CPU Office","cmbCPUOffice",ComboBox.class);
		...
		//Hiding Source drop-down as per BA Request , because the source drop-down will be useful only in level one. JIra-Id 8556
		cmbSource.setVisible(false);
...
//		cmbCPUOffice.setItemCaptionPropertyId("value");
		...
		BeanItemContainer<SelectValue> lumenStatusTypes = lumenService.getCoordinatorStatus();
