...
public class SearchLumenLevelTwoRequestViewImpl extends AbstractMVPView implements SearchLumenLevelTwoRequestView{

	@Inject
	private LumenSearchLevelTwoReqForm lumenForm;
	
	@Inject
	private SearchLevelTwoResultTable lumenTable;
...
//		lumenTable.init("", false, false);
	...
	public void doSearch() {
		if(!validatePage()){
			...
			fireViewEvent(SearchLumenLevelTwoRequestPresenter.DO_LUMEN_REQ_LEVEL_II_SEARCH, searchDTO,userName,passWord);
		}else{
