...
@UIScoped
public class LumenSearchLevelTwoReqForm extends SearchComponent<LumenSearchReqFormDTO>{
...
//	private ComboBox cmbCPUOffice;
	...
	@Inject
	SearchLevelTwoResultTable lumenTable;
	...
	public void init() {
		...
		mainPanel.setCaption("Process Lumen Request - Level II");
...
//		cmbCPUOffice.setItemCaptionPropertyId("value");
		...
		BeanItemContainer<SelectValue> lumenStatusTypes = lumenService.getLevelTwoStatus();
