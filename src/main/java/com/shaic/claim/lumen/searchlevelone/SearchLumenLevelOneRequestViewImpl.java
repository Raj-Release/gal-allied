...
public class SearchLumenLevelOneRequestViewImpl extends AbstractMVPView implements SearchLumenLevelOneRequestView{

	@Inject
	private LumenSearchLevelOneReqForm lumenForm;
	
	@Inject
	private SearchLevelOneResultTable lumenTable;
...
//		lumenTable.init("", false, false);
	...
	public void doSearch() {
		if(!validatePage()){
			...
			fireViewEvent(SearchLumenLevelOneRequestPresenter.DO_LUMEN_REQ_LEVEL_I_SEARCH, searchDTO,userName,passWord);
		}else{
