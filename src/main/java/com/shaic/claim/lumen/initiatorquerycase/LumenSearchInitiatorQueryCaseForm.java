...
@UIScoped
public class LumenSearchInitiatorQueryCaseForm extends SearchComponent<LumenSearchReqFormDTO>{
...
//	private ComboBox cmbCPUOffice;
	...
	@Inject
	SearchInitiatorCaseResultTable lumenTable;
	...
	public void init() {
		...
		mainPanel.setCaption("Initiator (Query Cases)");
...
//		cmbCPUOffice.setItemCaptionPropertyId("value");
		...
		BeanItemContainer<SelectValue> lumenStatusTypes = lumenService.getIntiatorStatus();
