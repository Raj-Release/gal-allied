...
public class SearchHospitalContactNoTable extends GBaseTable<HospitalDto>{
	...
	public void initTable() {
		...
		table.addGeneratedColumn("select", new Table.ColumnGenerator() {
		      ...
		      public Object generateCell(final Table source, final Object itemId, Object columnId) {
		    	  ...
		    	  if(selectedInsured != null && !selectedInsured.getIsEnable()){
		    	  ...
		    	  btnSelect.addClickListener(new ClickListener() {
		  			...
		  			public void buttonClick(ClickEvent event) {
		  				HospitalDto selectedInsured = (HospitalDto)itemId;
		  				if(presenterString.equals(SHAConstants.OP_DIAGNOSTIC_TAB)){
		  					fireViewEvent(ProcessOPClaimWizardPresenter.HOSPITAL_CONTACT_SEARCH, selectedInsured);
		  				}else{
		  					fireViewEvent(IntimationDetailsPresenter.HOSPITAL_CONTACT_NO_SEARCH, selectedInsured);
		  				}
		  			}
		  		});
