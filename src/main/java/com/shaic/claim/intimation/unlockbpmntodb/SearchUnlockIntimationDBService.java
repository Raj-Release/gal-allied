...
@Stateless
public class SearchUnlockIntimationDBService extends AbstractDAO<Intimation> {
	

	
	public SearchUnlockIntimationDBService(){
	...
	public  Page<SearchUnlockIntimationDBTableDTO> searchForUnlockIntimation(
		...
		taskProcedure = dbCalculationService.getTaskProcedureUnlock(intimationNo);
