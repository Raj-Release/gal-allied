...
import com.shaic.claim.intimation.unlockbpmntodb.SearchUnlockIntimationDBTable;
...
public class SearchUnlockOMPIntimationDBViewImpl extends AbstractMVPView implements SearchUnlockOMPIntimationDBView {
	...
	@Inject
	private SearchUnlockOMPIntimationDBForm searchForm;
	...
	public void doSearch() {
		...
		if(searchForm.validatePage()){
			...
			fireViewEvent(SearchUnlockOMPIntimationDBPresenter.SEARCH_OMP_BUTTON_CLICK, searchDTO,userName,passWord);
		} else {
