...
public class SearchUnlockIntimationForm  extends SearchComponent<SearchUnlockIntimationFormDTO> {
	...
	{
		this.binder = new BeanFieldGroup<SearchUnlockIntimationFormDTO>(SearchUnlockIntimationFormDTO.class);
		this.binder.setItemDataSource(new SearchUnlockIntimationFormDTO());
	...
	public Boolean validatePage(){
		...
		if(txtIntimationNo.getValue() == null || txtIntimationNo.getValue().equals("") 
				|| txtIntimationNo.getValue().length() <= 6){
			isValid = false;
		}
		return isValid;
	}
