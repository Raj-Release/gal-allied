...
public class SearchFvrReportGradingViewImpl  extends AbstractMVPView implements SearchFvrReportGradingView, Searchable {	
	...
	@Inject
	private SearchFvrReportGradingPage searchForm;
...
/*		
		...
		else
		{
			...
			homeButton.addClickListener(new ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					dialog.close();
					fireViewEvent(MenuItemBean.FVR_GRADING, null);
	...
	public void doSearch() {
		SearchFvrReportGradingFormDto searchDTO = searchForm.getSearchDTO();
		...
		fireViewEvent(SearchFvrReportGradingPresenter.SEARCH_FVR_GRADING, searchDTO,userName,passWord);
	...
	public void init(BeanItemContainer<SelectValue> parameter, BeanItemContainer<SelectValue> parameter1) {
		...
		searchForm.setCpuCode(parameter, parameter1);
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchFvrReportGradingTable)
			{
				((SearchFvrReportGradingTable) comp).removeRow();
			}
		}
	}
