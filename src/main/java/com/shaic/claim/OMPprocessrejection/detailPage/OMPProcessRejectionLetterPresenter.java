...
//import com.shaic.claim.reimbursement.financialapproval.pages.billreview.FinancialReviewPageWizard;
...
//
//@ViewInterface(OMPProcessRejectionLetterView.class)
//public class OMPProcessRejectionLetterPresenter extends AbstractMVPPresenter<OMPProcessRejectionLetterView>{
//	
...
//				.getClaimedAmountDetailsForSection(productKey, insuredSumInsured,
...
//		sublimitList = dbCalculationService
//				.getClaimedAmountDetailsForSection(productKey, insuredSumInsured,
//						insuredAge,0l, "0", (preauthDTO.getPreauthDataExtractionDetails().getSectionDetailsDTO().getSubCover() != null ? preauthDTO.getPreauthDataExtractionDetails().getSectionDetailsDTO().getSubCover().getCommonValue() : preauthDTO.getClaimDTO().getClaimSubCoverCode()));
//	}
//	
