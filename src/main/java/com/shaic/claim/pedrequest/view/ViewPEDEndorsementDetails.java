...
public class ViewPEDEndorsementDetails extends Window {
	...
	private GridLayout escalatedDetailsGridLayout;
	private Label escalateRemarkslbl;
	private TextArea escalateRemarksTxt;
	...
	public ViewPEDEndorsementDetails() {
		...
		setReadOnly(escalatedDetailsGridLayout, true);
	...
	private Panel buildSpecialistAdviseDetailsPanel() {
		...
		escalatedDetailsGridLayout = buildEscalateDetailsGridLayout(); 
		escalatedDetailsPanel
		.setContent(escalatedDetailsGridLayout);
	...
	private GridLayout buildEscalateDetailsGridLayout(){
		escalatedDetailsGridLayout = new GridLayout();
		escalatedDetailsGridLayout.setColumnExpandRatio(0, 0.10f);
		escalatedDetailsGridLayout.setColumnExpandRatio(1, 90.0f);
		//Vaadin8-setImmediate() escalatedDetailsGridLayout.setImmediate(false);
		escalatedDetailsGridLayout.setWidth("100.0%");
		escalatedDetailsGridLayout.setHeight("100.0%");
		escalatedDetailsGridLayout.setMargin(true);
		escalatedDetailsGridLayout.setSpacing(true);
		escalatedDetailsGridLayout.setColumns(2);
		escalatedDetailsGridLayout.setRows(2);
		
		escalateRemarkslbl = new Label();
		//Vaadin8-setImmediate() escalateRemarkslbl.setImmediate(false);
		escalateRemarkslbl.setWidth("-1px");
		escalateRemarkslbl.setHeight("-1px");
		escalateRemarkslbl.setValue("Escalate Remarks");
		specialistAdviseDetailsGridLayout.addComponent(escalateRemarkslbl, 0,
				0);

		escalateRemarksTxt = new TextArea();
		//Vaadin8-setImmediate() escalateRemarksTxt.setImmediate(false);
		escalateRemarksTxt.setWidth("100%");
		escalateRemarksTxt.setHeight("-1px");
		escalatedDetailsGridLayout.addComponent(escalateRemarksTxt, 0,
				1);
		
		
	
		return escalatedDetailsGridLayout;
	}
