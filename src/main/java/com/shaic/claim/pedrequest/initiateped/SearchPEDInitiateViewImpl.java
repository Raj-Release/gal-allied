...
public class SearchPEDInitiateViewImpl  extends AbstractMVPView implements SearchPEDInitiateView, Searchable  {
	

	private static final long serialVersionUID = 1934939436987293748L;

	@Inject
	private SearchPEDInitiateForm searchForm;
	
	@Inject
	private SearchPEDInitiateTable searchResultTable;
	...
	*/
	...
	public void doSearch() {
		...
		if(validate){
			...
			SearchPEDInitiateFormDTO searchDTO = searchForm.getSearchDTO();
			...
			fireViewEvent(SearchPEDInitiatePresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
		} else {
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchPEDInitiateTable)
			{
				((SearchPEDInitiateTable) comp).removeRow();
			}
		}
	}
