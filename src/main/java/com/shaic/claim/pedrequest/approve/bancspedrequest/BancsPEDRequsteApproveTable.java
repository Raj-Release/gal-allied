...
public class BancsPEDRequsteApproveTable extends GBaseTable<OldPedEndorsementDTO> {

public BancsPEDRequsteApproveTable() {
		...
		if(pedRecord.getKey().equals(pedRecord.getCurrentPED())){
	    	...
	    	button.addClickListener(new Button.ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					...
					fireViewEvent(BancsPEDRequestDetailsApprovePresenter.BANCS_EDIT_BUTTON, pedRequestDetailsProcessDTO);
...
public void tableSelectHandler(OldPedEndorsementDTO t) {
      fireViewEvent(BancsPEDRequestDetailsApprovePresenter.BANCS_SET_MODIFIED_DATA, t);
}
