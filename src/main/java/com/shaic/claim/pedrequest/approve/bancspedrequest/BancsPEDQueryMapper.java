...
public class BancsPEDQueryMapper {
	
	static BancsPEDQueryMapper myObj;
	...
	private static BoundMapperFacade<OldInitiatePedEndorsement,BancsPEDRequestDetailsApproveDTO>pedApproveDetailsMapper;
...
//		
		...
		pedApproveDetailsMapper=mapperFactory.getMapperFacade(OldInitiatePedEndorsement.class, BancsPEDRequestDetailsApproveDTO.class);
	}
	...
	public static BancsPEDRequestDetailsApproveDTO getPedApproveDto(OldInitiatePedEndorsement resultList) {
		pedApprovalDetails.register();
		
		BancsPEDRequestDetailsApproveDTO dest = pedApproveDetailsMapper.map(resultList);
		return dest;
	
	}
	
	public static OldInitiatePedEndorsement getPedApprove(BancsPEDRequestDetailsApproveDTO bean) {
	...
	public static BancsPEDQueryMapper getInstance(){
        if(myObj == null){
            myObj = new BancsPEDQueryMapper();
            getAllMapValues();
        }
        return myObj;
	 }
