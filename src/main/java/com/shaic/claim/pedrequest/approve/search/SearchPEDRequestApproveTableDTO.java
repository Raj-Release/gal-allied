...
/*	private String doorApartmentNumber;
    ...
    private SearchPEDRequestApproveFormDTO searchPEDRequestApproveFormDTO;
	...
	public SearchPEDRequestApproveFormDTO getSearchPEDRequestApproveFormDTO() {
		return searchPEDRequestApproveFormDTO;
	}

	public void setSearchPEDRequestApproveFormDTO(
			SearchPEDRequestApproveFormDTO searchPEDRequestApproveFormDTO) {
		this.searchPEDRequestApproveFormDTO = searchPEDRequestApproveFormDTO;
	}
