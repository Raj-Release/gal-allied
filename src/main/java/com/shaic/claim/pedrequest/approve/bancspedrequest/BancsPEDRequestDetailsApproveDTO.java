...
public class BancsPEDRequestDetailsApproveDTO extends AbstractSearchDTO implements Serializable{
...
/**
	...
	private List<BancsPEDQueryDetailTableDTO> pedQueryDetailsTableData = new ArrayList<BancsPEDQueryDetailTableDTO>();
	...
	public List<BancsPEDQueryDetailTableDTO> getPedQueryDetailsTableData() {
		return pedQueryDetailsTableData;
	}

	public void setPedQueryDetailsTableData(
			List<BancsPEDQueryDetailTableDTO> pedQueryDetailsTableData) {
		this.pedQueryDetailsTableData = pedQueryDetailsTableData;
	}
