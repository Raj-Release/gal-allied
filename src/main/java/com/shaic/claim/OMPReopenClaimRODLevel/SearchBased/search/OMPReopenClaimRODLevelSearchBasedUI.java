...
public class OMPReopenClaimRODLevelSearchBasedUI extends SearchComponent<OMPReopenClaimRODLevelSearchBasedFormDto>{
	
private	OMPReopenClaimRODLevelSearchBasedFormDto searchDto;
	
private OMPReopenClaimRODLevelSearchBasedDetailTable searchTable;
...
public void init() {
	...
	mainPanel.setCaption("Re-open Claim ROD Level (Search Based)");
...
public VerticalLayout mainVerticalLayout(){
	...
	policyNumber = binder.buildAndBind("Policy Nunber","policyNo",TextField.class);
	claimNumber = binder.buildAndBind("Claim No","claimno",TextField.class);
	
	FormLayout formLayoutLeft = new FormLayout(intimationNumber,claimNumber);
...
{
	this.binder = new BeanFieldGroup<OMPReopenClaimRODLevelSearchBasedFormDto>(OMPReopenClaimRODLevelSearchBasedFormDto.class);
	this.binder.setItemDataSource(new OMPReopenClaimRODLevelSearchBasedFormDto());
