...
public class SearchPreMedicalProcessingEnhancementTableDTO extends AbstractTableDTO implements Serializable {
	...
	public void setAutoAllocation(boolean isAutoAllocation) {
		this.isAutoAllocation = isAutoAllocation;
	}
