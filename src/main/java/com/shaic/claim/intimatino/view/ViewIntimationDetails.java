...
//			txtCpuCode.setValue(this.bean.getCpuId().toString());
		   ...
		   // "Refer to ICAC Remarks  <B style=color:red;> * </B>"
		    ...
		    FormLayout secondForm = new FormLayout(acctorDeath,txtPolicyNo,txtIssuingOffice,txtProductName,txtInsuredName,txtState,txtCity,txtArea,txtHospitalName,txtHospitalflag,txtSuspiciousReason,txtAddress,
