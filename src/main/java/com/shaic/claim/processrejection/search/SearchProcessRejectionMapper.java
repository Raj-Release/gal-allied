...
public class SearchProcessRejectionMapper {
	
private static MapperFacade tableMapper;

static SearchProcessRejectionMapper  myObj;
...
public static void getAllMapValues()  {
	...
	public static SearchProcessRejectionMapper getInstance(){
        if(myObj == null){
            myObj = new SearchProcessRejectionMapper();
            getAllMapValues();
        }
        return myObj;
	 }
