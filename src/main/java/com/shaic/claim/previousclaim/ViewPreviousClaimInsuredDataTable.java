...
public class ViewPreviousClaimInsuredDataTable extends GBaseTable<PreviousClaimsTableDTO> {
	...
	//private String initmationNo;

	////private static Window popup;
	private static final long serialVersionUID = -7771166917702155656L;
	private static final Object[] NATURAL_COL_ORDER= new Object[]{"policyNumber","claimNumber","insuredPatientName","claimStatus","claimedAmount","amountPayable"};
						...
						button.addClickListener(new Button.ClickListener() {
							...
							public void buttonClick(ClickEvent event) {
		                        ...
		                        if(previousClaimDto.getIntimation() != null){
		                        	...
		                        	getClaimStatus(previousClaimDto.getIntimation().getIntimationId().toString());
