...
public class ProcessRejectionDetailsTable extends GBaseTable<ReimbursementRejectionDetailsDto>{
	...
	private static final Object[] NATURAL_COL_ORDER = new Object[] {"select","rejectionNo","hospitalName", "hospitalAddress", "hospitalCity", "diagnosis", 
