...
public class OMPProcessOmpClaimApproverUI extends SearchComponent<OMPProcessOmpClaimApproverFormDto>{
	
	private OMPProcessOmpClaimApproverFormDto searchDto;
	
	private OMPProcessOmpClaimApproverDetailTable searchTable;
	...
	public void init() {
		...
		mainPanel.setCaption("Process OMP Claim - Approver");
	...
	{
		this.binder = new BeanFieldGroup<OMPProcessOmpClaimApproverFormDto>(OMPProcessOmpClaimApproverFormDto.class);
		this.binder.setItemDataSource(new OMPProcessOmpClaimApproverFormDto());
