...
import com.vaadin.ui.themes.ValoTheme;
	...
	public class ProcessPCCUploadDocumentsPageTable extends GBaseTable<PCCUploadDocumentsDTO>{
			    	...
			    	editButton.addClickListener(new Button.ClickListener() {
						...
						public void buttonClick(ClickEvent event) {
							...
							uploadDTO.setIsEdit(true);
								fireViewEvent(ProcessPCCZonalMedicalHeadRequestPresenter.PCC_EDIT_UPLOAD_EVENT, uploadDTO);
				        } 
				    });
												...
												"No", "Yes", new ConfirmDialog.Listener() {
													...
													public void onClose(ConfirmDialog dialog) {
														if (!dialog.isConfirmed()) {
															...
															table.removeItem(currentItemId);
															fireViewEvent(ProcessPCCZonalMedicalHeadRequestPresenter.PCC_DELETE_UPLOAD_EVENT, deletedRowDTO);
														} else {
