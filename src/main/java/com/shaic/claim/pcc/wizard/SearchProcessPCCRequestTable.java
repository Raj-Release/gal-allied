...
public class SearchProcessPCCRequestTable extends GBaseTable<SearchProcessPCCRequestTableDTO> {
	...
	private final static Object[] NATURAL_COL_ORDER_PCC = new Object[]{"serialNumber","intimationNo","pccSource","cpuName","productName","insuredPatientName","hospitalName","pccCatagory","dateAndTime"};
