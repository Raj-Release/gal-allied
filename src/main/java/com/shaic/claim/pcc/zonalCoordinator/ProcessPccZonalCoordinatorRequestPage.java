...
public class ProcessPccZonalCoordinatorRequestPage extends ViewComponent {
	...
	@Inject
	private ProcessPCCUploadDocumentsPageTableZC uploadedDocumentsTable;
	
	@Inject
	private ProcessPCCZCUploadDocumentsGridForm fileUploadUI;
	...
	public void init(PccDetailsTableDTO pccDetailsTableDTO, String presenterString) {
		...
		fileUploadUI.init(new PCCUploadDocumentsDTO(),bean,SHAConstants.PCC_ZONAL_COORDINATOR_SCREEN);
			...
			public void componentEvent(Event event) {
				if (cmbSelectRole.getValue() !=null) {
					...
					if(selectValue.getCommonValue() !=null){
							fireViewEvent(ProcessPCCZonalCoordinatorRequestPresenter.PCCCZC_GENERATE_USER_DETAILS,selectValue.getCommonValue(),cpuCode);
					}
				}
			}			
		});
