...
public class ProcessPCCZonalCoordinatorRequestWizardViewImpl extends
	...
	public void editPCCUploadDocumentDetails(PCCUploadDocumentsDTO dto) {
		processPccZonalCoordinatorRequestPage.editPCCUploadDocumentDetails(dto);
		
	}
	
	@Override
	public void deletePCCUploadedDocumentDetails(PCCUploadDocumentsDTO dto) {
		processPccZonalCoordinatorRequestPage.deletePCCUploadedDocumentDetails(dto);
	...
	public void updateTableValues(List<PCCUploadDocumentsDTO> uploadedDocList) {
		...
		processPccZonalCoordinatorRequestPage.setUploadTableValues(uploadedDocList);

	}
	
	@Override
	public List<PCCUploadDocumentsDTO> getUploadedDocDtoList(){
		return processPccZonalCoordinatorRequestPage.getUploadedTableValues();
	}
	
	@Override
	public void addUserDetails(BeanItemContainer<SelectValue> userDetailsContainer) {
		processPccZonalCoordinatorRequestPage.addUserDetails(userDetailsContainer);
	}
