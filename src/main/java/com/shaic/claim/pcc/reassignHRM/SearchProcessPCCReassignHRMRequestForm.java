...
public class SearchProcessPCCReassignHRMRequestForm extends SearchComponent<SearchProcessPCCRequestFormDTO>{
	...
	public BeanItemContainer<SelectValue>  getCpuCodeList() {
		...
		String roleCode =  SHAConstants.HRM_COORDINATOR_ROLE;
	...
	public void init(String menuString) {
		...
		mainPanel = new Panel();
		mainPanel.setCaption("Re-assign HRM");
	...
	public VerticalLayout mainVerticalLayout(){
		...
		absoluteLayout_3.addComponent(btnReset, "top:130.0px;left:470.0px;");
