...
public class ProcessPCCHrmCoordinatorRequestPresenter extends AbstractMVPPresenter<ProcessPCCHrmCoordinatorRequestWizardView> {
	...
	public static final String PCC_HRM_UPLOAD_EVENT = "PCC HRM Upload document button";
	
	public static final String PCC_HRM_EDIT_UPLOAD_EVENT = "PCC HRM edit upload button";
	
	public static final String PCC_HRM_DELETE_UPLOAD_EVENT = "PCC HRM delete upload button";
	
	public static final String PCCCHRM_GENERATE_USER_DETAILS = "pccHRM_generate_user_details";	
	...
	public void addUserDetails(@Observes @CDIEvent(PCCCHRM_GENERATE_USER_DETAILS) final ParameterDTO parameters) {	
	...
	public void editPCCUploadedDocumentDetails(@Observes @CDIEvent(PCC_HRM_EDIT_UPLOAD_EVENT) final ParameterDTO parameters) {
	...
	public void deletePCCUploadedDocumentDetails(@Observes @CDIEvent(PCC_HRM_DELETE_UPLOAD_EVENT) final ParameterDTO parameters) {
		PCCUploadDocumentsDTO uploadDTO = (PCCUploadDocumentsDTO)parameters.getPrimaryParameter();
		view.deletePCCUploadedDocumentDetails(uploadDTO);
	}
	public void setUploadDocument(
			@Observes @CDIEvent(PCC_HRM_UPLOAD_EVENT) final ParameterDTO parameters) {
