...
public class ProcessPCCUploadDocumentsPageTableHRM extends GBaseTable<PCCUploadDocumentsDTO>{
		    	...
		    	editButton.addClickListener(new Button.ClickListener() {
					...
					public void buttonClick(ClickEvent event) {
						...
						uploadDTO.setIsEdit(true);
							fireViewEvent(ProcessPCCHrmCoordinatorRequestPresenter.PCC_HRM_EDIT_UPLOAD_EVENT, uploadDTO);
			        } 
			    });
											...
											"No", "Yes", new ConfirmDialog.Listener() {
												...
												public void onClose(ConfirmDialog dialog) {
													if (!dialog.isConfirmed()) {
														...
														table.removeItem(currentItemId);
														fireViewEvent(ProcessPCCHrmCoordinatorRequestPresenter.PCC_HRM_DELETE_UPLOAD_EVENT, deletedRowDTO);
													} else {
