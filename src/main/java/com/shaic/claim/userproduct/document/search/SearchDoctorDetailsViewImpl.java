...
public class SearchDoctorDetailsViewImpl extends AbstractMVPView implements SearchDoctorDetailsView {
	...
	@Inject
	private SearchDoctorNameForm searchDoctorForm;
	
	@Inject 
	private SearchDoctorDetailsTable searchDoctorDetails;
...
//			String passWord=(String)getUI().getSession().getAttribute(BPMClientContext.PASSWORD);
			...
			fireViewEvent(SearchDoctorDetailsPresenter.SEARCH_BUTTON_CLICK, searchDTO);
		}
		else{
...
//		searchDoctorDetails.resetTable();
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchDoctorDetailsTable)
			{
				((SearchDoctorDetailsTable) comp).removeRow();
			}
		}
		...
		else
		{
			...
			homeButton.addClickListener(new ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					dialog.close();
					fireViewEvent(MenuItemBean.USER_ACCESS_ALLOCATION, null);
