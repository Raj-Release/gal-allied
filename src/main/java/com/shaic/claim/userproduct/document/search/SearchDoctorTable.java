...
public class SearchDoctorTable extends GBaseTable<SearchDoctorDetailsTableDTO>{
...
//		table.setColumnHeaderMode(Table.COLUMN_HEADER_MODE_EXPLICIT_DEFAULTS_ID);
			...
			public Object generateCell(Table source, Object itemId, Object columnId) {
				...
				btnSelect.addClickListener(new ClickListener() {
					...
					public void buttonClick(ClickEvent event) {
							...
							fireViewEvent(SearchDoctorDetailsPresenter.DOCTOR_SEARCH_BUTTON_CLICK, viewSearchCriteriaTableDTO);
	...
	@Override
	public void tableSelectHandler(SearchDoctorDetailsTableDTO t) {
