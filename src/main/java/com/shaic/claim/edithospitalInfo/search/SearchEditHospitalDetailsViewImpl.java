...
public class SearchEditHospitalDetailsViewImpl  extends AbstractMVPView implements SearchEditHospitalDetailsView, Searchable {	
	...
	@Inject
	private SearchEditHospitalDetailsForm searchForm;
	
	@Inject
	private SearchEditHospitalDetailsTable searchResultTable;	
	...
	protected void init() {
		...
		//searchResultTable.setHeight("200px");
	...
	public void list(Page<SearchEditHospitalDetailsTableDTO> tableRows) {
		...
		else
		{
			...
			Button homeButton = new Button("Edit Hospital Details Home");
	...
	public void doSearch() {
		SearchEditHospitalDetailsFormDTO searchDTO = searchForm.getSearchDTO();
		...
		fireViewEvent(SearchEditHospitalDetailsPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchEditHospitalDetailsTable)
			{
				((SearchEditHospitalDetailsTable) comp).removeRow();
			}
		}
	}
