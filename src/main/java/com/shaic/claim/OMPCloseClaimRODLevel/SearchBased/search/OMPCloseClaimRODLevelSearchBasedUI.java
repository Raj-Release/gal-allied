...
public class OMPCloseClaimRODLevelSearchBasedUI extends SearchComponent<OMPCloseClaimRODLevelSearchBasedFormDto>{
	
	private OMPCloseClaimRODLevelSearchBasedFormDto searchDto;
	private OMPCloseClaimRODLevelSearchBasedDetailTable searchTable;
	...
	public void init() {
		...
		mainPanel.setCaption("Close Claim ROD Level (Search Based)");
...
//		VerticalLayout verticalLayout = new VerticalLayout();
	...
	{
		this.binder = new BeanFieldGroup<OMPCloseClaimRODLevelSearchBasedFormDto>(OMPCloseClaimRODLevelSearchBasedFormDto.class);
		this.binder.setItemDataSource(new OMPCloseClaimRODLevelSearchBasedFormDto());
