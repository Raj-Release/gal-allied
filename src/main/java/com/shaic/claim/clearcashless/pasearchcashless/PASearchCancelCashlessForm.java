...
public class PASearchCancelCashlessForm  extends SearchComponent<PASearchCancelCashlessFormDTO> {
	...
	public void init() {
		...
		mainPanel.setCaption("PA Clear Cashless");
	...
	{
		this.binder = new BeanFieldGroup<PASearchCancelCashlessFormDTO>(PASearchCancelCashlessFormDTO.class);
		this.binder.setItemDataSource(new PASearchCancelCashlessFormDTO());
