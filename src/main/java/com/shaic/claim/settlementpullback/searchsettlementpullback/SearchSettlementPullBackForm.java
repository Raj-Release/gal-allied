...
public class SearchSettlementPullBackForm  extends SearchComponent<SearchSettlementPullBackFormDTO> {
	...
	{
		this.binder = new BeanFieldGroup<SearchSettlementPullBackFormDTO>(SearchSettlementPullBackFormDTO.class);
		this.binder.setItemDataSource(new SearchSettlementPullBackFormDTO());
