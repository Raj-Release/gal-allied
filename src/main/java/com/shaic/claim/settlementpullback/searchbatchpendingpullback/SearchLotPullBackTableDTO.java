...
public class SearchLotPullBackTableDTO extends  AbstractTableDTO implements Serializable {
	...
	public String getLotCreatedBy() {
		return lotCreatedBy;
	}

	public void setLotCreatedBy(String lotCreatedBy) {
		this.lotCreatedBy = lotCreatedBy;
	}
