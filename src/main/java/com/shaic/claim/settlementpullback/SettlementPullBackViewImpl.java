...
public class SettlementPullBackViewImpl extends AbstractMVPView implements SettlementPullBackView, GMVPView{

	private static final long serialVersionUID = 1180651477021369571L;


	@Inject
	private Instance<SettlementPullBackUI> clearCashlessUIInstance;	 
	
	private SettlementPullBackUI clearCashlessUI;
	...
	public void buildFailureLayout() {
		...
		homeButton.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				dialog.close();
				fireViewEvent(MenuItemBean.CLEAR_CASHLESS, null);
