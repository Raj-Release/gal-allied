...
@Stateless
public class SearchUploadDocumentsService extends AbstractDAO<Reimbursement>{
	
	@PersistenceContext
	protected EntityManager entityManager;

	public SearchUploadDocumentsService() {
		super();
	}
	...
	public Page<SearchUploadDocumentsTableDTO> search(SearchUploaddocumentsFormDTO searchFormDTO, String userName,String passWord) {
		...
		try {
			...
			List<SearchUploadDocumentsTableDTO> tableDTO = SearchUploadDocumentsMapper.getInstance().getSeachOrUploadDocumentsTableObj(doList);
	...
	public List<UploadDocumentDTO> getAckDocByDocAckKey(Long key)
    {
    	...
    	if(null != ackDocList && !ackDocList.isEmpty())
    	{
    		...
    		for (AcknowledgeDocument acknowledgeDocument : ackDocList) {
    			...
    			if(acknowledgeDocument.getDocToken()!=null){
    				uploadDocDTO.setDmsDocToken(acknowledgeDocument.getDocToken());
    			}
