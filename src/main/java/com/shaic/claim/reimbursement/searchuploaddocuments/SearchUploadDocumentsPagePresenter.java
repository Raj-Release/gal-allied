...
@ViewInterface(SearchUploadDocumentsPageView.class)
public class SearchUploadDocumentsPagePresenter extends AbstractMVPPresenter<SearchUploadDocumentsPageView>{
	
public static final String UPLOAD_DOC_SETUP_DROPDOWN_VALUES = "upload_doc_setup_dropdown_values";
	
	public static final String SUBMIT_SEARCH_OR_UPLOADED_DOCUMENTS = "submit_search_or_uploaded_documents";
	
	public static final String DELETE_SEARCH_OR_UPLOADED_UPLOADED_DOCUMENTS = "delete_search_or_uploaded_documents";
	
	public static final String EDIT_SEARCH_OR_UPLOADED_UPLOADED_DOCUMENTS = "edit_search_or_uploaded_documents";
