...
public class SearchUploadDocumentsWizardViewImpl extends AbstractMVPView implements
SearchUploadDocumentsWizardView{
...
/*		item.addNestedProperty("documentDetails.documentCheckList");
	...
	public void wizardCompleted(WizardCompletedEvent event) {
		...
		{
			fireViewEvent(SearchUploadDocumentsWizardPresenter.SUBMIT_SEARCH_OR_UPLOAD_DOCUMENTS, bean);
		}
	}
