...
public class SearchUploadDocumentsPageTable extends GEditableTable<UploadDocumentDTO>{
	...
	public SearchUploadDocumentsPageTable() {
		super(SearchUploadDocumentsPageTable.class);
		setUp();
	}
		    	...
		    	editButton.addClickListener(new Button.ClickListener() {
					...
					public void buttonClick(ClickEvent event) {
						...
						uploadDTO.setIsEdit(true);
							fireViewEvent(SearchUploadDocumentsPagePresenter.EDIT_SEARCH_OR_UPLOADED_UPLOADED_DOCUMENTS, uploadDTO);
	...
	public void tableSelectHandler(UploadDocumentDTO t) {		
			fireViewEvent(SearchUploadDocumentsPagePresenter.DELETE_SEARCH_OR_UPLOADED_UPLOADED_DOCUMENTS,t);
				}
