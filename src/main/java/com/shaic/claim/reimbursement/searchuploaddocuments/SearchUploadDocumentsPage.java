...
public class SearchUploadDocumentsPage extends ViewComponent {
	@Inject
...
//	private UploadDocumentsTable uploadDocsTable;
	...
	@Inject
	private SearchUploadDocumentsPageTable uploadedDocsTable;
	
	private BeanFieldGroup<UploadDocumentDTO> binder;
	
	@Inject
	private SearchUploadDocumentsGridForm uploadDocsTable;
