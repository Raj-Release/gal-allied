...
public class UploadDocumentsForAckNotReceivedWizardViewImpl extends AbstractMVPView implements UploadDocumentsForAckNotReceivedWizardView{

	@Inject
	private Instance<UploadDocumentsForAckNotReceivedPageView> searchUploadDocumentsPageObj;
	private UploadDocumentsForAckNotReceivedPageView searchUploadDocumentsPage;
...
/*		item.addNestedProperty("documentDetails.documentCheckList");
		...
		public void buildSuccessLayout() {
			...
			homeButton.addClickListener(new ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					dialog.close();
					if(searchUploadDocumentsPage!=null){
                		searchUploadDocumentsPage.setClearMapObject();
                	}
					if(mainPanel!=null){
	...
	public void wizardCompleted(WizardCompletedEvent event) {
		...
		{
			fireViewEvent(UploadDocumentsForAckNotReceivedWizard.SUBMIT_SEARCH_OR_UPLOAD_DOCUMENTS, bean);
		}
	}
