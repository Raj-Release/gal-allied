...
public class UploadDocumentsForAckNotReceivedMapper {
	...
	static UploadDocumentsForAckNotReceivedMapper  myObj;
	...
	public static UploadDocumentsForAckNotReceivedMapper getInstance(){
        if(myObj == null){
            myObj = new UploadDocumentsForAckNotReceivedMapper();
            getAllMapValues();
        }
        return myObj;
	 }
