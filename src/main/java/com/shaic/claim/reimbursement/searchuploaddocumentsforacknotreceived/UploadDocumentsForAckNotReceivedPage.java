...
public class UploadDocumentsForAckNotReceivedPage extends ViewComponent{
...
//	private UploadDocumentsTable uploadDocsTable;
	...
	@Inject
	private UploadDocumentsForAckNotReceivedPageTable uploadedDocsTable;
	
	private BeanFieldGroup<UploadDocumentDTO> binder;
	
	@Inject
	private UploadDocumentsForAckNotReceivedGridForm uploadDocsTable;
	
	@Inject
	private SearchUploadDocumentsRODDetailsTable searchUploadDocumentsRoddetailsTable;
...
public boolean validatePage() {
	...
	public void clrearObj() {
		...
		if(uploadDocsTable!=null){
			uploadDocsTable.clearData();
		}
		if(this.bean!=null){
			this.bean=null;
		}
