...
public class SearchProcessClaimCommonBillingAndFinancialsHoldMonitoringTable extends GBaseTable<SearchHoldMonitorScreenTableDTO>{

	
	private final Logger log = LoggerFactory.getLogger(SearchProcessClaimCommonBillingAndFinancialsHoldMonitoringTable.class);
				...
				alertMessage(preauthDto, errorMessage,holdMonitorDto);
					...
					try{
						...
						if(isActiveHumanTask){
							...
							preauthDto.setScreenName(SHAConstants.PROCESS_CLAIM_COMMON_BILLING_AND_FA_AUTO_ALLOCATION);
