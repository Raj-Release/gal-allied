 ...
 *
 */
public class SearchRRCRequestMapper {
	
	
	private static MapperFacade tableMapper;
	
	static SearchRRCRequestMapper  myObj;
	...
	public static void getAllMapValues()  {
		...
		ClassMapBuilder<RRCRequest, SearchRRCRequestTableDTO> rrcRequestMap = mapperFactory.classMap(RRCRequest.class, SearchRRCRequestTableDTO.class);
	...
	public  List<SearchRRCRequestTableDTO> getRRCRequestList(
			List<RRCRequest> rrcRequestList) {
		List<SearchRRCRequestTableDTO> mapAsList = tableMapper
				.mapAsList(rrcRequestList,
						SearchRRCRequestTableDTO.class);
		return mapAsList;
	}
	
	public static SearchRRCRequestMapper getInstance(){
        if(myObj == null){
            myObj = new SearchRRCRequestMapper();
            getAllMapValues();
        }
        return myObj;
	 }
