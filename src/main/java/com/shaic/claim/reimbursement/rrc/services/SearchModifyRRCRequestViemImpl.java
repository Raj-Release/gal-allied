 ...
 *
 */
public class SearchModifyRRCRequestViemImpl extends AbstractMVPView implements SearchModifyRRCRequestView {
	
	@Inject
	private SearchModifyRRCRequestForm  searchForm;
	
	@Inject
	private SearchModifyRRCRequestTable searchResultTable;
	...
	public void doSearch() {
		SearchModifyRRCRequestFormDTO searchDTO = searchForm.getSearchDTO();
		Pageable pageable = searchResultTable.getPageable();
		searchDTO.setPageable(pageable);
		String userName=(String)getUI().getSession().getAttribute(BPMClientContext.USERID);
		String passWord=(String)getUI().getSession().getAttribute(BPMClientContext.PASSWORD);
		fireViewEvent(SearchModifyRRCRequestPresenter.SEARCH_BUTTON_CLICK_MODIFY_RRC_REQUEST, searchDTO,userName,passWord);
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchModifyRRCRequestTable)
			{
				((SearchModifyRRCRequestTable) comp).removeRow();
			}
		}
	...
	public void list(Page<SearchModifyRRCRequestTableDTO> tableRows) {
		...
		else
		{
			...
			Button homeButton = new Button("Modify RRC Request Home");
