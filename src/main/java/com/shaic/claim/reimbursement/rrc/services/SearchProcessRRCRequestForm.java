 ...
 *
 */
public class SearchProcessRRCRequestForm extends SearchComponent<SearchProcessRRCRequestFormDTO> {
	...
	public void init() {
		...
		mainPanel.setCaption("Process RRC Request");
	...
	//	txtRRCRequestNo.setMaxLength(25);
		...
		FormLayout formLayoutLeft = new FormLayout(txtIntimationNo,cmbCpu,cmbPriority,cmbType);
		formLayoutLeft.setSpacing(true);
		FormLayout formLayoutRight = new FormLayout(txtRRCRequestNo,cmbRRCRequestType,cmbSource);
	...
	{
		this.binder = new BeanFieldGroup<SearchProcessRRCRequestFormDTO>(SearchProcessRRCRequestFormDTO.class);
		this.binder.setItemDataSource(new SearchProcessRRCRequestFormDTO());
