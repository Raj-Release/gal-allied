 ...
 *
 */
public class SearchRRCRequestTableDTO extends AbstractTableDTO  implements Serializable{
...
//	private String statusDate;
	...
	private List<SearchRRCRequestTableDTO> totalList;
...
public String getCreditsEmployeeName7() {
	...
	public List<SearchRRCRequestTableDTO> getTotalList() {
		return totalList;
	}

	public void setTotalList(List<SearchRRCRequestTableDTO> totalList) {
