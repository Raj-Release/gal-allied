...
public class SearchRRCStatusForm extends
		SearchComponent<SearchRRCStatusFormDTO> {
	...
	public void init() {
		...
		mainPanel.setCaption("RRC Status Screen");
	...
	public VerticalLayout mainVerticalLayout() {
		...
		txtRRCRequestNo = binder.buildAndBind("RRC Request No", "rrcRequestNo",
				TextField.class);
		...
		cmbRRCRequestType = binder.buildAndBind("RRC Request Type",
				"rrcRequestType", ComboBox.class);
		cmbEligiblityType = binder.buildAndBind("Eligibility Type",
				"eligibilityType", ComboBox.class);
		fromDate = binder
				.buildAndBind("From Date", "fromDate", DateField.class);
		...
		FormLayout formLayoutLeft = new FormLayout(txtIntimationNo, cmbCpu,
				dummyField, fromDate);
		formLayoutLeft.setSpacing(true);
		FormLayout formLayoutRight = new FormLayout(txtRRCRequestNo,
				cmbRRCRequestType, cmbEligiblityType, toDate);
	...
	private void initBinder() {
		this.binder = new BeanFieldGroup<SearchRRCStatusFormDTO>(
				SearchRRCStatusFormDTO.class);
		this.binder.setItemDataSource(new SearchRRCStatusFormDTO());
		this.binder.setFieldFactory(new EnhancedFieldGroupFieldFactory());
	}

	public void setDropDownValues(BeanItemContainer<SelectValue> cpu,
			BeanItemContainer<SelectValue> rrcRequestType,
			BeanItemContainer<SelectValue> rrcEligiblity) {
