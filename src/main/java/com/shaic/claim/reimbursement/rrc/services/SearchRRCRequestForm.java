 ...
 *
 */
public class SearchRRCRequestForm  extends SearchComponent<SearchRRCRequestFormDTO> {
	...
	public void init() {
		...
		mainPanel.setCaption("Search RRC Request");
	...
	{
		this.binder = new BeanFieldGroup<SearchRRCRequestFormDTO>(SearchRRCRequestFormDTO.class);
		this.binder.setItemDataSource(new SearchRRCRequestFormDTO());
