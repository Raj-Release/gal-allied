...
public class FinancialReviewPagePresenter extends AbstractMVPPresenter<FinancialReviewPageWizard>{
	...
	public static final String FINANCIAL_VENTILATOR_SUPPORT = "financial_ventilator_support";
	...
	public static final String SAVE_FA_HOSPITAL_CASH_PHC_TABLE_VALUES = "save_FA_hospital_cash_phc_table_values";

	public static final String SAVE_FA_HOSPITAL_CASH_TABLE_VALUES = "save_FA_hospital_cash_table_values";
...
//				}
		...
		public void generateRejectLayout(@Observes @CDIEvent(FIANANCIAL_REJECT_EVENT) final ParameterDTO parameters)
		{
		 ...
		 public void getSecCover(
			...
			public void saveHospitalCashPhcValue(@Observes @CDIEvent(SAVE_FA_HOSPITAL_CASH_PHC_TABLE_VALUES) final ParameterDTO parameters)
			{
			...
			public void saveHospitalCashchangeValue(@Observes @CDIEvent(SAVE_FA_HOSPITAL_CASH_TABLE_VALUES) final ParameterDTO parameters)
			{
				ReceiptOfDocumentsDTO rodDTO = (ReceiptOfDocumentsDTO)parameters.getPrimaryParameter();
