...
public class BillAssessmentUI extends UI{
	...
	protected void init(VaadinRequest request) {
		...
		if( request.getWrappedSession().getAttribute(SHAConstants.PREAUTH_DTO) != null && request.getWrappedSession().getAttribute(SHAConstants.FA_BILL_ASSESSMENT_VIEW_PAGE) != null) {
			ViewBillAssessmentSheet viewAssessmentView = (ViewBillAssessmentSheet) request.getWrappedSession().getAttribute(SHAConstants.FA_BILL_ASSESSMENT_VIEW_PAGE);
