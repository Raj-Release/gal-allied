...
*/
	...
	private Button getSubmitButtonWithListener(final ConfirmDialog dialog) {
		...
		submitButton.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				String eMsg = "";
				if (isValid()) {
					/*if (rejectionRemarksTxta.getValue() != null && !rejectionRemarksTxta.getValue().isEmpty()) {
						System.out.println(String.format("Rejection Remarks Legth   :  [%s]", rejectionRemarksTxta.getValue().length()));
						saveRemarksValues();
					}*/
	...
	/*public void saveRemarksValues(){
		String rejectRremarks = rejectionRemarksTxta.getValue();
		String subString1 = "";
		String subString2 = "";
		
		if(rejectRremarks.length()> 4000){
			 subString1 = rejectRremarks.substring(0,4000);
			 subString2 = rejectRremarks.substring(4000,8000);
			 System.out.println("Inside IF***************");
			System.out.println(String.format("Rejection Remarks substring 1   :  [%s]",subString1));
			System.out.println(String.format("Rejection Remarks SubString 2   :  [%s]",subString2));
			...
			bean.getPreauthMedicalDecisionDetails().setRejectionRemarks(rejectionRemarksTxta.getValue());
