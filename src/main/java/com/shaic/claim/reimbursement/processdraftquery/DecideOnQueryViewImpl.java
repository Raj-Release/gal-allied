 ...
 *
 */
public class DecideOnQueryViewImpl extends AbstractMVPView implements DecideOnQueryView{
	
	@Inject 
	private DecideOnQueryPage decideOnQueryPage;
