...
public class TalkTalkTalkCategoryListenerTable extends ViewComponent {
	...
	public void init(Boolean isAddBtnRequired,PreauthDTO bean) {
		...
		if(bean.getInitiateTalkTalkTalkDTOList() !=null && !bean.getInitiateTalkTalkTalkDTOList().isEmpty()){
	...
	private void addListener() {
		btnAdd.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				/*if(!editedKeys.contains(initiateTalkTalkTalkDTO.getKey())){
					editedKeys.add(initiateTalkTalkTalkDTO.getKey());*/
		...
		table.addGeneratedColumn("callOptions", new Table.ColumnGenerator() {
			...
			@Override
		      public Object generateCell(final Table source, final Object itemId, Object columnId) {
		    	...
		    	if(preauthDTO.getInitiateTalkTalkTalkDTOList() !=null && !preauthDTO.getInitiateTalkTalkTalkDTOList().isEmpty()){
		    	...
		    	callBtn.addClickListener(new Button.ClickListener() {
					...
					public void buttonClick(ClickEvent event) {
						...
						talkDTO.setIntimationNumber(preauthDTO.getIntimationNumber());
