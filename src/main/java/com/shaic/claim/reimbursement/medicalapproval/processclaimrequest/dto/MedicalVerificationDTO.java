...
public class MedicalVerificationDTO extends AbstractTableDTO  implements Serializable{
	...
	@NotNull(message = "Please Select Verified in Medical Verification Table")
