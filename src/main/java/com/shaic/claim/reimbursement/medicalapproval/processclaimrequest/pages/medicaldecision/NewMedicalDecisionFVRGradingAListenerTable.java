...
public class NewMedicalDecisionFVRGradingAListenerTable extends ViewComponent {
...
//		layout.addComponent(btnLayout);
	...
	void initTable(VerticalLayout layout) {
		...
		table = new Table("SEGMENT: A", data);
...
//		table.setWidth("100%");
		...
		table.setColumnHeader("category", "A. POINTS TO FOCUS FOR VERIFICATION");
		table.setColumnHeader("checkFlagA", "");
	...
	public class ImmediateFieldFactory extends DefaultFieldFactory {
		...
		public Field<?> createField(Container container, Object itemId,
			...
			if("serialNumber".equals(propertyId)) {
				...
				//box.setHeight("60px");
				box.setRows(5);
				box.setStyleName(ValoTheme.TEXTAREA_BORDERLESS);
				return box;
			}  else if("checkFlagA".equals(propertyId)) {
				...
				tableRow.put("checkFlagA", selectGroup);
				...
				selectGroup.addValueChangeListener(segmentAListener());
				return selectGroup;
			} else {
...
//			addCommonValues(statusCombo, "status");
	...
	public void setTableList(List<NewFVRGradingDTO> fvrGradingDTOList) {
		...
		for (NewFVRGradingDTO fvrGradingDTO2 : fvrGradingDTOList) {
			if(fvrGradingDTO2.getSegment() != null && fvrGradingDTO2.getSegment().equalsIgnoreCase(SHAConstants.FVR_GRADING_SEGMENT_A)){
	...
	protected Collection<Boolean> getReadioButtonOptions() {
	 ...
	 public void resetTableList(List<NewFVRGradingDTO> fvrGradingDTOList) {
			...
			for (NewFVRGradingDTO fvrGradingDTO2 : fvrGradingDTOList) {
				if(fvrGradingDTO2.getSegment() != null && fvrGradingDTO2.getSegment().equalsIgnoreCase(SHAConstants.FVR_GRADING_SEGMENT_A)){
					fvrGradingDTO2.setSerialNumber(i);
					fvrGradingDTO2.setCheckFlagA(null);
...
//			manageListeners();
	...
	public ValueChangeListener segmentAListener() {
