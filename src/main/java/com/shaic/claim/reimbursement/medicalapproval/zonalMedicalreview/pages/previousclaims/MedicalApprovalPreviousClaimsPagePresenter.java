...
@ViewInterface(MedicalApprovalPreviousClaimsPageInterface.class)
public class MedicalApprovalPreviousClaimsPagePresenter extends AbstractMVPPresenter<MedicalApprovalPreviousClaimsPageInterface>  {
	...
	public static final String MEDICAL_APPROVAL_PREVIOUS_CLAIMS_SETUP_REFERNCE = "medical_approval_previous_claims_setup_reference";
	public static final String MEDICAL_APPROVAL_PREVIOUS_CLAIM_DETAILS = "medical_approval_previous_claims_details_list";
	public static final String MEDICAL_APPROVAL_RELAPSE_OF_ILLNESS_CHANGED = "medical_approval_previous_claims_relapse_of_illness_changed";

	public static final String ZONAL_REVIEW_PREVIOUS_CLAIM_FOR_POLICY = "Previous claims for zonal review";
	public static final String ZONAL_REVIEW_PREVIOUS_CLAIM_DETAILS = "zonalreview_previous_claims_details";
	...
	public void getPreviousClaimForPolicy1(
			@Observes @CDIEvent(ZONAL_REVIEW_PREVIOUS_CLAIM_FOR_POLICY) final ParameterDTO parameters) {
		PreauthDTO preauthDto = (PreauthDTO) parameters.getPrimaryParameter();
...
//		List<PreviousClaimsTableDTO> previousClaimDTOList = SHAUtils.getPreviousClaims(claimList, preauthDto.getClaimDTO().getClaimId(), pedValidationService, masterService);
	...
	public void getPreviousClaimForPolicy(
			@Observes @CDIEvent(ZONAL_REVIEW_PREVIOUS_CLAIM_DETAILS) final ParameterDTO parameters) {
		PreauthDTO preauthDto = (PreauthDTO) parameters.getPrimaryParameter();
