...
public class BillingProcessButtonsUIForFirstPage extends ViewComponent  {
	...
	private void addListener() {
		...
		referCoordinatorBtn.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				fireViewEvent(BillingReviewPagePresenter.BILLING_REFERCOORDINATOR_EVENT, null);
			}
		});
		...
		referToMedicalApproverBtn.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				fireViewEvent(BillingReviewPagePresenter.BILLING_REFER_TO_MEDICAL_APPROVER_EVENT, null);
			}
		});
		...
		cancelROD.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				fireViewEvent(BillingReviewPagePresenter.BILLING_CANCEL_ROD_EVENT, bean);
			}
		});
		...
		btnBillAssessmentSheet.addClickListener(new Button.ClickListener() {
		 ...
		 referToBillEntry.addClickListener(new Button.ClickListener() {
				...
				@Override
				public void buttonClick(ClickEvent event) {
					fireViewEvent(BillingReviewPagePresenter.BILLING_REFER_TO_BILL_ENTRY, null);
				}
			});
