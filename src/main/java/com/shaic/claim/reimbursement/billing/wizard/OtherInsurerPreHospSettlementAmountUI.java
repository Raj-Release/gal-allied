...
public class OtherInsurerPreHospSettlementAmountUI extends ViewComponent {

	private static final long serialVersionUID = -4222456099408568886L;
	
	private BeanFieldGroup<OtherInsPreHospSettlementDetailsDTO> binder;
	...
	{
		this.binder = new BeanFieldGroup<OtherInsPreHospSettlementDetailsDTO>(OtherInsPreHospSettlementDetailsDTO.class);
		this.binder.setItemDataSource(bean.getOtherInsPreHospSettlementCalcDTO());
...
//		preauthAppAmtTxt.setValue(preauthApprAmt);
		...
		formLayout.setCaption("Pre Hospitalization Settlement Calculation");
		formLayout.setMargin(true);
		formLayout.setSpacing(false);
		HorizontalLayout layout = new HorizontalLayout(formLayout);
		layout.setCaption("Pre Hospitalization Settlement Calculation");
