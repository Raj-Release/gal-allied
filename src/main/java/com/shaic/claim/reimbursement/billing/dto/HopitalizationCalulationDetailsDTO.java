...
public class HopitalizationCalulationDetailsDTO implements Serializable {
	...
	private Integer lessHospitalNetworkDis = 0;
	...
	public Integer getLessHospitalNetworkDis() {
		return lessHospitalNetworkDis;
	}
	public void setLessHospitalNetworkDis(Integer lessHospitalNetworkDis) {
		this.lessHospitalNetworkDis = lessHospitalNetworkDis;
	}
