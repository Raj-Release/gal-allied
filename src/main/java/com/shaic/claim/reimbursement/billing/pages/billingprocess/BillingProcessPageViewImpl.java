...
public class BillingProcessPageViewImpl extends AbstractMVPView implements BillingProcessPageWizard {

	private static final long serialVersionUID = -1756934701433733987L;
	
	@Inject
	private BillingProcessPageUI billingProcessPage;
	...
	public Component getContent() {
		...
		fireViewEvent(BillingProcessPagePresenter.BILLING_PROCESS_SET_UP_REFERENCE, bean);
		return comp;
	}
	...
	public boolean onAdvance() {
		if(billingProcessPage.validatePage()) {
			if(bean.getPostHospitalizaionFlag() || bean.getPreHospitalizaionFlag()) {
				...
				fireViewEvent(BillingProcessPagePresenter.POST_HOSPITALIZATION_AMOUNT, bean);
			}
