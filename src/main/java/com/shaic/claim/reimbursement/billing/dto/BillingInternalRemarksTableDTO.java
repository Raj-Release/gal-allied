...
public class BillingInternalRemarksTableDTO implements Serializable {
	...
	public String toString() {
		return "BillingInternalRemarksTableDTO [claimType=" + claimType
				+ ", refNoRodNo=" + refNoRodNo + ", createdDate=" + createdDate
