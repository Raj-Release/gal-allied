...
public class OtherInsurerHospSettlementAmountUI extends ViewComponent {
	
	private static final long serialVersionUID = -4103793305223450982L;

	private BeanFieldGroup<OtherInsHospSettlementDetailsDTO> binder;
	...
	{
		this.binder = new BeanFieldGroup<OtherInsHospSettlementDetailsDTO>(OtherInsHospSettlementDetailsDTO.class);
		this.binder.setItemDataSource(bean.getOtherInsHospSettlementCalcDTO());
...
//		preauthAppAmtTxt.setValue(preauthApprAmt);
		...
		tpaSettledAmt = (TextField) binder.buildAndBind("B. TPA Settled Amount for \nHospitalisation",
		...
		formLayout.setCaption("Hospitalization Settlement Calculation");
		HorizontalLayout layout = new HorizontalLayout(formLayout);
		layout.setCaption("Hospitalization Settlement Calculation");
