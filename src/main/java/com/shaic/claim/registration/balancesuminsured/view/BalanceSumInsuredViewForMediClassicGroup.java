...
public class BalanceSumInsuredViewForMediClassicGroup extends GBaseTable<ComprehensiveHospitalisationTableDTO>{
	...
	public void initTable() {
		...
		table.setContainerDataSource(new BeanItemContainer<ComprehensiveHospitalisationTableDTO>(
		 ...
		 Object[] NATURAL_COL_ORDER = new Object[] {
			"optionalcoverName", "policyLevelLimit","claimPaid", "claimOutStanding", "balance", "provisionCurrentClaim", "balanceSI" };
