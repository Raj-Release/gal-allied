...
public class LumpSumTableDTO {
	
	private String sectionVIII;
	...
	public String getSectionVIII() {
		return sectionVIII;
	}
	public void setSectionVIII(String sectionVIII) {
		this.sectionVIII = sectionVIII;
	}
