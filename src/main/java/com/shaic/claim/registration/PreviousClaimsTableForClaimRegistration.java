...
public class PreviousClaimsTableForClaimRegistration extends GBaseTable<PreviousClaimsTableDTO> {
...
//		fireViewEvent(ClaimRegistrationPresenter.CLICK_VIEW_CLAIM_STATUS, t);
	...
	public static final Object[] COLUMN_HEADER = new Object[] {"serialNumber",
		"policyNumber","insuredName","patientName","intimationNumber","admissionDate",
		"hospitalName","claimType","claimNumber","diagnosis",
		"provisionAmount","settledAmount","claimStatus"
	};
		      ...
		      public Object generateCell(final Table source, final Object itemId, Object columnId) {
		    	...
		    	button.addClickListener(new Button.ClickListener() {
					...
					public void buttonClick(ClickEvent event) {
						...
						fireViewEvent(ClaimRegistrationPresenter.CLICK_VIEW_CLAIM_STATUS, itemId);
			        } 
			    });
