...
@ViewInterface(ConvertReimbursementPageView.class)
public class ConvertReimbursementPagePresenter extends AbstractMVPPresenter<ConvertReimbursementPageView> {
	...
	public static final String SUBMIT_EVENT = "submit Event for convert to reimbursement";
	
	public static final String CONVERSION_REIMBURSEMENT="Convert to Reimbursement for out of process";
	
	@EJB
	private ReimbursementService reimbursementService;
	
	public static final String VALIDATE_CONVERT_CLAIM_USER_RRC_REQUEST = "convert_claim_user_rrc_request_for_outOfProcess";
	
	public static final String CONVERT_CLAIM_LOAD_RRC_REQUEST_DROP_DOWN_VALUES = "convert_claim_load_rrc_request_drop_down_values_for_outOfProcess";
	
	public static final String CONVERT_CLAIM_SAVE_RRC_REQUEST_VALUES = "convert_claim_query_save_rrc_request_values_for_outOfProcess";

	public static final String CONVERT_CLAIM_RRC_REQUEST_SUB_CATEGORY_VALUES = "convert_claim_rrc_request_sub_category_values";

	public static final String CONVERT_CLAIM_RRC_REQUEST_SOURCE_VALUES = "convert_claim_rrc_request_source_values";
	...
	public void setUpSubCategoryValues(
			@Observes @CDIEvent(CONVERT_CLAIM_RRC_REQUEST_SUB_CATEGORY_VALUES) final ParameterDTO parameters) {
	...
	public void setUpsourceValues(
			@Observes @CDIEvent(CONVERT_CLAIM_RRC_REQUEST_SOURCE_VALUES) final ParameterDTO parameters) {
