...
public class ConvertReimbursementPageViewImpl extends AbstractMVPView implements ConvertReimbursementPageView {
	...
	@Inject
	private Instance<ConvertReimbursementPage> ConvertClaimPageInstance;
	...
	private ConvertReimbursementPage convertClaimPage;
...
//		spaceVeritcLayout.setHeight("100px");
	...
	{
		fireViewEvent(ConvertReimbursementPagePresenter.VALIDATE_CONVERT_CLAIM_USER_RRC_REQUEST, preauthDTO);//, secondaryParameters);
	}
