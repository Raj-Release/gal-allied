...
public class ConvertReimbursementPage extends ViewComponent {
	...
	public void addListener(){
		...
		convertbutton.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				fireViewEvent(ConvertReimbursementPagePresenter.CONVERSION_REIMBURSEMENT,bean,searchFormDto);
				}
			}
		});
