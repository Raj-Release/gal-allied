...
public class SearchConvertReimbursementViewImpl  extends AbstractMVPView implements SearchConvertReimbursementView, Searchable {	
	...
	@Inject
	private SearchConvertReimbursementPage searchForm;
...
/*		
		...
		else
		{
			...
			homeButton.addClickListener(new ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					dialog.close();
					fireViewEvent(MenuItemBean.CONVERT_CLAIM_OUTSIDE_PROCESS, null);
	...
	public void doSearch() {
		...
		fireViewEvent(SearchConvertReimbursementPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchConvertReimbursementTable)
			{
				((SearchConvertReimbursementTable) comp).removeRow();
			}
		}
	}
