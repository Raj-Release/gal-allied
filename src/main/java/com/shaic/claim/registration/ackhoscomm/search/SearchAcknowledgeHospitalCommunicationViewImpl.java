...
public class SearchAcknowledgeHospitalCommunicationViewImpl  extends AbstractMVPView implements SearchAcknowledgeHospitalCommunicationView, Searchable  {
	

	private static final long serialVersionUID = 1934939436987293748L;

	@Inject
	private SearchAcknowledgeHospitalCommunicationForm searchForm;
	
	@Inject
	private SearchAcknowledgeHospitalCommunicationTable searchResultTable;
	
	@Inject
	private HospitalFormDTO hospitalDto;
	...
	protected void initView() {
		...
		searchResultTable.setHeight("370px");*/
	...
	@Override
	public void list(Page<SearchAcknowledgeHospitalCommunicationTableDTO> tableRows) {
		...
		else
		{
			...
			Button homeButton = new Button("Acknowledge Hospital Communication Home");
			...
			homeButton.addClickListener(new ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					dialog.close();
					fireViewEvent(MenuItemBean.ACKNOWLEDGE_HOSPITAL_COMMUNICATION, null);
	...
	public void doSearch() {
		SearchAcknowledgeHospitalCommunicationFormDTO searchDTO = searchForm.getSearchDTO();
		...
		fireViewEvent(SearchAcknowledgeHospitalCommunicationPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
	}
	@Override
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchAcknowledgeHospitalCommunicationTable)
			{
				((SearchAcknowledgeHospitalCommunicationTable) comp).removeRow();
			}
		}
	}
	...
	public void setCpuCode(BeanItemContainer<SelectValue> tmpCpuCodes) {
		searchForm.setCpuCode(tmpCpuCodes);
