...
public class ConvertClaimPageViewImpl extends AbstractMVPView implements ConvertClaimPageView {
	...
	@Inject
	private Instance<ConvertClaimPage> ConvertClaimPageInstance;
	...
	private ConvertClaimPage convertClaimPage;
...
//		dummyLabel.setWidth("395px");
		...
		HorizontalLayout alignmentHLayout = new HorizontalLayout(crmLayout,btnRRC/*,dummyLabel*/);
	...
	{
		fireViewEvent(ConvertClaimPagePresenter.VALIDATE_CONVERT_CLAIM_USER_RRC_REQUEST, preauthDTO);//, secondaryParameters);
	}
