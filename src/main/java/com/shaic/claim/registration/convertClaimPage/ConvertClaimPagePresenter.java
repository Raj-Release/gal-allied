...
@ViewInterface(ConvertClaimPageView.class)
public class ConvertClaimPagePresenter extends AbstractMVPPresenter<ConvertClaimPageView> {
	...
	public static final String SUBMIT_EVENT = "submit Event";
	
	public static final String CONVERSION_REIMBURSEMENT="Convert to Reimbursement";
	
	@EJB
	private ReimbursementService reimbursementService;
	
	public static final String VALIDATE_CONVERT_CLAIM_USER_RRC_REQUEST = "convert_claim_user_rrc_request";
	
	public static final String CONVERT_CLAIM_LOAD_RRC_REQUEST_DROP_DOWN_VALUES = "convert_claim_load_rrc_request_drop_down_values";
	
	public static final String CONVERT_CLAIM_SAVE_RRC_REQUEST_VALUES = "convert_claim_query_save_rrc_request_values";

	public static final String CONVERT_CLAIM_LOAD_RRC_REQUEST_SUB_CATEGORY_VALUES = "convert_claim_load_rrc_request_sub_category_values";

	public static final String CONVERT_CLAIM_LOAD_RRC_REQUEST_SOURCE_VALUES = "convert_claim_load_rrc_request_source_values";
...
//	}
	...
	public void setUpSubCategoryValues(
			@Observes @CDIEvent(CONVERT_CLAIM_LOAD_RRC_REQUEST_SUB_CATEGORY_VALUES) final ParameterDTO parameters) {
	...
	public void setUpsourceValues(
			@Observes @CDIEvent(CONVERT_CLAIM_LOAD_RRC_REQUEST_SOURCE_VALUES) final ParameterDTO parameters) {
