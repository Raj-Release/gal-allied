...
public class SearchConverClaimCashlessForm extends ViewComponent {

	/**
	 * 
	 */
	@Inject
	private SearchConverClaimCashlessTable searchPEDRequestProcessTable;
	private static final long serialVersionUID = 1L;

	private BeanFieldGroup<SearchConverClaimCashlessFormDTO> binder;
	...
	public SearchConverClaimCashlessFormDTO getSearchDTO() {
		try {
			this.binder.commit();
			SearchConverClaimCashlessFormDTO bean = this.binder
	...
	public void init() 
	{
		...
		processPedProcessRequestPanel.setCaption("Convert Claim type To Cashless");
	...
	private void initBinder() {
		this.binder = new BeanFieldGroup<SearchConverClaimCashlessFormDTO>(
				SearchConverClaimCashlessFormDTO.class);
		this.binder
				.setItemDataSource(new SearchConverClaimCashlessFormDTO());
