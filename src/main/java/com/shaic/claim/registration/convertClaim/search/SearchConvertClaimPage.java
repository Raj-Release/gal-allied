...
public class SearchConvertClaimPage extends ViewComponent {
	...
	@Inject
	private SearchConvertClaimTable searchResultTable;	
...
//		convertClaimPanel.setHeight("50%");
	...
	private VerticalLayout buildConvertClaimLayout() {
		...
		FormLayout formLayoutLeft = new FormLayout(txtIntimationNo,cpuCodeCmb);
		FormLayout formLayoutMiddle = new FormLayout(txtPolicyNo,cmbPriority);		
		//FormLayout formLayoutRight = new FormLayout(cmbType,cmbSource);
		FormLayout formLayoutRight = new FormLayout(cmbSource,cmbPriorityNew);
		HorizontalLayout searchFormLayout = new HorizontalLayout(formLayoutLeft,formLayoutMiddle,formLayoutRight);
		...
		absoluteLayout_3
		.addComponent(convertClaimSearchBtn, "top:90.0px;left:220.0px;");
		//Vaadin8-setImmediate() convertClaimSearchBtn.setImmediate(true);
		...
		absoluteLayout_3.addComponent(resetBtn, "top:90.0px;left:329.0px;");
		//Vaadin8-setImmediate() resetBtn.setImmediate(true);
...
public void setDropDownValues(){
		...
		Stage stageByKey3 = preauthService.getStageByKey(ReferenceTable.CLAIM_REGISTRATION_STAGE);
...
//		Stage stageByKey3 = preauthService.getStageByKey(ReferenceTable.FINANCIAL_STAGE);
		...
		selectValue3.setId(status.getKey());	
		selectValue3.setValue(status.getProcessValue());
		
		SelectValue selectValue4 = new SelectValue();
		selectValue4.setId(stageByKey3.getKey());	
		selectValue4.setValue(stageByKey3.getStageName());
