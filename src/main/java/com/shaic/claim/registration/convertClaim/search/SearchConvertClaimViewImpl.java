...
public class SearchConvertClaimViewImpl  extends AbstractMVPView implements SearchConvertClaimView, Searchable {	
	...
	@Inject
	private SearchConvertClaimPage searchForm;
...
/*		
	...
	public void list(Page<SearchConvertClaimTableDto> tableRows) {
		...
		{	
			...
			for (SearchConvertClaimTableDto tableDto : tableRows.getPageItems()) {
		...
		else
		{
			...
			homeButton.addClickListener(new ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					dialog.close();
					fireViewEvent(MenuItemBean.CONVERT_CLAIM, null);
	...
	public void doSearch() {
		...
		fireViewEvent(SearchConvertClaimPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchConvertClaimTable)
			{
				((SearchConvertClaimTable) comp).removeRow();
			}
		}
	}
