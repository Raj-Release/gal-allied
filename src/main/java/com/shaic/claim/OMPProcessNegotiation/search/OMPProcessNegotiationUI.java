...
public class OMPProcessNegotiationUI  extends SearchComponent<OMPProcessNegotiationFormDto>{
...
initBinder();
		...
		mainPanel.setCaption("Process OMP Negotiation");
	...
	{
		this.binder = new BeanFieldGroup<OMPProcessNegotiationFormDto>(OMPProcessNegotiationFormDto.class);
		this.binder.setItemDataSource(new OMPProcessNegotiationFormDto());
