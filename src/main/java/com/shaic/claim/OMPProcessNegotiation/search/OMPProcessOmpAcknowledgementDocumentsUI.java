...
import com.shaic.claim.OMPProcessOmpAcknowledgementDocuments.Upload.OMPProcessOmpAcknowledgementDocumentsFormDto;
import com.shaic.claim.OMPProcessOmpAcknowledgementDocuments.Upload.OMPProcessOmpAcknowledgementDocumentsTable;
...
public class OMPProcessOmpAcknowledgementDocumentsUI extends SearchComponent<OMPProcessOmpAcknowledgementDocumentsFormDto>{
	
	private OMPProcessOmpAcknowledgementDocumentsFormDto searchDto;
	private OMPProcessOmpAcknowledgementDocumentsTable searchTable;
	...
	{
		this.binder = new BeanFieldGroup<OMPProcessOmpAcknowledgementDocumentsFormDto>(OMPProcessOmpAcknowledgementDocumentsFormDto.class);
		this.binder.setItemDataSource(new OMPProcessOmpAcknowledgementDocumentsFormDto());
