...
public class UpdatePanCardDocumentsTable extends
		GEditableTable<UpdatePanCardTableDTO> {
	...
	public UpdatePanCardDocumentsTable() {
		super(UpdatePanCardDocumentsTable.class);
		setUp();
	}
	...
	public void initTable() {
		table.setContainerDataSource(new BeanItemContainer<UpdatePanCardTableDTO>(
				UpdatePanCardTableDTO.class));
	...
	@Override
	public void tableSelectHandler(UpdatePanCardTableDTO t) {
		// TODO Auto-generated method stub
