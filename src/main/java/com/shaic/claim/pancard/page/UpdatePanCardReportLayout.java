...
public class UpdatePanCardReportLayout extends ViewComponent {
	...
	@Inject
	private UpdatePanCardDocumentsTable updatePanCardDocumentsTable;
	...
	public void init() {
		...
		updatePanCardDocumentsTable.init("", false, false);
		btnUpload = new Button("Upload");
		mainLayout = new VerticalLayout(lblUploadInvestigationReport,
				updatePanCardDocumentsTable, btnUpload);
