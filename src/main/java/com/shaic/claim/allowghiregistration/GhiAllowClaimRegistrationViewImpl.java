...
@Default
public class GhiAllowClaimRegistrationViewImpl extends AbstractMVPView implements GhiAllowClaimRegistrationView, GMVPView{
	
    @Inject
	private Instance<GhiAllowClaimRegistration> claimRegistrationInstance;	 
    
    
    private GhiAllowClaimRegistration claimRegistration;
