...
public class SearchGhiAllowClaimRegistrationTable extends GBaseTable<SearchClaimRegistrationTableDto> {
			...
			if(get64vbStatus != null && SHAConstants.DISHONOURED.equalsIgnoreCase(get64vbStatus)) {
				...
				if(isActiveHumanTask){
					...
					SHAUtils.setActiveOrDeactiveClaim(t.getUsername(),t.getPassword(),t.getTaskNumber(),session);
						...
						fireViewEvent(MenuPresenter.CREATE_GHI_ALLOW_CLAIM_REGISTRATION, t);	
