...
private VerticalSplitPanel mainPanel;
	...
	public void doSearch() {
		...
		if((searchDTO.getYear() != null && searchDTO.getYear().getValue() == null)
				|| searchDTO.getYear() == null || searchDTO.getYear().getValue().isEmpty()){
			fireViewEvent(SearchCVCAuditActionPresenter.VALIDATE_SUBMIT, searchDTO,userName,passWord);
		} else {
