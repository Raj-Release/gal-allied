 ...
 *
 */
public class CVCAuditActionPageViewImpl extends AbstractMVPView
implements CVCAuditActionPageView {
	...
	@Inject
	private CVCAuditActionPageUI cvcPageUI;
	...
	public void result() {
		...
		public void loadCVCStatusDropDownValues(AuditDetails auditDetails,BeanItemContainer<SelectValue> remediationStatusValueContainer, 
			...
			cvcPageUI.loadCVCStatusDropDownValues(auditDetails,remediationStatusValueContainer,statusValueContainer,auditTeam,auditCategory,
					auditProcessor,cmbCategoryContainer, TeamValueContainer, ErrorValueContainer, processorValueContainer, monetaryValueContainer, qryOutcomeContainer, complReasonContainer)	;
