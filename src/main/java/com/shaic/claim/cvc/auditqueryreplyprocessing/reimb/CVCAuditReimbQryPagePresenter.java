...
@ViewInterface(CVCAuditReimbQryPageView.class)
public class CVCAuditReimbQryPagePresenter extends AbstractMVPPresenter<CVCAuditReimbQryPageView>{
	...
	public static final String SUBMIT_EVENT_AUDIT_QUERY_REIMB = "Submit event for CVC Audit reimb Qry Rly";
	
	public static final String LOAD_CVC_AUDIT_ACTION_STATUS_VALUES = "load_cvc_audit_Cls_Qry_Rly_status_values";
	...
	@EJB
	private SearchCVCAuditReimbQryService cvcSearchService;
	...
	public void submitEvent(
			@Observes @CDIEvent(SUBMIT_EVENT_AUDIT_QUERY_REIMB) final ParameterDTO parameters) {
