...
public class SearchCVCAuditReimbQryViewImpl extends AbstractMVPView implements SearchCVCAuditReimbQryView{
	
	@Inject
	private SearchCVCAuditReimbQryForm searchForm;
	
	@Inject
	private SearchCVCAuditReimbQryTable searchResultTable;
...
private VerticalSplitPanel mainPanel;
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchCVCAuditReimbQryTable)
			{
				((SearchCVCAuditReimbQryTable) comp).removeRow();
			}
		}
		...
		}else
		{
			...
			homeButton.addClickListener(new Button.ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					dialog.close();
					fireViewEvent(MenuItemBean.CVC_AUDIT_RMB_QRY_RLY, null);
...
//		searchForm.enableButtons();
	...
	public void doSearch() {
		...
		fireViewEvent(SearchCVCAuditReimbQryPresenter.SUBMIT_SEARCH, searchDTO,userName,passWord);
