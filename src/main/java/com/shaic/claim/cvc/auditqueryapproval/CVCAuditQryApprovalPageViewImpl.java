...
public class CVCAuditQryApprovalPageViewImpl extends AbstractMVPView
implements CVCAuditQryApprovalPageView {
	...
	@Inject
	private CVCAuditQryApprovalPageUI cvcPageUI;
	...
	public void result() {
		...
		public void loadCVCStatusDropDownValues(AuditDetails auditDetails,BeanItemContainer<SelectValue> remediationStatusValueContainer, 
			...
			// TODO Auto-generated method stub
			cvcPageUI.loadCVCStatusDropDownValues(auditDetails,remediationStatusValueContainer,statusValueContainer,auditTeam,
					auditCategory,auditProcessor,cmbCategoryContainer, TeamValueContainer, ErrorValueContainer, 
