...
public class SearchCVCAuditQryApprovalTable extends GBaseTable<SearchCVCAuditActionTableDTO>{
	
	private final static Object[] VISIBLE_COL_ORDER = new Object[]{
		"serialNumber", "intimationNumber", "transactionNumber", "claimType", "status", "auditBy", "auditDate" }; 
	...
	public void initTable() {
	 ...
	 @Override
		...
		// TODO Auto-generated method stub
		 ...
		 fireViewEvent(RevisedMenuPresenter.CVC_AUDIT_QRY_APPROVAL_WIZARD, t);
