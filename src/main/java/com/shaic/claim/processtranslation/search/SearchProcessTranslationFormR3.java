...
public class SearchProcessTranslationFormR3 extends ViewComponent {
...
//		searchFormLayout.setComponentAlignment(formLayout2 , Alignment.MIDDLE_RIGHT);
	...
	public void resetAlltheValues() 
	{
     ...
     public void setUpDropDownValue(){
		...
		Stage stageByKey2 = preauthService.getStageByKey(ReferenceTable.ZONAL_REVIEW_STAGE);
		Stage stageByKey3 = preauthService.getStageByKey(ReferenceTable.CLAIM_REQUEST_STAGE);
		Stage stageByKey4 = preauthService.getStageByKey(ReferenceTable.BILLING_STAGE);
