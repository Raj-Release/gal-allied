...
public class SearchProcessTranslationViewImpl  extends AbstractMVPView implements SearchProcessTranslationView ,Searchable {
	

	private static final long serialVersionUID = 1934939436987293748L;

	@Inject
	private SearchProcessTranslationForm searchForm;
	...
	private boolean reimburementFlag = false;
...
//	private SearchProcessTranslationTable searchProcessTranslationTable;
		...
		else
		{
			...
			homeButton.addClickListener(new ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					dialog.close();
					fireViewEvent(MenuItemBean.UPLOAD_TRANSLATED_DOCUMENTS, null);
	...
	public void doSearch() {
		...
		fireViewEvent(SearchProcessTranslationPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord, reimburementFlag);
	}
	...
	public void init(boolean reimburementFlag) {
		...
		this.reimburementFlag = reimburementFlag;
