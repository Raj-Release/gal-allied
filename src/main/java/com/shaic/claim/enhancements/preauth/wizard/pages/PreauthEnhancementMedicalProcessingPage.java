...
public class PreauthEnhancementMedicalProcessingPage extends ViewComponent implements WizardStep<PreauthDTO> {
	private static final long serialVersionUID = -7554302936251509566L;
...
//	private PreauthButtons preauthButtonObj;
	...
	public Component getContent() {
		...
		if(bean.getNewIntimationDTO().getIsPaayasPolicy() || bean.getNewIntimationDTO().getIsPaayasPolicy()) {
			procedureExclusionCheckTableInstance.setEditable(false);
		}
...
//			dialog.setCaption("Alert");
	 ...
	 final MessageBox showInfo= showInfoMessageBox("Change in Sum Insured - Increased SI is subject to Waiting Period");
