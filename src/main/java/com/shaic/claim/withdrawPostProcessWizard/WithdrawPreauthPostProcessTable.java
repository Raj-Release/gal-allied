package com.shaic.claim.withdrawPostProcessWizard;
	...
	public class WithdrawPreauthPostProcessTable extends GBaseTable<WithdrawPreauthPostProcessPageDTO> {
		...
		public void initTable() {
			...
			table.setWidth("100%");
			table.setContainerDataSource(new BeanItemContainer<WithdrawPreauthPostProcessPageDTO>(
...
//				    		UI.getCurrent().addWindow(viewDetailUI);
		...
		@Override
		public void tableSelectHandler(WithdrawPreauthPostProcessPageDTO t) {
			// TODO Auto-generated method stub
