...
<div>
  ...
  <c:set var="hospitalDiscount" scope="session" value=""/>
   ...
   <c:forEach items="${param}" var="currentParam">
   		...
   		<c:if test="${currentParam.key == 'hospitalDiscount'}"> 		
   			<c:set var="hospitalDiscount" value="${currentParam.value}"/>		
   		</c:if>
      </c:forEach>
	...
	<br>
	  <div>
	   <iframe src="${dmsDocumentDTO.getHosiptalDiscount()}" width="80%" height="80%" style="position:relative;"></iframe>
	  </div>
    ...
    <!-- <script type="text/javascript">
   	 document.getElementById('viewFrame').src = $("#p1").text();
	</script> -->
 	<script type="text/javascript">
