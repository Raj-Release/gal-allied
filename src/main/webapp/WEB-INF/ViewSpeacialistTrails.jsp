...
<body>
	 <%
         session.setAttribute("specialistList", request.getAttribute("specialistList"));
      %>
	<div class="container"> 
		...
		<!-- <div class="col-md-12"> -->
					<div class="panel panel-default">
					  <!--  <div class="panel-heading"> -->
						  <p class = "text-center" style="background-color: #003366 !important;color:#f7fff7"><strong>Specialist Opinion Details</strong></p>
					   <!-- </div> -->
							 ...
							 <table class="table table-condensed table-bordered table-hover">
								<thead>
								   <tr style="background-color: #003366 !important;color:#f7fff7;text-align: center;font-size: 11px;">
									   ...
									   <td><strong>Replied Date</strong></td>
									   <td><strong>Specialist Type</strong></td>
									   <td><strong>Specialist Dr NameId</strong></td>
									   <td><strong>Requestor Name Id</strong></td>
									   <td><strong>Requestor Remarks</strong></td>
									   <td><strong>View File</strong></td>
									   <td><strong>Specialist Remarks</strong></td>
							
								   </tr>
								</thead>
								<tbody>
								   <c:forEach items="${specialistList}" var="specialistList">
									  <tr>
										 <td>${specialistList.getRequestedDate()}</td>
										 <td>${specialistList.getRepliedDate()}</td>
										 <td>${specialistList.getSpecialistType()}</td>
										 <td>${specialistList.getSpecialistDrNameId()}</td>
										 <td>${specialistList.getRequestorNameId()}</td>
										 <td>${specialistList.getRequestorRemarks()}</td>
										 <td>View File</td>
										 <td>${specialistList.getSpecialistRemarks()}</td>
