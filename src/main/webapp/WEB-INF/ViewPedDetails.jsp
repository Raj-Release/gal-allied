...
<body>
	 <%
         session.setAttribute("pedList", request.getAttribute("pedList"));
      %>
	<div class="container"> 
		...
		<!-- <div class="col-md-12"> -->
					<div class="panel panel-default">
					  <!--  <div class="panel-heading"> -->
						  <p class = "text-center" style="background-color: #003366 !important;color:#f7fff7"><strong>PED Request Details</strong></p>
					   <!-- </div> -->
					   <div class="panel-body">
						  <div class="table-responsive">
							 <table class="table table-condensed table-bordered table-hover">
								...
								<tbody>
								   <c:forEach items="${pedList}" var="pedList">
									  <tr>
										 
										 <td>${pedList.getIntimationNo()}</td>
										 <td>${pedList.getPedSuggestionName()}</td>
										 <td>${pedList.getPedName()}</td>
										 <td>${pedList.getRepLetterDate()}</td>
										 <td>${pedList.getRemarks()}</td>
										 <td>${pedList.getRequestorId()}</td>
										 <td>${pedList.getRequestedDate()}</td>
										 <td>${pedList.getRequestStatus()}</td>
									  </tr>
								   </c:forEach>
								</tbody>
							 </table>
